...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.ManagePermissionService();
  });
  ...
  describe('ManagePermissionService', function() {
    it('should create an instance of ManagePermissionService', function() {
      // uncomment below and update the code to test ManagePermissionService
      //var instane = new CloudGovernanceApi.ManagePermissionService();
      //expect(instance).to.be.a(CloudGovernanceApi.ManagePermissionService);
    });

    it('should have the property userScopeSetting (base name: "userScopeSetting")', function() {
      // uncomment below and update the code to test the property userScopeSetting
      //var instane = new CloudGovernanceApi.ManagePermissionService();
      //expect(instance).to.be();
    });

    it('should have the property sharePointGroupOptions (base name: "sharePointGroupOptions")', function() {
      // uncomment below and update the code to test the property sharePointGroupOptions
      //var instane = new CloudGovernanceApi.ManagePermissionService();
      //expect(instance).to.be();
    });

    it('should have the property permissionOptions (base name: "permissionOptions")', function() {
      // uncomment below and update the code to test the property permissionOptions
      //var instane = new CloudGovernanceApi.ManagePermissionService();
      //expect(instance).to.be();
    });
