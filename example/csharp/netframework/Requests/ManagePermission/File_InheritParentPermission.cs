...
namespace NetFramework
{
    ...
    public class File_InheritParentPermission : TestBase
    {
        public File_InheritParentPermission(ApiConfig authData) : base(authData) { }
        ...
        public Guid Run(ManagePermissionTestData data)
        {
            try
            {
                ...
                request.Summary = $"Api_Sample_ManagePermission_InheritPermissionForFile_Request_{DateTime.Now}";
