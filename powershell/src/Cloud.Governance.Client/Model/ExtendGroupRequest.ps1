...
function New-ExtendGroupRequest {
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => ExtendGroupRequest' | Write-Debug
...
ExtendGroupRequest<PSCustomObject>
#>
function ConvertFrom-JsonToExtendGroupRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => ExtendGroupRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ExtendGroupRequest
        $AllProperties = $("ExtendDuration", "ExtendDurationType", "GroupId", "GroupName", "GroupEmail", "GroupObjectType", "Id", "ServiceId", "Department", "Summary", "NotesToApprovers", "QuestionnaireId", "Metadatas", "TicketNumber", "Type", "TypeDescription", "Requester", "RequesterLoginName", "Status", "ProgressStatus", "ProgressStatusDescription", "SubmittedTime", "LastUpdated", "CreatedTime", "AssignTo", "FullPath")
