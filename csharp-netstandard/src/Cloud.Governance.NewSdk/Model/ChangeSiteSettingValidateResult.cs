...
namespace Cloud.Governance.NewSdk.Model
{
    ...
    public partial class ChangeSiteSettingValidateResult :  IEquatable<ChangeSiteSettingValidateResult>, IValidatableObject
    {
        ...
        public ChangeSiteSettingValidateResult(string siteUrl = default(string), Guid siteId = default(Guid), string siteTitle = default(string), string siteDescription = default(string), bool isModernSite = default(bool), bool isHubSite = default(bool), Guid? associatedHubSiteId = default(Guid?), List<CustomMetadata> metadatas = default(List<CustomMetadata>), ApiUser primaryContact = default(ApiUser), ApiUser secondaryContact = default(ApiUser), ApiUser primaryAdministrator = default(ApiUser), string errorMessage = default(string))
        {
