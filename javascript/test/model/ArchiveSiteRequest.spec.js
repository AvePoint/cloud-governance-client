...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.ArchiveSiteRequest();
  });
  ...
  describe('ArchiveSiteRequest', function() {
    it('should create an instance of ArchiveSiteRequest', function() {
      // uncomment below and update the code to test ArchiveSiteRequest
      //var instane = new CloudGovernanceApi.ArchiveSiteRequest();
      //expect(instance).to.be.a(CloudGovernanceApi.ArchiveSiteRequest);
    });
