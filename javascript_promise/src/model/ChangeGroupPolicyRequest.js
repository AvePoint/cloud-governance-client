...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AssignBy', 'model/GuidModel', 'model/RequestMetadata', 'model/RequestStatusNullable', 'model/ServiceTypeNullable', 'model/StartDateType'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AssignBy'), require('./GuidModel'), require('./RequestMetadata'), require('./RequestStatusNullable'), require('./ServiceTypeNullable'), require('./StartDateType'));
  } else {
    // Browser globals (root is window)
    if (!root.CgClient) {
      root.CgClient = {};
    }
    root.CgClient.ChangeGroupPolicyRequest = factory(root.CgClient.ApiClient, root.CgClient.AssignBy, root.CgClient.GuidModel, root.CgClient.RequestMetadata, root.CgClient.RequestStatusNullable, root.CgClient.ServiceTypeNullable, root.CgClient.StartDateType);
  }
}(this, function(ApiClient, AssignBy, GuidModel, RequestMetadata, RequestStatusNullable, ServiceTypeNullable, StartDateType) {
  'use strict';
