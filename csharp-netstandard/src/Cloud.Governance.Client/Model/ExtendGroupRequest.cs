...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class ExtendGroupRequest : IEquatable<ExtendGroupRequest>, IValidatableObject
    {
        ...
        public ExtendGroupRequest(int extendDuration = default(int), ApiDurationType? extendDurationType = default(ApiDurationType?), Guid groupId = default(Guid), Guid? id = default(Guid?), Guid serviceId = default(Guid), string department = default(string), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<RequestMetadata> metadatas = default(List<RequestMetadata>), ServiceType? type = default(ServiceType?), string typeDescription = default(string), RequestStatus? status = default(RequestStatus?), int progressStatus = default(int), string progressStatusDescription = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExtendGroupRequest {\n");
        ...
        {
            return this.Equals(input as ExtendGroupRequest);
        }

        /// <summary>
        /// Returns true if ExtendGroupRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ExtendGroupRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExtendGroupRequest input)
        {
            if (input == null)
                return false;
