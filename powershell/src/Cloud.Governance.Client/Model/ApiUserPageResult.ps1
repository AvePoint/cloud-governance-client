...
<#
ApiUserPageResult<PSCustomObject>
#>

function New-ApiUserPageResult {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => ApiUserPageResult' | Write-Debug
...
ApiUserPageResult<PSCustomObject>
#>
function ConvertFrom-JsonToApiUserPageResult {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => ApiUserPageResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApiUserPageResult
