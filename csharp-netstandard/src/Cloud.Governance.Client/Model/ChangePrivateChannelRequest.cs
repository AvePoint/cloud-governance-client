...
namespace Cloud.Governance.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChangePrivateChannelRequest")]
    public partial class ChangePrivateChannelRequest : IEquatable<ChangePrivateChannelRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChangePrivateChannelRequest" /> class.
        /// </summary>
        ...
        public ChangePrivateChannelRequest(ApiUser team = default(ApiUser), ApiUser channel = default(ApiUser), StringChangedProperty name = default(StringChangedProperty), StringChangedProperty channelDescription = default(StringChangedProperty), ApiUserIListChangedProperty owners = default(ApiUserIListChangedProperty), ApiUserIListChangedProperty members = default(ApiUserIListChangedProperty), Guid? id = default(Guid?), Guid serviceId = default(Guid), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<QuestionAnswerResponse> questionnaireResponse = default(List<QuestionAnswerResponse>), List<RequestMetadata> metadatas = default(List<RequestMetadata>))
        {
            this.Team = team;
        ...
        public ApiUser Channel { get; set; }
        ...
        public StringChangedProperty ChannelDescription { get; set; }
        ...
        public ApiUserIListChangedProperty Owners { get; set; }
        ...
        public ApiUserIListChangedProperty Members { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChangePrivateChannelRequest {\n");
        ...
        {
            return this.Equals(input as ChangePrivateChannelRequest);
        }

        /// <summary>
        /// Returns true if ChangePrivateChannelRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ChangePrivateChannelRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChangePrivateChannelRequest input)
        {
            if (input == null)
                return false;
