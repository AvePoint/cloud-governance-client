...
.PARAMETER ChangeContactMethod
No description available.

.PARAMETER ChangeByUrlSetting
No description available.

.PARAMETER ChangeByUserSetting
No description available.
...
function New-ChangeSiteContactRequest {
    ...
    Process {
        'Creating object: Cloud.Governance.Client => ChangeSiteContactRequest' | Write-Debug
