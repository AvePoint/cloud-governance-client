...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class GroupLinks :  IEquatable<GroupLinks>, IValidatableObject
    {
        ...
        public GroupLinks(string groupSiteLink = default(string), string groupPlannerLink = default(string), string groupFilesLink = default(string), string groupConversationsLink = default(string), string groupNotebookLink = default(string))
        {
