...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class GuidModel : IEquatable<GuidModel>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GuidModel);
        }

        /// <summary>
        /// Returns true if GuidModel instances are equal
        /// </summary>
        /// <param name="input">Instance of GuidModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GuidModel input)
        {
            if (input == null)
                return false;
