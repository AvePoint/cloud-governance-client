...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class WebLifecycleRequest : IEquatable<WebLifecycleRequest>, IValidatableObject
    {
        ...
        public WebLifecycleRequest(Guid webId = default(Guid), string webUrl = default(string), string webRelativeUrl = default(string), Guid siteId = default(Guid), string siteUrl = default(string), WebLifecycleActionType? action = default(WebLifecycleActionType?), Guid? id = default(Guid?), Guid serviceId = default(Guid), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<RequestMetadata> metadatas = default(List<RequestMetadata>))
        {
            this.WebId = webId;
            this.WebUrl = webUrl;
