...
namespace Cloud.Governance.NewSdk.Model
{
    ...
    public partial class ChangeSiteSettingRequest :  IEquatable<ChangeSiteSettingRequest>, IValidatableObject
    {
        ...
        /// <param name="enableChangedMetadata">enableChangedMetadata.</param>
        /// <param name="changedMetadatas">changedMetadatas.</param>
        /// <param name="originalSiteMetadatas">originalSiteMetadatas.</param>
        ...
        public ChangeSiteSettingRequest(Guid siteId = default(Guid), string siteUrl = default(string), StringChangedProperty siteTitleSetting = default(StringChangedProperty), StringChangedProperty siteDescriptionSetting = default(StringChangedProperty), bool enableChangedMetadata = default(bool), List<RequestMetadata> changedMetadatas = default(List<RequestMetadata>), List<RequestMetadata> originalSiteMetadatas = default(List<RequestMetadata>), string deploymentPlanName = default(string), HubSiteChangedSettings hubSiteSettings = default(HubSiteChangedSettings), Guid? id = default(Guid?), Guid serviceId = default(Guid), string department = default(string), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<RequestMetadata> metadatas = default(List<RequestMetadata>), int? ticketNumber = default(int?), ServiceType type = default(ServiceType), string requester = default(string), RequestStatus status = default(RequestStatus), DateTime? submittedTime = default(DateTime?), DateTime? lastUpdated = default(DateTime?), DateTime? createdTime = default(DateTime?), string assignTo = default(string), string fullPath = default(string))
        {
            this.SiteUrl = siteUrl;
            this.ChangedMetadatas = changedMetadatas;
            this.OriginalSiteMetadatas = originalSiteMetadatas;
            ...
            this.EnableChangedMetadata = enableChangedMetadata;
            this.ChangedMetadatas = changedMetadatas;
            this.OriginalSiteMetadatas = originalSiteMetadatas;
            this.DeploymentPlanName = deploymentPlanName;
        ...
        public bool EnableChangedMetadata { get; set; }
        ...
        public List<RequestMetadata> OriginalSiteMetadatas { get; set; }
