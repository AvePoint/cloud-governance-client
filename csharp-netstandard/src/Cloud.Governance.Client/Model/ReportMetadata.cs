...
namespace Cloud.Governance.Client.Model
{
    ...
    /// ReportMetadata
    /// </summary>
    [DataContract(Name = "ReportMetadata")]
    public partial class ReportMetadata : IEquatable<ReportMetadata>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        {
            return this.Equals(input as ReportMetadata);
        }

        /// <summary>
        /// Returns true if ReportMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of ReportMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportMetadata input)
        {
            if (input == null)
                return false;
