...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class ChangeWebContactRequest : IEquatable<ChangeWebContactRequest>, IValidatableObject
    {
        ...
        public ChangeWebContactRequest(ChangeContactMethod? changedMethod = default(ChangeContactMethod?), ChangeContactByUserSetting changedByUserSetting = default(ChangeContactByUserSetting), List<ChangeWebContactByUrlSetting> changedByUrlItems = default(List<ChangeWebContactByUrlSetting>), Guid? id = default(Guid?), Guid serviceId = default(Guid), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<QuestionAnswerResponse> questionnaireResponse = default(List<QuestionAnswerResponse>), List<RequestMetadata> metadatas = default(List<RequestMetadata>))
        {
        ...
        /// </summary>
        [DataMember(Name = "changedByUserSetting", EmitDefaultValue = true)]
