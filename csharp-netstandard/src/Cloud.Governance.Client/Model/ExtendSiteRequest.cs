...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class ExtendSiteRequest : IEquatable<ExtendSiteRequest>, IValidatableObject
    {
        ...
        public ExtendSiteRequest(int extendDuration = 0, ApiDurationType? extendDurationType = default(ApiDurationType?), SiteLifecycleActionType? action = default(SiteLifecycleActionType?), Guid siteId = default(Guid), string siteUrl = default(string), string siteTitle = default(string), Guid? id = default(Guid?), Guid serviceId = default(Guid), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<RequestMetadata> metadatas = default(List<RequestMetadata>))
        {
