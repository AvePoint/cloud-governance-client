...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class SharingEnabledUser : IEquatable<SharingEnabledUser>, IValidatableObject
    {
        ...
        public SharingEnabledUser(bool isSharePointGroup = default(bool), bool isGuestUser = default(bool), bool isGuestUserExistsInOrganization = default(bool), string id = default(string), string loginName = default(string), ExternalUserType? isExternalUser = default(ExternalUserType?), string displayName = default(string), bool isGroup = default(bool), string email = default(string))
        {
