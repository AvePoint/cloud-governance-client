...
function ConvertFrom-JsonToManagePermissionService {
    ...
    Process {
        ...
        $AllProperties = $("UserScopeSetting", "SharePointGroupOptions", "PermissionOptions", "ScopeSettings", "PeoplePickerFilterProfileId", "RequestTemplate", "Metadatas", "HideRequestSummary", "Id", "Name", "Description", "Type", "ServiceContact", "ServiceAdminContact", "ApproversContainManagerRole", "Status", "ShowServiceInCatalog", "CustomActions", "ApprovalProcessId", "LanguageId", "CategoryId")
