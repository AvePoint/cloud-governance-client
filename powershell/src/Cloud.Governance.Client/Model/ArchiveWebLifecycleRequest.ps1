...
<#
ArchiveWebLifecycleRequest<PSCustomObject>
#>

function New-ArchiveWebLifecycleRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => ArchiveWebLifecycleRequest' | Write-Debug
...
ArchiveWebLifecycleRequest<PSCustomObject>
#>
function ConvertFrom-JsonToArchiveWebLifecycleRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => ArchiveWebLifecycleRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
