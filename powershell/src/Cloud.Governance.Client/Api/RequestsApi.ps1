...
#>
function Get-ChangePrivateChannelRequest {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Get-ChangePrivateChannelRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/requests/changeprivatechannel/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getChangePrivateChannelRequest."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', $Id)
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "ChangePrivateChannelRequest" `
                                -IsBodyNullable $false
...
.PARAMETER ChangePrivateChannelRequest
No description available.
...
String
#>
function Submit-ChangePrivateChannelRequest {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Submit-ChangePrivateChannelRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/requests/changeprivatechannel'

        $LocalVarBodyParameter = $ChangePrivateChannelRequest | ConvertTo-Json -Depth 100
