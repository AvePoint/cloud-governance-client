...
<#
WebLifecycleRequest<PSCustomObject>
#>

function New-WebLifecycleRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => WebLifecycleRequest' | Write-Debug
...
WebLifecycleRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWebLifecycleRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
