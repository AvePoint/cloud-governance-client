...
namespace Cloud.Governance.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChangeSiteSettingRequest")]
    public partial class ChangeSiteSettingRequest : IEquatable<ChangeSiteSettingRequest>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChangeSiteSettingRequest" /> class.
        /// </summary>
        ...
        public ChangeSiteSettingRequest(Guid siteId = default(Guid), string siteUrl = default(string), StringChangedProperty siteTitleSetting = default(StringChangedProperty), StringChangedProperty siteDescriptionSetting = default(StringChangedProperty), List<RequestMetadata> changedMetadatas = default(List<RequestMetadata>), string deploymentPlanName = default(string), HubSiteChangedSettings hubSiteSettings = default(HubSiteChangedSettings), Guid? id = default(Guid?), Guid serviceId = default(Guid), string department = default(string), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<RequestMetadata> metadatas = default(List<RequestMetadata>), ServiceType? type = default(ServiceType?), string typeDescription = default(string), RequestStatus? status = default(RequestStatus?), int progressStatus = default(int), string progressStatusDescription = default(string))
        {
            this.SiteId = siteId;
        ...
        /// </summary>
        [DataMember(Name = "siteTitleSetting", EmitDefaultValue = false)]
        public StringChangedProperty SiteTitleSetting { get; set; }

        /// <summary>
        /// Gets or Sets SiteDescriptionSetting
        /// </summary>
        [DataMember(Name = "siteDescriptionSetting", EmitDefaultValue = false)]
        public StringChangedProperty SiteDescriptionSetting { get; set; }

        /// <summary>
        /// Gets or Sets EnableChangedMetadata
        /// </summary>
        [DataMember(Name = "enableChangedMetadata", EmitDefaultValue = false)]
        public bool EnableChangedMetadata { get; private set; }

        /// <summary>
        /// Gets or Sets ChangedMetadatas
        /// </summary>
        [DataMember(Name = "changedMetadatas", EmitDefaultValue = true)]
        public List<RequestMetadata> ChangedMetadatas { get; set; }

        /// <summary>
        /// Gets or Sets OriginalSiteMetadatas
        /// </summary>
        [DataMember(Name = "originalSiteMetadatas", EmitDefaultValue = true)]
        public List<RequestMetadata> OriginalSiteMetadatas { get; private set; }

        /// <summary>
        /// Gets or Sets DeploymentPlanName
        /// </summary>
        [DataMember(Name = "deploymentPlanName", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ChangedMetadatas: ").Append(ChangedMetadatas).Append("\n");
        ...
        {
            return this.Equals(input as ChangeSiteSettingRequest);
        }

        /// <summary>
        /// Returns true if ChangeSiteSettingRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ChangeSiteSettingRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChangeSiteSettingRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SiteDescriptionSetting == input.SiteDescriptionSetting ||
                    (this.SiteDescriptionSetting != null &&
                    this.SiteDescriptionSetting.Equals(input.SiteDescriptionSetting))
                ) && 
                (
                    this.EnableChangedMetadata == input.EnableChangedMetadata ||
                    this.EnableChangedMetadata.Equals(input.EnableChangedMetadata)
                ) && 
                (
                    this.ChangedMetadatas == input.ChangedMetadatas ||
                    this.ChangedMetadatas != null &&
                    input.ChangedMetadatas != null &&
                    this.ChangedMetadatas.SequenceEqual(input.ChangedMetadatas)
                ) && 
                (
                    this.OriginalSiteMetadatas == input.OriginalSiteMetadatas ||
                    this.OriginalSiteMetadatas != null &&
                    input.OriginalSiteMetadatas != null &&
                    this.OriginalSiteMetadatas.SequenceEqual(input.OriginalSiteMetadatas)
                ) && 
                (
                    this.DeploymentPlanName == input.DeploymentPlanName ||
                    (this.DeploymentPlanName != null &&
                    this.DeploymentPlanName.Equals(input.DeploymentPlanName))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SiteDescriptionSetting != null)
                    hashCode = hashCode * 59 + this.SiteDescriptionSetting.GetHashCode();
                hashCode = hashCode * 59 + this.EnableChangedMetadata.GetHashCode();
                if (this.ChangedMetadatas != null)
                    hashCode = hashCode * 59 + this.ChangedMetadatas.GetHashCode();
                if (this.OriginalSiteMetadatas != null)
                    hashCode = hashCode * 59 + this.OriginalSiteMetadatas.GetHashCode();
                if (this.DeploymentPlanName != null)
