...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.ChangeWebSettingRequest();
  });
  ...
  describe('ChangeWebSettingRequest', function() {
    it('should create an instance of ChangeWebSettingRequest', function() {
      // uncomment below and update the code to test ChangeWebSettingRequest
      //var instane = new CloudGovernanceApi.ChangeWebSettingRequest();
      //expect(instance).to.be.a(CloudGovernanceApi.ChangeWebSettingRequest);
    });
    ...
    it('should have the property changedTitle (base name: "changedTitle")', function() {
      // uncomment below and update the code to test the property changedTitle
      //var instane = new CloudGovernanceApi.ChangeWebSettingRequest();
      //expect(instance).to.be();
    });

    it('should have the property changedDescription (base name: "changedDescription")', function() {
      // uncomment below and update the code to test the property changedDescription
      //var instane = new CloudGovernanceApi.ChangeWebSettingRequest();
      //expect(instance).to.be();
    });

    it('should have the property changedMetadata (base name: "changedMetadata")', function() {
      // uncomment below and update the code to test the property changedMetadata
      //var instane = new CloudGovernanceApi.ChangeWebSettingRequest();
      //expect(instance).to.be();
    });
