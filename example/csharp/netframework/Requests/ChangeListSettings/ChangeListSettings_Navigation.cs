...
namespace NetFramework
{
    ...
    public class ChangeListSettings_Navigation : TestBase
    {
        public ChangeListSettings_Navigation(ApiConfig config) : base(config) { }
        ...
        public Guid Run(ChangeListSettingsTestData data)
        {
            try
            {
                ...
                request.NavigationSetting.ChangeValue = !originalInfo.IsOnQuickLaunch;
