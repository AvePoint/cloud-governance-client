...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/RequestMetadata', 'model/RequestStatusNullable', 'model/ServiceTypeNullable', 'model/SiteLifecycleActionType', 'model/SiteLockType'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./RequestMetadata'), require('./RequestStatusNullable'), require('./ServiceTypeNullable'), require('./SiteLifecycleActionType'), require('./SiteLockType'));
  } else {
    // Browser globals (root is window)
    if (!root.CgClient) {
      root.CgClient = {};
    }
    root.CgClient.LockSiteRequest = factory(root.CgClient.ApiClient, root.CgClient.RequestMetadata, root.CgClient.RequestStatusNullable, root.CgClient.ServiceTypeNullable, root.CgClient.SiteLifecycleActionType, root.CgClient.SiteLockType);
  }
}(this, function(ApiClient, RequestMetadata, RequestStatusNullable, ServiceTypeNullable, SiteLifecycleActionType, SiteLockType) {
  'use strict';
   ...
   */
  exports.prototype['lockTypeDescription'] = undefined;
  /**
