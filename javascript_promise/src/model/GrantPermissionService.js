...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiUser', 'model/AssignBy', 'model/CommonStatus', 'model/CustomActionSettings', 'model/CustomMetadata', 'model/GrantPermissionServiceDurationSettings', 'model/GrantPermissionServicePermissionSettings', 'model/ServiceScopeSettings', 'model/ServiceType', 'model/UserLevelControlSettings', 'model/WelcomeEmailSettings'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ApiUser'), require('./AssignBy'), require('./CommonStatus'), require('./CustomActionSettings'), require('./CustomMetadata'), require('./GrantPermissionServiceDurationSettings'), require('./GrantPermissionServicePermissionSettings'), require('./ServiceScopeSettings'), require('./ServiceType'), require('./UserLevelControlSettings'), require('./WelcomeEmailSettings'));
  } else {
    // Browser globals (root is window)
    if (!root.CgClient) {
      root.CgClient = {};
    }
    root.CgClient.GrantPermissionService = factory(root.CgClient.ApiClient, root.CgClient.ApiUser, root.CgClient.AssignBy, root.CgClient.CommonStatus, root.CgClient.CustomActionSettings, root.CgClient.CustomMetadata, root.CgClient.GrantPermissionServiceDurationSettings, root.CgClient.GrantPermissionServicePermissionSettings, root.CgClient.ServiceScopeSettings, root.CgClient.ServiceType, root.CgClient.UserLevelControlSettings, root.CgClient.WelcomeEmailSettings);
  }
}(this, function(ApiClient, ApiUser, AssignBy, CommonStatus, CustomActionSettings, CustomMetadata, GrantPermissionServiceDurationSettings, GrantPermissionServicePermissionSettings, ServiceScopeSettings, ServiceType, UserLevelControlSettings, WelcomeEmailSettings) {
  'use strict';
   ...
   */
  exports.prototype['userLevelControlSettings'] = undefined;
  /**
   ...
   */
  exports.prototype['defaultWelcomeEmailSettings'] = undefined;
  /**
