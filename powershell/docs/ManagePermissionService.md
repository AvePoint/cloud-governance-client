...
------------ | ------------- | ------------- | -------------
**UserScopeSetting** | [**ManagePermissionUserSetting**](ManagePermissionUserSetting.md) |  | [optional] [default to null]
**SharePointGroupOptions** | [**ManagePermissionSharePointGroupOption**](ManagePermissionSharePointGroupOption.md) |  | [optional] [default to null]
**PermissionOptions** | [**ManagePermissionOption**](ManagePermissionOption.md) |  | [optional] [default to null]
...
- Create a new object
```powershell
New-Cloud.Governance.ClientManagePermissionService  -UserScopeSetting null `
