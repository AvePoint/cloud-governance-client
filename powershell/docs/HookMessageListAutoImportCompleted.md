# HookMessageListAutoImportCompleted
## Properties
...
```powershell
$HookMessageListAutoImportCompleted = New-Cloud.Governance.ClientHookMessageListAutoImportCompleted  -AutoImportProfileName null `
 -TaskLink null `
 -ObjectTitle null `
 -ObjectType null `
 -ObjectTypeEnum null `
...
```powershell
$HookMessageListAutoImportCompleted | ConvertTo-JSON
```
