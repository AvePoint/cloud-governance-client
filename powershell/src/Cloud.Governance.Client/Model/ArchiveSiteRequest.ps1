...
<#
ArchiveSiteRequest<PSCustomObject>
#>

function New-ArchiveSiteRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => ArchiveSiteRequest' | Write-Debug
...
ArchiveSiteRequest<PSCustomObject>
#>
function ConvertFrom-JsonToArchiveSiteRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => ArchiveSiteRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
