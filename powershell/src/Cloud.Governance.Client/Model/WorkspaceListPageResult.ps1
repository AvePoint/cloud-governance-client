...
function New-WorkspaceListPageResult {
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => WorkspaceListPageResult' | Write-Debug
...
WorkspaceListPageResult<PSCustomObject>
#>
function ConvertFrom-JsonToWorkspaceListPageResult {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => WorkspaceListPageResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WorkspaceListPageResult
