...
------------ | ------------- | ------------- | -------------
**ChangeContactMethod** | [**ChangeContactMethod**](ChangeContactMethod.md) |  | [optional] [default to null]
**ChangeByUrlSetting** | [**ChangeContactByUrlSetting[]**](ChangeContactByUrlSetting.md) |  | [optional] [default to null]
**ChangeByUserSetting** | [**ChangeContactByUserSetting**](ChangeContactByUserSetting.md) |  | [optional] [default to null]
**SubRequests** | [**ChangeSiteContactSubRequest[]**](ChangeSiteContactSubRequest.md) |  | [optional] [readonly] [default to null]
...
- Create a new object
```powershell
New-Cloud.Governance.ClientChangeSiteContactRequest  -ChangeContactMethod null `
