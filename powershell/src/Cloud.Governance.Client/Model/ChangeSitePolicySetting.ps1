...
function New-ChangeSitePolicySetting {
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => ChangeSitePolicySetting' | Write-Debug
...
ChangeSitePolicySetting<PSCustomObject>
#>
function ConvertFrom-JsonToChangeSitePolicySetting {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => ChangeSitePolicySetting' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ChangeSitePolicySetting
