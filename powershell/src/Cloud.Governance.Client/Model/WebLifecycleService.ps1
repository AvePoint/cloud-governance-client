...
function New-WebLifecycleService {
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => WebLifecycleService' | Write-Debug
...
WebLifecycleService<PSCustomObject>
#>
function ConvertFrom-JsonToWebLifecycleService {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => WebLifecycleService' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebLifecycleService
        $AllProperties = $("Action", "ArchiveContentProfile", "ScopeSettings", "RequestTemplate", "Metadatas", "HideRequestSummary", "Id", "Name", "Description", "Type", "ServiceContact", "ServiceAdminContact", "ApproversContainManagerRole", "Status", "ShowServiceInCatalog", "CustomActions", "ApprovalProcessId", "LanguageId", "CategoryId")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "ArchiveContentProfile"))) { #optional property not found
            $ArchiveContentProfile = $null
        } else {
            $ArchiveContentProfile = $JsonParameters.PSobject.Properties["ArchiveContentProfile"].value
        }
