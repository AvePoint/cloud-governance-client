...
namespace Cloud.Governance.Client.Model
{
    ...
    /// WebLifecycleService
    /// </summary>
    [DataContract(Name = "WebLifecycleService")]
    public partial class WebLifecycleService : IEquatable<WebLifecycleService>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Action
        /// </summary>
        ...
        /// <summary>
        /// Gets or Sets ArchiveContentProfile
        /// </summary>
        [DataMember(Name = "archiveContentProfile", EmitDefaultValue = true)]
        public string ArchiveContentProfile { get; set; }
        ...
        public WebLifecycleRequest RequestTemplate { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WebLifecycleService {\n");
            sb.Append("  Action: ").Append(Action).Append("\n");
            sb.Append("  ArchiveContentProfile: ").Append(ArchiveContentProfile).Append("\n");
        ...
        {
            return this.Equals(input as WebLifecycleService);
        }

        /// <summary>
        /// Returns true if WebLifecycleService instances are equal
        /// </summary>
        /// <param name="input">Instance of WebLifecycleService to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebLifecycleService input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ArchiveContentProfile == input.ArchiveContentProfile ||
                    (this.ArchiveContentProfile != null &&
                    this.ArchiveContentProfile.Equals(input.ArchiveContentProfile))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ArchiveContentProfile != null)
                    hashCode = hashCode * 59 + this.ArchiveContentProfile.GetHashCode();
