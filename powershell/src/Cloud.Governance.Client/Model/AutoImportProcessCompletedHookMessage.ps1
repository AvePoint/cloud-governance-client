...
<#
AutoImportProcessCompletedHookMessage<PSCustomObject>
#>

function New-AutoImportProcessCompletedHookMessage {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => AutoImportProcessCompletedHookMessage' | Write-Debug
...
AutoImportProcessCompletedHookMessage<PSCustomObject>
#>
function ConvertFrom-JsonToAutoImportProcessCompletedHookMessage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => AutoImportProcessCompletedHookMessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AutoImportProcessCompletedHookMessage
