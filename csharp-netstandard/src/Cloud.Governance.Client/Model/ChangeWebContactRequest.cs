...
namespace Cloud.Governance.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChangeWebContactRequest")]
    public partial class ChangeWebContactRequest : IEquatable<ChangeWebContactRequest>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets ChangedMethod
        /// </summary>
        [DataMember(Name = "changedMethod", EmitDefaultValue = false)]
        public ChangeContactMethod? ChangedMethod { get; set; }
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChangeWebContactRequest" /> class.
        /// </summary>
        /// <param name="changedMethod">changedMethod.</param>
        /// <param name="changedByUserSetting">changedByUserSetting.</param>
        ...
        public ChangeWebContactRequest(ChangeContactMethod? changedMethod = default(ChangeContactMethod?), ChangeContactByUserSetting changedByUserSetting = default(ChangeContactByUserSetting), List<ChangeWebContactByUrlSetting> changedByUrlItems = default(List<ChangeWebContactByUrlSetting>), Guid? id = default(Guid?), Guid serviceId = default(Guid), string department = default(string), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<RequestMetadata> metadatas = default(List<RequestMetadata>), ServiceType? type = default(ServiceType?), string typeDescription = default(string), RequestStatus? status = default(RequestStatus?), int progressStatus = default(int), string progressStatusDescription = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets ChangedByUserSetting
        /// </summary>
        [DataMember(Name = "changedByUserSetting", EmitDefaultValue = false)]
        public ChangeContactByUserSetting ChangedByUserSetting { get; set; }

        /// <summary>
        /// Gets or Sets ChangedByUrlItems
        /// </summary>
        [DataMember(Name = "changedByUrlItems", EmitDefaultValue = true)]
        public List<ChangeWebContactByUrlSetting> ChangedByUrlItems { get; set; }

        /// <summary>
        /// Gets or Sets SubRequests
        /// </summary>
        [DataMember(Name = "subRequests", EmitDefaultValue = true)]
        public List<ChangeWebContactSubRequest> SubRequests { get; private set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChangeWebContactRequest {\n");
            sb.Append("  ChangedMethod: ").Append(ChangedMethod).Append("\n");
            sb.Append("  ChangedByUserSetting: ").Append(ChangedByUserSetting).Append("\n");
            sb.Append("  ChangedByUrlItems: ").Append(ChangedByUrlItems).Append("\n");
        ...
        {
            return this.Equals(input as ChangeWebContactRequest);
        }

        /// <summary>
        /// Returns true if ChangeWebContactRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ChangeWebContactRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChangeWebContactRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.ChangedMethod == input.ChangedMethod ||
                    this.ChangedMethod.Equals(input.ChangedMethod)
                ) && 
                (
                    this.ChangedByUserSetting == input.ChangedByUserSetting ||
                    (this.ChangedByUserSetting != null &&
                    this.ChangedByUserSetting.Equals(input.ChangedByUserSetting))
                ) && 
                (
                    this.ChangedByUrlItems == input.ChangedByUrlItems ||
                    this.ChangedByUrlItems != null &&
                    input.ChangedByUrlItems != null &&
                    this.ChangedByUrlItems.SequenceEqual(input.ChangedByUrlItems)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = hashCode * 59 + this.ChangedMethod.GetHashCode();
                if (this.ChangedByUserSetting != null)
                    hashCode = hashCode * 59 + this.ChangedByUserSetting.GetHashCode();
                if (this.ChangedByUrlItems != null)
                    hashCode = hashCode * 59 + this.ChangedByUrlItems.GetHashCode();
