...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class DeleteWorkspaceParameter : IEquatable<DeleteWorkspaceParameter>, IValidatableObject
    {
        ...
        public DeleteWorkspaceParameter(bool enableRemoveObject = false, bool isSendCancelEmail = false, Guid cancelEmailTemplateId = default(Guid), List<WorkspaceIdTypeModel> workspace = default(List<WorkspaceIdTypeModel>))
        {
