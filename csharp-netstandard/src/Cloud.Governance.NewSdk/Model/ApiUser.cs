...
namespace Cloud.Governance.NewSdk.Model
{
    ...
    public partial class ApiUser :  IEquatable<ApiUser>, IValidatableObject
    {
        ...
        public ApiUser(string id = default(string), string loginName = default(string), string displayName = default(string), string email = default(string), bool isGroup = default(bool), string jobTitle = default(string), string physicalDeliveryOfficeName = default(string))
        {
            this.Id = id;
