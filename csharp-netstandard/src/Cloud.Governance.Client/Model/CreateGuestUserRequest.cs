...
namespace Cloud.Governance.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateGuestUserRequest")]
    public partial class CreateGuestUserRequest : IEquatable<CreateGuestUserRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateGuestUserRequest(GuestUserPropertyModel userProperties = default(GuestUserPropertyModel), string welcomeEmailMessage = default(string), ApiUser primaryContact = default(ApiUser), ApiUser secondaryContact = default(ApiUser), List<ApiUser> inviteGroups = default(List<ApiUser>), GuestUserRequestOneTimeRenewalSettingModel oneTimeSettings = default(GuestUserRequestOneTimeRenewalSettingModel), List<CreateGuestUserSubRequest> subRequestInfos = default(List<CreateGuestUserSubRequest>), Guid? id = default(Guid?), Guid serviceId = default(Guid), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<QuestionAnswerResponse> questionnaireResponse = default(List<QuestionAnswerResponse>), List<RequestMetadata> metadatas = default(List<RequestMetadata>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateGuestUserRequest {\n");
        ...
        {
            return this.Equals(input as CreateGuestUserRequest);
        }

        /// <summary>
        /// Returns true if CreateGuestUserRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateGuestUserRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateGuestUserRequest input)
        {
            if (input == null)
                return false;
