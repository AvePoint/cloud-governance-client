...
namespace Cloud.Governance.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ServiceTeamsSettings")]
    public partial class ServiceTeamsSettings : IEquatable<ServiceTeamsSettings>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets MemberPermissionsAssignBy
        /// </summary>
        [DataMember(Name = "memberPermissionsAssignBy", EmitDefaultValue = false)]
        public AssignBy? MemberPermissionsAssignBy { get; set; }
        /// <summary>
        /// Gets or Sets GuestPermissionsAssignBy
        /// </summary>
        [DataMember(Name = "guestPermissionsAssignBy", EmitDefaultValue = false)]
        public AssignBy? GuestPermissionsAssignBy { get; set; }
        /// <summary>
        /// Gets or Sets MentionsAssignBy
        /// </summary>
        [DataMember(Name = "mentionsAssignBy", EmitDefaultValue = false)]
        public AssignBy? MentionsAssignBy { get; set; }
        /// <summary>
        /// Gets or Sets FunStuffAssignBy
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceTeamsSettings {\n");
            sb.Append("  MemberPermissionsAssignBy: ").Append(MemberPermissionsAssignBy).Append("\n");
            sb.Append("  GuestPermissionsAssignBy: ").Append(GuestPermissionsAssignBy).Append("\n");
            sb.Append("  MentionsAssignBy: ").Append(MentionsAssignBy).Append("\n");
            sb.Append("  FunStuffAssignBy: ").Append(FunStuffAssignBy).Append("\n");
        ...
        {
            return this.Equals(input as ServiceTeamsSettings);
        }

        /// <summary>
        /// Returns true if ServiceTeamsSettings instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceTeamsSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceTeamsSettings input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.MemberPermissionsAssignBy == input.MemberPermissionsAssignBy ||
                    this.MemberPermissionsAssignBy.Equals(input.MemberPermissionsAssignBy)
                ) && 
                (
                    this.GuestPermissionsAssignBy == input.GuestPermissionsAssignBy ||
                    this.GuestPermissionsAssignBy.Equals(input.GuestPermissionsAssignBy)
                ) && 
                (
                    this.MentionsAssignBy == input.MentionsAssignBy ||
                    this.MentionsAssignBy.Equals(input.MentionsAssignBy)
                ) && 
                (
                    this.FunStuffAssignBy == input.FunStuffAssignBy ||
                    this.FunStuffAssignBy.Equals(input.FunStuffAssignBy)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = hashCode * 59 + this.MemberPermissionsAssignBy.GetHashCode();
                hashCode = hashCode * 59 + this.GuestPermissionsAssignBy.GetHashCode();
                hashCode = hashCode * 59 + this.MentionsAssignBy.GetHashCode();
                hashCode = hashCode * 59 + this.FunStuffAssignBy.GetHashCode();
