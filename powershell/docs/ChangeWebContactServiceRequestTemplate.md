# ChangeWebContactServiceRequestTemplate
## Properties
...
```powershell
$ChangeWebContactServiceRequestTemplate = New-Cloud.Governance.ClientChangeWebContactServiceRequestTemplate  -ChangedMethod null `
...
```powershell
$ChangeWebContactServiceRequestTemplate | ConvertTo-JSON
```
