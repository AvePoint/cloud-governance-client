...
namespace Cloud.Governance.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeleteWebLifecycleRequest")]
    public partial class DeleteWebLifecycleRequest : IEquatable<DeleteWebLifecycleRequest>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Action
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteWebLifecycleRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteWebLifecycleRequest {\n");
        ...
        {
            return this.Equals(input as DeleteWebLifecycleRequest);
        }

        /// <summary>
        /// Returns true if DeleteWebLifecycleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteWebLifecycleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteWebLifecycleRequest input)
        {
            if (input == null)
                return false;
