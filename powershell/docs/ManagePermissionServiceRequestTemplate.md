# ManagePermissionServiceRequestTemplate
## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**ObjectUrl** | **String** | Object URL | [optional] 
**ObjectType** | [**NodeType**](NodeType.md) | Object type | [optional] 
...
```powershell
$ManagePermissionServiceRequestTemplate = New-Cloud.Governance.ClientManagePermissionServiceRequestTemplate  -ObjectUrl null `
 -ObjectType null `
 -ObjectTitle null `
 -SiteUrl null `
 -WebUrl null `
...
```powershell
$ManagePermissionServiceRequestTemplate | ConvertTo-JSON
```
