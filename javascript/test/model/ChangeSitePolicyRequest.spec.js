...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.ChangeSitePolicyRequest();
  });
  ...
  describe('ChangeSitePolicyRequest', function() {
    it('should create an instance of ChangeSitePolicyRequest', function() {
      // uncomment below and update the code to test ChangeSitePolicyRequest
      //var instane = new CloudGovernanceApi.ChangeSitePolicyRequest();
      //expect(instance).to.be.a(CloudGovernanceApi.ChangeSitePolicyRequest);
    });
