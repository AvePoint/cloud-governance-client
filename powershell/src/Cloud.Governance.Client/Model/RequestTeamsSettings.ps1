...
function New-RequestTeamsSettings {
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => RequestTeamsSettings' | Write-Debug
...
RequestTeamsSettings<PSCustomObject>
#>
function ConvertFrom-JsonToRequestTeamsSettings {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
