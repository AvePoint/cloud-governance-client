...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.ChangeWebContactValidateResult();
  });
  ...
  describe('ChangeWebContactValidateResult', function() {
    it('should create an instance of ChangeWebContactValidateResult', function() {
      // uncomment below and update the code to test ChangeWebContactValidateResult
      //var instane = new CloudGovernanceApi.ChangeWebContactValidateResult();
      //expect(instance).to.be.a(CloudGovernanceApi.ChangeWebContactValidateResult);
    });
