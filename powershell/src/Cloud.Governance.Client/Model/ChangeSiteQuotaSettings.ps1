...
function New-ChangeSiteQuotaSettings {
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => ChangeSiteQuotaSettings' | Write-Debug
...
ChangeSiteQuotaSettings<PSCustomObject>
#>
function ConvertFrom-JsonToChangeSiteQuotaSettings {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => ChangeSiteQuotaSettings' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
