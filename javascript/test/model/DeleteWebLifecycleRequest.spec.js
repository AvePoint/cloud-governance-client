...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.DeleteWebLifecycleRequest();
  });
  ...
  describe('DeleteWebLifecycleRequest', function() {
    it('should create an instance of DeleteWebLifecycleRequest', function() {
      // uncomment below and update the code to test DeleteWebLifecycleRequest
      //var instane = new CloudGovernanceApi.DeleteWebLifecycleRequest();
      //expect(instance).to.be.a(CloudGovernanceApi.DeleteWebLifecycleRequest);
    });
