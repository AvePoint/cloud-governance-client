...
<#
RenewalTaskHookMessage<PSCustomObject>
#>

function New-RenewalTaskHookMessage {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => RenewalTaskHookMessage' | Write-Debug
...
RenewalTaskHookMessage<PSCustomObject>
#>
function ConvertFrom-JsonToRenewalTaskHookMessage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => RenewalTaskHookMessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RenewalTaskHookMessage
        $AllProperties = $("PhaseStartTime", "RenewalProfileName", "Message", "DueDate", "AssigneeDisplayName", "AssigneeIdentityName", "TaskLink", "ObjectTitle", "ObjectType", "ObjectTypeEnum", "GroupEmail", "TriggerType", "TriggerTime", "ObjectUrl", "ObjectId", "Summary")
