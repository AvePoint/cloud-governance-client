# RequestUserWithPermissionsUser
## Properties
...
```powershell
$RequestUserWithPermissionsUser = New-Cloud.Governance.ClientRequestUserWithPermissionsUser  -Id null `
 -LoginName null `
 -IsExternalUser null `
 -AzureUserType null `
 -DisplayName null `
...
```powershell
$RequestUserWithPermissionsUser | ConvertTo-JSON
```
