...
namespace Cloud.Governance.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GroupLifecycleRequest")]
    public partial class GroupLifecycleRequest : IEquatable<GroupLifecycleRequest>, IValidatableObject
    {
        /// <summary>
        /// Group type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupLifecycleRequest" /> class.
        /// </summary>
        ...
        public GroupLifecycleRequest(Guid groupId = default(Guid), GroupObjectType? groupObjectType = default(GroupObjectType?), Guid? id = default(Guid?), Guid serviceId = default(Guid), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<QuestionAnswerResponse> questionnaireResponse = default(List<QuestionAnswerResponse>), List<RequestMetadata> metadatas = default(List<RequestMetadata>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupLifecycleRequest {\n");
        ...
        {
            return this.Equals(input as GroupLifecycleRequest);
        }

        /// <summary>
        /// Returns true if GroupLifecycleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupLifecycleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupLifecycleRequest input)
        {
            if (input == null)
                return false;
