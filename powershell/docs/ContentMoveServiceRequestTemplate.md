# ContentMoveServiceRequestTemplate
## Properties
...
```powershell
$ContentMoveServiceRequestTemplate = New-Cloud.Governance.ClientContentMoveServiceRequestTemplate  -Method null `
 -CopySettings null `
 -MoveSettings null `
 -CommonSettings null `
 -ObjectMappings null `
...
```powershell
$ContentMoveServiceRequestTemplate | ConvertTo-JSON
```
