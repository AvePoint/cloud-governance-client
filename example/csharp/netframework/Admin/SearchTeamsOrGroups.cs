namespace NetFramework
{
    ...
    public class SearchTeamsOrGroups : TestBase
    {
        public SearchTeamsOrGroups(ApiConfig authData) : base(authData) { }
        ...
        public List<WorkspaceGridModel> Run()
        {
            ...
            try
            {
                ...
                do
                {
                    var pageResult = apiInstance.GetWorkspaces(filter: "type eq 'Group' or type eq 'Teams'", search: "test", nexttoken: nextToken);
