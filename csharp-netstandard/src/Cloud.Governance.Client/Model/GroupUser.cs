...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class GroupUser : IEquatable<GroupUser>, IValidatableObject
    {
        ...
        public GroupUser(bool isEnforce = default(bool), bool isHide = default(bool), string id = default(string), string loginName = default(string), ExternalUserType? isExternalUser = default(ExternalUserType?), string azureUserType = default(string), string displayName = default(string), bool isGroup = default(bool), bool isLocalUser = default(bool))
        {
