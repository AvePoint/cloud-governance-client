...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.ContentMoveRequest();
  });
  ...
  describe('ContentMoveRequest', function() {
    it('should create an instance of ContentMoveRequest', function() {
      // uncomment below and update the code to test ContentMoveRequest
      //var instane = new CloudGovernanceApi.ContentMoveRequest();
      //expect(instance).to.be.a(CloudGovernanceApi.ContentMoveRequest);
    });
    ...
    it('should have the property objectMappings (base name: "objectMappings")', function() {
      // uncomment below and update the code to test the property objectMappings
      //var instane = new CloudGovernanceApi.ContentMoveRequest();
      //expect(instance).to.be();
    });
