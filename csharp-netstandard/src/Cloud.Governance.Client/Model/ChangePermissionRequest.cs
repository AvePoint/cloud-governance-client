...
namespace Cloud.Governance.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChangePermissionRequest")]
    public partial class ChangePermissionRequest : IEquatable<ChangePermissionRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChangePermissionRequest" /> class.
        /// </summary>
        /// <param name="objectProperty">objectProperty.</param>
        /// <param name="permissionChangedType">permissionChangedType.</param>
        /// <param name="isManagedAllUsers">isManagedAllUsers.</param>
        ...
        public ChangePermissionRequest(PermissionObjectProperty objectProperty = default(PermissionObjectProperty), PermissionChangedType? permissionChangedType = default(PermissionChangedType?), bool isManagedAllUsers = default(bool), List<ApiUser> selectedUsers = default(List<ApiUser>), Guid? id = default(Guid?), Guid serviceId = default(Guid), string department = default(string), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<RequestMetadata> metadatas = default(List<RequestMetadata>), ServiceType? type = default(ServiceType?), string typeDescription = default(string), RequestStatus? status = default(RequestStatus?), int progressStatus = default(int), string progressStatusDescription = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets ObjectProperty
        /// </summary>
        [DataMember(Name = "objectProperty", EmitDefaultValue = false)]
        public PermissionObjectProperty ObjectProperty { get; set; }

        /// <summary>
        /// Gets or Sets IsManagedAllUsers
        /// </summary>
        [DataMember(Name = "isManagedAllUsers", EmitDefaultValue = false)]
        public bool IsManagedAllUsers { get; set; }

        /// <summary>
        /// Gets or Sets SelectedUsers
        /// </summary>
        [DataMember(Name = "selectedUsers", EmitDefaultValue = true)]
        public List<ApiUser> SelectedUsers { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChangePermissionRequest {\n");
            sb.Append("  ObjectProperty: ").Append(ObjectProperty).Append("\n");
            sb.Append("  PermissionChangedType: ").Append(PermissionChangedType).Append("\n");
            sb.Append("  IsManagedAllUsers: ").Append(IsManagedAllUsers).Append("\n");
        ...
        {
            return this.Equals(input as ChangePermissionRequest);
        }

        /// <summary>
        /// Returns true if ChangePermissionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ChangePermissionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChangePermissionRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.ObjectProperty == input.ObjectProperty ||
                    (this.ObjectProperty != null &&
                    this.ObjectProperty.Equals(input.ObjectProperty))
                ) && 
                (
                ...
                (
                    this.IsManagedAllUsers == input.IsManagedAllUsers ||
                    this.IsManagedAllUsers.Equals(input.IsManagedAllUsers)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ObjectProperty != null)
                    hashCode = hashCode * 59 + this.ObjectProperty.GetHashCode();
                hashCode = hashCode * 59 + this.PermissionChangedType.GetHashCode();
                hashCode = hashCode * 59 + this.IsManagedAllUsers.GetHashCode();
