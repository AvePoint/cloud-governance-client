# ChangeWebSettingServiceRequestTemplate
## Properties
...
```powershell
$ChangeWebSettingServiceRequestTemplate = New-Cloud.Governance.ClientChangeWebSettingServiceRequestTemplate  -Url null `
 -ChangedTitle null `
...
```powershell
$ChangeWebSettingServiceRequestTemplate | ConvertTo-JSON
```
