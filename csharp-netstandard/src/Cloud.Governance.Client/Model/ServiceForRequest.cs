...
namespace Cloud.Governance.Client.Model
{
    ...
    /// ServiceForRequest
    /// </summary>
    [DataContract(Name = "ServiceForRequest")]
    public partial class ServiceForRequest : IEquatable<ServiceForRequest>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceForRequest {\n");
        ...
        {
            return this.Equals(input as ServiceForRequest);
        }

        /// <summary>
        /// Returns true if ServiceForRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceForRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceForRequest input)
        {
            if (input == null)
                return false;
