...
function New-ChangeWebContactService {
    ...
    Param (
        ...
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [PSCustomObject]
        ${ChangeMethod} = "ChangeByUrl",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [PSCustomObject]
        ${ChangeMethodAssignBy} = "BusinessUser",
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [System.Nullable[Boolean]]
        ${EnableNotifyNewContact} = $false,
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
...
function ConvertFrom-JsonToChangeWebContactService {
    ...
    Process {
        ...
        $AllProperties = $("SelectedNodes", "UnCheckedNodesInfo", "ChangeMethod", "ChangeMethodAssignBy", "EnableNotifyNewContact", "NewContactNotifiedEmail", "ScopeSettings", "RequestTemplate", "Metadatas", "HideRequestSummary", "Id", "Name", "Description", "Type", "ServiceContact", "ServiceAdminContact", "ApproversContainManagerRole", "Status", "ShowServiceInCatalog", "CustomActions", "ApprovalProcessId", "LanguageId", "CategoryId")
