# SiteLifecycleServiceRequestTemplate
## Properties
...
```powershell
$SiteLifecycleServiceRequestTemplate = New-Cloud.Governance.ClientSiteLifecycleServiceRequestTemplate  -Action null `
...
```powershell
$SiteLifecycleServiceRequestTemplate | ConvertTo-JSON
```
