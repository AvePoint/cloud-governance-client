...
function ConvertFrom-JsonToGrantPermissionService {
    ...
    Process {
        ...
        $AllProperties = $("AllowBreakPermissionInheritance", "ScopeSettings", "UserLevelControlSettings", "PermissionDurationSettings", "PermissionSettings", "DefaultWelcomeEmailSettings", "WelcomeEmailAssignBy", "RequestTemplate", "Metadatas", "HideRequestSummary", "Id", "Name", "Description", "Type", "ServiceContact", "ServiceAdminContact", "ApproversContainManagerRole", "Status", "ShowServiceInCatalog", "CustomActions", "ApprovalProcessId", "LanguageId", "CategoryId")
