...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ExternalUserSharingSettings', 'model/GrantPermissionRequestDurationSettings', 'model/GrantPermissionRequestPermissionSettings', 'model/GrantPermissionSPObject', 'model/RequestMetadata', 'model/RequestStatusNullable', 'model/ServiceTypeNullable', 'model/SharingEnabledUser', 'model/WelcomeEmailSettings'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ExternalUserSharingSettings'), require('./GrantPermissionRequestDurationSettings'), require('./GrantPermissionRequestPermissionSettings'), require('./GrantPermissionSPObject'), require('./RequestMetadata'), require('./RequestStatusNullable'), require('./ServiceTypeNullable'), require('./SharingEnabledUser'), require('./WelcomeEmailSettings'));
  } else {
    // Browser globals (root is window)
    if (!root.CgClient) {
      root.CgClient = {};
    }
    root.CgClient.GrantPermissionRequest = factory(root.CgClient.ApiClient, root.CgClient.ExternalUserSharingSettings, root.CgClient.GrantPermissionRequestDurationSettings, root.CgClient.GrantPermissionRequestPermissionSettings, root.CgClient.GrantPermissionSPObject, root.CgClient.RequestMetadata, root.CgClient.RequestStatusNullable, root.CgClient.ServiceTypeNullable, root.CgClient.SharingEnabledUser, root.CgClient.WelcomeEmailSettings);
  }
}(this, function(ApiClient, ExternalUserSharingSettings, GrantPermissionRequestDurationSettings, GrantPermissionRequestPermissionSettings, GrantPermissionSPObject, RequestMetadata, RequestStatusNullable, ServiceTypeNullable, SharingEnabledUser, WelcomeEmailSettings) {
  'use strict';
   ...
   */
  exports.prototype['selectedUsers'] = undefined;
  /**
   * @member {module:model/ExternalUserSharingSettings} externalUserSharingSettings
   */
  exports.prototype['externalUserSharingSettings'] = undefined;
  /**
