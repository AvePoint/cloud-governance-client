...
namespace Cloud.Governance.Client.Model
{
    ...
    /// ArchiveSiteRequest
    /// </summary>
    [DataContract(Name = "ArchiveSiteRequest")]
    public partial class ArchiveSiteRequest : IEquatable<ArchiveSiteRequest>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Action
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchiveSiteRequest" /> class.
        /// </summary>
        ...
        public ArchiveSiteRequest(SiteLifecycleActionType? action = default(SiteLifecycleActionType?), string actionDescription = default(string), Guid siteId = default(Guid), string siteUrl = default(string), Guid? id = default(Guid?), Guid serviceId = default(Guid), string department = default(string), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<RequestMetadata> metadatas = default(List<RequestMetadata>), ServiceType? type = default(ServiceType?), string typeDescription = default(string), RequestStatus? status = default(RequestStatus?), int progressStatus = default(int), string progressStatusDescription = default(string))
        {
            this.Action = action;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ArchiveSiteRequest {\n");
        ...
        {
            return this.Equals(input as ArchiveSiteRequest);
        }

        /// <summary>
        /// Returns true if ArchiveSiteRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ArchiveSiteRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArchiveSiteRequest input)
        {
            if (input == null)
                return false;
