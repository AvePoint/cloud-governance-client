...
namespace Cloud.Governance.NewSdk.Model
{
    ...
    public partial class ChangeSiteContactRequest :  IEquatable<ChangeSiteContactRequest>, IValidatableObject
    {
        ...
        public ChangeSiteContactRequest(ChangeContactMethod changeContactMethod = default(ChangeContactMethod), List<ChangeContactByUrlSetting> changeByUrlSetting = default(List<ChangeContactByUrlSetting>), ChangeContactByUserSetting changeByUserSetting = default(ChangeContactByUserSetting), List<ChangeSiteContactSubRequest> subRequests = default(List<ChangeSiteContactSubRequest>), Guid? id = default(Guid?), Guid serviceId = default(Guid), string department = default(string), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<RequestMetadata> metadatas = default(List<RequestMetadata>), int? ticketNumber = default(int?), ServiceType type = default(ServiceType), string requester = default(string), RequestStatus status = default(RequestStatus), DateTime? submittedTime = default(DateTime?), DateTime? lastUpdated = default(DateTime?), DateTime? createdTime = default(DateTime?), string assignTo = default(string), string fullPath = default(string))
        {
        ...
        public List<ChangeSiteContactSubRequest> SubRequests { get; set; }
