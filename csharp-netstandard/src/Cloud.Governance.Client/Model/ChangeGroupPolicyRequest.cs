...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class ChangeGroupPolicyRequest : IEquatable<ChangeGroupPolicyRequest>, IValidatableObject
    {
        ...
        public ChangeGroupPolicyRequest(GuidModel policy = default(GuidModel), GuidModel originalPolicy = default(GuidModel), bool isLeaseEnabled = default(bool), AssignBy? changePolicyConfig = default(AssignBy?), StartDateType? startDateType = default(StartDateType?), DateTime? specifyStartDate = default(DateTime?), Guid groupId = default(Guid), Guid? id = default(Guid?), Guid serviceId = default(Guid), string department = default(string), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<RequestMetadata> metadatas = default(List<RequestMetadata>), ServiceType? type = default(ServiceType?), string typeDescription = default(string), RequestStatus? status = default(RequestStatus?), int progressStatus = default(int), string progressStatusDescription = default(string))
        {
            this.Policy = policy;
