...
{
    public class CreateGroup_ConstructGroupName : TestBase
    {
        public CreateGroup_ConstructGroupName(ApiConfig config) : base(config) { }
        ...
        public Guid Run(CreateGroupTestData data)
        {
            try
            {
                ...
                request.GroupNameWithoutPrefixSuffix = "Api_Sample_Group_" + ticks;
