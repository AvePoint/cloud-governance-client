...
namespace Cloud.Governance.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickRequestManagementModel :  IEquatable<QuickRequestManagementModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickRequestManagementModel" /> class.
        /// </summary>
        ...
        public QuickRequestManagementModel(bool isCategoryEnabledSelectAll = default(bool), List<Guid> selectedCategories = default(List<Guid>), bool isServiceEnabledSelectAll = default(bool), List<Guid> selectedServices = default(List<Guid>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QuickRequestManagementModel {\n");
        ...
        {
            return this.Equals(input as QuickRequestManagementModel);
        }

        /// <summary>
        /// Returns true if QuickRequestManagementModel instances are equal
        /// </summary>
        /// <param name="input">Instance of QuickRequestManagementModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickRequestManagementModel input)
        {
            if (input == null)
                return false;
