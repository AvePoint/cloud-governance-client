...
namespace Cloud.Governance.NewSdk.Model
{
    ...
    public partial class GroupValidationParameter :  IEquatable<GroupValidationParameter>, IValidatableObject
    {
        ...
        public GroupValidationParameter(Guid groupId = default(Guid), string groupEmail = default(string), bool isEditTask = default(bool), bool isFromQuestionnaire = default(bool))
        {
