...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.ContentMoveSPObject();
  });
  ...
  describe('ContentMoveSPObject', function() {
    it('should create an instance of ContentMoveSPObject', function() {
      // uncomment below and update the code to test ContentMoveSPObject
      //var instane = new CloudGovernanceApi.ContentMoveSPObject();
      //expect(instance).to.be.a(CloudGovernanceApi.ContentMoveSPObject);
    });
