...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BooleanChangedProperty', 'model/ChangeListSettingObjectInfo', 'model/ListVersionSettingsChangedProperty', 'model/RequestMetadata', 'model/RequestStatusNullable', 'model/ServiceTypeNullable', 'model/StringChangedProperty'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BooleanChangedProperty'), require('./ChangeListSettingObjectInfo'), require('./ListVersionSettingsChangedProperty'), require('./RequestMetadata'), require('./RequestStatusNullable'), require('./ServiceTypeNullable'), require('./StringChangedProperty'));
  } else {
    // Browser globals (root is window)
    if (!root.CgClient) {
      root.CgClient = {};
    }
    root.CgClient.ChangeListSettingRequest = factory(root.CgClient.ApiClient, root.CgClient.BooleanChangedProperty, root.CgClient.ChangeListSettingObjectInfo, root.CgClient.ListVersionSettingsChangedProperty, root.CgClient.RequestMetadata, root.CgClient.RequestStatusNullable, root.CgClient.ServiceTypeNullable, root.CgClient.StringChangedProperty);
  }
}(this, function(ApiClient, BooleanChangedProperty, ChangeListSettingObjectInfo, ListVersionSettingsChangedProperty, RequestMetadata, RequestStatusNullable, ServiceTypeNullable, StringChangedProperty) {
  'use strict';
   ...
   */
  exports.prototype['navigationSetting'] = undefined;
  /**
   * @member {module:model/ListVersionSettingsChangedProperty} versionSetting
   */
  exports.prototype['versionSetting'] = undefined;
  /**
   * @member {String} id
   */
