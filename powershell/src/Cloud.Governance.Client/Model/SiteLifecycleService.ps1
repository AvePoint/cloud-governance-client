...
<#
SiteLifecycleService<PSCustomObject>
#>

function New-SiteLifecycleService {
    [CmdletBinding()]
    Param (
        ...
        ${DisplayMetadataInAutoLifecycleTask} = $false,
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [PSCustomObject]
        ${ScopeSettings},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => SiteLifecycleService' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        
        $PSO = [PSCustomObject]@{
            "Action" = ${Action}
            "DisplayMetadataInAutoLifecycleTask" = ${DisplayMetadataInAutoLifecycleTask}
...
SiteLifecycleService<PSCustomObject>
#>
function ConvertFrom-JsonToSiteLifecycleService {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => SiteLifecycleService' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "DisplayMetadataInAutoLifecycleTask"))) { #optional property not found
            $DisplayMetadataInAutoLifecycleTask = $null
        } else {
            $DisplayMetadataInAutoLifecycleTask = $JsonParameters.PSobject.Properties["DisplayMetadataInAutoLifecycleTask"].value
        }
