...
Then import module from the .\src\Cloud.Governance.Client folder:
```powershell
Import-Module -Name '.\src\Cloud.Governance.Client'
```

To uninstall the module, simply run:
```powershell
Remove-Module -FullyQualifiedName @{ModuleName = "Cloud.Governance.Client"; ModuleVersion = "0.1.2"}
```
