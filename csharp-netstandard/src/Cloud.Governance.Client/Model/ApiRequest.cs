...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class ApiRequest : IEquatable<ApiRequest>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        public ApiRequest(Guid? id = default(Guid?), Guid serviceId = default(Guid), string department = default(string), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<RequestMetadata> metadatas = default(List<RequestMetadata>), ServiceType? type = default(ServiceType?), string typeDescription = default(string), RequestStatus? status = default(RequestStatus?), int progressStatus = default(int), string progressStatusDescription = default(string))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as ApiRequest);
        }

        /// <summary>
        /// Returns true if ApiRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiRequest input)
        {
            if (input == null)
                return false;
