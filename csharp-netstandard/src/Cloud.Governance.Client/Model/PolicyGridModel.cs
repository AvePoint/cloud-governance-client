...
namespace Cloud.Governance.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PolicyGridModel :  IEquatable<PolicyGridModel>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PolicyGridModel {\n");
        ...
        {
            return this.Equals(input as PolicyGridModel);
        }

        /// <summary>
        /// Returns true if PolicyGridModel instances are equal
        /// </summary>
        /// <param name="input">Instance of PolicyGridModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PolicyGridModel input)
        {
            if (input == null)
                return false;
