...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.ChangeSiteQuotaRequest();
  });
  ...
  describe('ChangeSiteQuotaRequest', function() {
    it('should create an instance of ChangeSiteQuotaRequest', function() {
      // uncomment below and update the code to test ChangeSiteQuotaRequest
      //var instane = new CloudGovernanceApi.ChangeSiteQuotaRequest();
      //expect(instance).to.be.a(CloudGovernanceApi.ChangeSiteQuotaRequest);
    });
