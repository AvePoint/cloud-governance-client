# CreateSiteRequestSecondaryContact
## Properties
...
```powershell
$CreateSiteRequestSecondaryContact = New-Cloud.Governance.ClientCreateSiteRequestSecondaryContact  -Id null `
 -LoginName null `
 -IsExternalUser null `
 -AzureUserType null `
 -DisplayName null `
...
```powershell
$CreateSiteRequestSecondaryContact | ConvertTo-JSON
```
