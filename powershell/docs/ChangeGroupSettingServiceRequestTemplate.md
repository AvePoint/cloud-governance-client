# ChangeGroupSettingServiceRequestTemplate
## Properties
...
```powershell
$ChangeGroupSettingServiceRequestTemplate = New-Cloud.Governance.ClientChangeGroupSettingServiceRequestTemplate  -GroupId null `
 -GroupEmail null `
 -GroupName null `
...
```powershell
$ChangeGroupSettingServiceRequestTemplate | ConvertTo-JSON
```
