...
namespace Cloud.Governance.Client.Model
{
    ...
    /// RestoreGroupRequest
    /// </summary>
    [DataContract(Name = "RestoreGroupRequest")]
    public partial class RestoreGroupRequest : IEquatable<RestoreGroupRequest>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RestoreGroupRequest" /> class.
        /// </summary>
        ...
        public RestoreGroupRequest(Guid groupId = default(Guid), Guid? id = default(Guid?), Guid serviceId = default(Guid), string department = default(string), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<RequestMetadata> metadatas = default(List<RequestMetadata>), ServiceType? type = default(ServiceType?), string typeDescription = default(string), RequestStatus? status = default(RequestStatus?), int progressStatus = default(int), string progressStatusDescription = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RestoreGroupRequest {\n");
        ...
        {
            return this.Equals(input as RestoreGroupRequest);
        }

        /// <summary>
        /// Returns true if RestoreGroupRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RestoreGroupRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RestoreGroupRequest input)
        {
            if (input == null)
                return false;
