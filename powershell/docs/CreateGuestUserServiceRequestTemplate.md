# CreateGuestUserServiceRequestTemplate
## Properties
...
```powershell
$CreateGuestUserServiceRequestTemplate = New-Cloud.Governance.ClientCreateGuestUserServiceRequestTemplate  -UserProperties null `
...
```powershell
$CreateGuestUserServiceRequestTemplate | ConvertTo-JSON
```
