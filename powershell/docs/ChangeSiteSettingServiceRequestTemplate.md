# ChangeSiteSettingServiceRequestTemplate
## Properties
...
```powershell
$ChangeSiteSettingServiceRequestTemplate = New-Cloud.Governance.ClientChangeSiteSettingServiceRequestTemplate  -SiteId null `
 -SiteUrl null `
 -SiteTitle null `
...
```powershell
$ChangeSiteSettingServiceRequestTemplate | ConvertTo-JSON
```
