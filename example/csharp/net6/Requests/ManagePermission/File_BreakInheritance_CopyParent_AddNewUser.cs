...
namespace NetFramework
{
    ...
    public class File_BreakInheritance_CopyParent_AddNewUser : TestBase
    {
        public File_BreakInheritance_CopyParent_AddNewUser(ApiConfig authData) : base(authData) { }
        ...
        public Guid Run(ManagePermissionTestData data)
        {
            try
            {
                ...
                request.Summary = $"Api_Sample_ManagePermission_BreakInheritancePermissionForFile_Request_{DateTime.Now}";
                request.ObjectUrl = data.ObjectUrl;
                request.ObjectType = NodeType.File;
