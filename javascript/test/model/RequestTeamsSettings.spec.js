...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.RequestTeamsSettings();
  });
  ...
  describe('RequestTeamsSettings', function() {
    it('should create an instance of RequestTeamsSettings', function() {
      // uncomment below and update the code to test RequestTeamsSettings
      //var instane = new CloudGovernanceApi.RequestTeamsSettings();
      //expect(instance).to.be.a(CloudGovernanceApi.RequestTeamsSettings);
    });
