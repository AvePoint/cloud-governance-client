...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.SPPrincipal();
  });
  ...
  describe('SPPrincipal', function() {
    it('should create an instance of SPPrincipal', function() {
      // uncomment below and update the code to test SPPrincipal
      //var instane = new CloudGovernanceApi.SPPrincipal();
      //expect(instance).to.be.a(CloudGovernanceApi.SPPrincipal);
    });
