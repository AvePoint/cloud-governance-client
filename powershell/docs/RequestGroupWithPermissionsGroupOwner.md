...
```powershell
$RequestGroupWithPermissionsGroupOwner = New-Cloud.Governance.ClientRequestGroupWithPermissionsGroupOwner  -Id null `
 -LoginName null `
 -IsExternalUser null `
 -AzureUserType null `
 -DisplayName null `
...
```powershell
$RequestGroupWithPermissionsGroupOwner | ConvertTo-JSON
```
