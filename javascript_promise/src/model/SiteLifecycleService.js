...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiUser', 'model/AssignBy', 'model/CommonStatus', 'model/CustomActionSettings', 'model/CustomMetadata', 'model/ServiceScopeSettings', 'model/ServiceType', 'model/SiteLifecycleActionType'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ApiUser'), require('./AssignBy'), require('./CommonStatus'), require('./CustomActionSettings'), require('./CustomMetadata'), require('./ServiceScopeSettings'), require('./ServiceType'), require('./SiteLifecycleActionType'));
  } else {
    // Browser globals (root is window)
    if (!root.CgClient) {
      root.CgClient = {};
    }
    root.CgClient.SiteLifecycleService = factory(root.CgClient.ApiClient, root.CgClient.ApiUser, root.CgClient.AssignBy, root.CgClient.CommonStatus, root.CgClient.CustomActionSettings, root.CgClient.CustomMetadata, root.CgClient.ServiceScopeSettings, root.CgClient.ServiceType, root.CgClient.SiteLifecycleActionType);
  }
}(this, function(ApiClient, ApiUser, AssignBy, CommonStatus, CustomActionSettings, CustomMetadata, ServiceScopeSettings, ServiceType, SiteLifecycleActionType) {
  'use strict';
   ...
   */
  exports.prototype['displayMetadataInAutoLifecycleTask'] = undefined;
  /**
