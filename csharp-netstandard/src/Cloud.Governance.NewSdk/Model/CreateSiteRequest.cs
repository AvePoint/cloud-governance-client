...
namespace Cloud.Governance.NewSdk.Model
{
    ...
    public partial class CreateSiteRequest :  IEquatable<CreateSiteRequest>, IValidatableObject
    {
        ...
        /// <param name="designType">designType.</param>
        ...
        /// <summary>
        /// Gets or Sets DesignType
        /// </summary>
        [DataMember(Name="designType", EmitDefaultValue=true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DesignType: ").Append(DesignType).Append("\n");
        ...
        public bool Equals(CreateSiteRequest input)
        {
            ...
            return 
                ...
                (
                    this.DesignType == input.DesignType ||
                    (this.DesignType != null &&
                    this.DesignType.Equals(input.DesignType))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DesignType != null)
                    hashCode = hashCode * 59 + this.DesignType.GetHashCode();
