...
.PARAMETER VarFilter
Use **eq**(equal) or **ne**(not equal) to filter the results (e.g. field1 eq 'value1' and field2 ne 'value2'), supported fields :<br/> id, description, name, serviceType, status, language, modifiedTime, createdByDisplayName, createdBy

.PARAMETER Orderby
Order by one field, supported fields:<br/> id, description, name, serviceType, status, language, modifiedTime, createdByDisplayName, createdBy
...
function Get-Services {
    ...
    Process {
        'Calling method: Get-Services' | Write-Debug
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -ReturnType "ServiceGridModelPageResult" `
