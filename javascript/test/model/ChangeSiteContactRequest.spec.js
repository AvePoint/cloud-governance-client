...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.ChangeSiteContactRequest();
  });
  ...
  describe('ChangeSiteContactRequest', function() {
    it('should create an instance of ChangeSiteContactRequest', function() {
      // uncomment below and update the code to test ChangeSiteContactRequest
      //var instane = new CloudGovernanceApi.ChangeSiteContactRequest();
      //expect(instance).to.be.a(CloudGovernanceApi.ChangeSiteContactRequest);
    });

    it('should have the property changeContactMethod (base name: "changeContactMethod")', function() {
      // uncomment below and update the code to test the property changeContactMethod
      //var instane = new CloudGovernanceApi.ChangeSiteContactRequest();
      //expect(instance).to.be();
    });

    it('should have the property changeByUrlSetting (base name: "changeByUrlSetting")', function() {
      // uncomment below and update the code to test the property changeByUrlSetting
      //var instane = new CloudGovernanceApi.ChangeSiteContactRequest();
      //expect(instance).to.be();
    });

    it('should have the property changeByUserSetting (base name: "changeByUserSetting")', function() {
      // uncomment below and update the code to test the property changeByUserSetting
      //var instane = new CloudGovernanceApi.ChangeSiteContactRequest();
      //expect(instance).to.be();
    });

    it('should have the property subRequests (base name: "subRequests")', function() {
      // uncomment below and update the code to test the property subRequests
      //var instane = new CloudGovernanceApi.ChangeSiteContactRequest();
      //expect(instance).to.be();
    });
