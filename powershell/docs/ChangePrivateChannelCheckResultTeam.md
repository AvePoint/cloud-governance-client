# ChangePrivateChannelCheckResultTeam
## Properties
...
```powershell
$ChangePrivateChannelCheckResultTeam = New-Cloud.Governance.ClientChangePrivateChannelCheckResultTeam  -Id null `
 -LoginName null `
 -IsExternalUser null `
 -AzureUserType null `
 -DisplayName null `
...
```powershell
$ChangePrivateChannelCheckResultTeam | ConvertTo-JSON
```
