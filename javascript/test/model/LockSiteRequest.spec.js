...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.LockSiteRequest();
  });
  ...
  describe('LockSiteRequest', function() {
    it('should create an instance of LockSiteRequest', function() {
      // uncomment below and update the code to test LockSiteRequest
      //var instane = new CloudGovernanceApi.LockSiteRequest();
      //expect(instance).to.be.a(CloudGovernanceApi.LockSiteRequest);
    });

    it('should have the property lockType (base name: "lockType")', function() {
      // uncomment below and update the code to test the property lockType
      //var instane = new CloudGovernanceApi.LockSiteRequest();
      //expect(instance).to.be();
    });

    it('should have the property lockTypeDescription (base name: "lockTypeDescription")', function() {
      // uncomment below and update the code to test the property lockTypeDescription
      //var instane = new CloudGovernanceApi.LockSiteRequest();
      //expect(instance).to.be();
    });
