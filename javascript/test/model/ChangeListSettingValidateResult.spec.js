...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.ChangeListSettingValidateResult();
  });
  ...
  describe('ChangeListSettingValidateResult', function() {
    it('should create an instance of ChangeListSettingValidateResult', function() {
      // uncomment below and update the code to test ChangeListSettingValidateResult
      //var instane = new CloudGovernanceApi.ChangeListSettingValidateResult();
      //expect(instance).to.be.a(CloudGovernanceApi.ChangeListSettingValidateResult);
    });
