# CreateListServiceRequestTemplate
## Properties
...
**PermissionSettings** | [**CreateListRequestPermissionSettings**](CreateListRequestPermissionSettings.md) |  | [optional] 
...
```powershell
$CreateListServiceRequestTemplate = New-Cloud.Governance.ClientCreateListServiceRequestTemplate  -ListTitle null `
 -ListName null `
...
```powershell
$CreateListServiceRequestTemplate | ConvertTo-JSON
```
