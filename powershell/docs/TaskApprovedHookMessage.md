...
```powershell
$TaskApprovedHookMessage = New-Cloud.Governance.ClientTaskApprovedHookMessage  -ApproverDisplayName null `
...
```powershell
$TaskApprovedHookMessage | ConvertTo-JSON
```
