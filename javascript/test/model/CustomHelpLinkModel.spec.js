...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.CustomHelpLinkModel();
  });
  ...
  describe('CustomHelpLinkModel', function() {
    it('should create an instance of CustomHelpLinkModel', function() {
      // uncomment below and update the code to test CustomHelpLinkModel
      //var instane = new CloudGovernanceApi.CustomHelpLinkModel();
      //expect(instance).to.be.a(CloudGovernanceApi.CustomHelpLinkModel);
    });
