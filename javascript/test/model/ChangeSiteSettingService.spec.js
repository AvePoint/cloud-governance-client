...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.ChangeSiteSettingService();
  });
  ...
  describe('ChangeSiteSettingService', function() {
    it('should create an instance of ChangeSiteSettingService', function() {
      // uncomment below and update the code to test ChangeSiteSettingService
      //var instane = new CloudGovernanceApi.ChangeSiteSettingService();
      //expect(instance).to.be.a(CloudGovernanceApi.ChangeSiteSettingService);
    });
