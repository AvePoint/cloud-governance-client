...
namespace Cloud.Governance.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChangeSiteContactService")]
    public partial class ChangeSiteContactService : IEquatable<ChangeSiteContactService>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets ChangeModeAssignBy
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChangeSiteContactService" /> class.
        /// </summary>
        /// <param name="enableChangeContact">enableChangeContact.</param>
        /// <param name="enableChangeAdmin">enableChangeAdmin.</param>
        ...
        /// <summary>
        /// Gets or Sets EnableChangeContact
        /// </summary>
        [DataMember(Name = "enableChangeContact", EmitDefaultValue = false)]
        public bool EnableChangeContact { get; set; }

        /// <summary>
        /// Gets or Sets EnableChangeAdmin
        /// </summary>
        [DataMember(Name = "enableChangeAdmin", EmitDefaultValue = false)]
        public bool EnableChangeAdmin { get; set; }
        ...
        public ChangeSiteContactRequest RequestTemplate { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChangeSiteContactService {\n");
            sb.Append("  EnableChangeContact: ").Append(EnableChangeContact).Append("\n");
            sb.Append("  EnableChangeAdmin: ").Append(EnableChangeAdmin).Append("\n");
        ...
        {
            return this.Equals(input as ChangeSiteContactService);
        }

        /// <summary>
        /// Returns true if ChangeSiteContactService instances are equal
        /// </summary>
        /// <param name="input">Instance of ChangeSiteContactService to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChangeSiteContactService input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.EnableChangeContact == input.EnableChangeContact ||
                    this.EnableChangeContact.Equals(input.EnableChangeContact)
                ) && 
                (
                    this.EnableChangeAdmin == input.EnableChangeAdmin ||
                    this.EnableChangeAdmin.Equals(input.EnableChangeAdmin)
                ) && 
                (
                ...
                (
                    this.ChangeModeAssignBy == input.ChangeModeAssignBy ||
                    this.ChangeModeAssignBy.Equals(input.ChangeModeAssignBy)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = hashCode * 59 + this.EnableChangeContact.GetHashCode();
                hashCode = hashCode * 59 + this.EnableChangeAdmin.GetHashCode();
                hashCode = hashCode * 59 + this.ChangedMethod.GetHashCode();
                hashCode = hashCode * 59 + this.ChangeModeAssignBy.GetHashCode();
