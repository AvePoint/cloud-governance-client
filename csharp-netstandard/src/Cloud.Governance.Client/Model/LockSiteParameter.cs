...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class LockSiteParameter : IEquatable<LockSiteParameter>, IValidatableObject
    {
        ...
        public LockSiteParameter(LockSiteCollectionType? lockType = default(LockSiteCollectionType?), bool isSendCancelEmail = false, Guid cancelEmailTemplateId = default(Guid), List<WorkspaceIdTypeModel> workspace = default(List<WorkspaceIdTypeModel>), bool isSelectAllWorkspace = false)
        {
