...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class ContentMoveRequest : IEquatable<ContentMoveRequest>, IValidatableObject
    {
        ...
        public ContentMoveRequest(ContentMoveMethod? method = default(ContentMoveMethod?), CopyMoveSetting copySettings = default(CopyMoveSetting), CopyMoveSetting moveSettings = default(CopyMoveSetting), ContentMoveCommonSetting commonSettings = default(ContentMoveCommonSetting), List<ContentMoveSPObjectMapping> objectMappings = default(List<ContentMoveSPObjectMapping>), Guid? id = default(Guid?), Guid serviceId = default(Guid), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<QuestionAnswerResponse> questionnaireResponse = default(List<QuestionAnswerResponse>), List<RequestMetadata> metadatas = default(List<RequestMetadata>))
        {
            this.Method = method;
