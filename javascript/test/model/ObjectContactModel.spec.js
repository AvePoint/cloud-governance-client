...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.ObjectContactModel();
  });
  ...
  describe('ObjectContactModel', function() {
    it('should create an instance of ObjectContactModel', function() {
      // uncomment below and update the code to test ObjectContactModel
      //var instane = new CloudGovernanceApi.ObjectContactModel();
      //expect(instance).to.be.a(CloudGovernanceApi.ObjectContactModel);
    });
