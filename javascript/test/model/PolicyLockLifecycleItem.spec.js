...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.PolicyLockLifecycleItem();
  });
  ...
  describe('PolicyLockLifecycleItem', function() {
    it('should create an instance of PolicyLockLifecycleItem', function() {
      // uncomment below and update the code to test PolicyLockLifecycleItem
      //var instane = new CloudGovernanceApi.PolicyLockLifecycleItem();
      //expect(instance).to.be.a(CloudGovernanceApi.PolicyLockLifecycleItem);
    });
