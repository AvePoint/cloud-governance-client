# WebLifecycleServiceRequestTemplate
## Properties
...
```powershell
$WebLifecycleServiceRequestTemplate = New-Cloud.Governance.ClientWebLifecycleServiceRequestTemplate  -WebId null `
 -WebUrl null `
 -WebRelativeUrl null `
 -WebTitle null `
 -SiteId null `
...
```powershell
$WebLifecycleServiceRequestTemplate | ConvertTo-JSON
```
