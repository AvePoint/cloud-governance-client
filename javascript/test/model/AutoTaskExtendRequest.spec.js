...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.AutoTaskExtendRequest();
  });
  ...
  describe('AutoTaskExtendRequest', function() {
    it('should create an instance of AutoTaskExtendRequest', function() {
      // uncomment below and update the code to test AutoTaskExtendRequest
      //var instane = new CloudGovernanceApi.AutoTaskExtendRequest();
      //expect(instance).to.be.a(CloudGovernanceApi.AutoTaskExtendRequest);
    });
