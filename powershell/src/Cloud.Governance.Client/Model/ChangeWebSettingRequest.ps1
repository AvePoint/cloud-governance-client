...
function New-ChangeWebSettingRequest {
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => ChangeWebSettingRequest' | Write-Debug
...
ChangeWebSettingRequest<PSCustomObject>
#>
function ConvertFrom-JsonToChangeWebSettingRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => ChangeWebSettingRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "ChangedTitle"))) { #optional property not found
            $ChangedTitle = $null
        } else {
            $ChangedTitle = $JsonParameters.PSobject.Properties["ChangedTitle"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "ChangedDescription"))) { #optional property not found
            $ChangedDescription = $null
        } else {
            $ChangedDescription = $JsonParameters.PSobject.Properties["ChangedDescription"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "ChangedMetadata"))) { #optional property not found
            $ChangedMetadata = $null
        } else {
            $ChangedMetadata = $JsonParameters.PSobject.Properties["ChangedMetadata"].value
        }
