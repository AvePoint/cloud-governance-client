...
namespace Cloud.Governance.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChangePrivateChannelService")]
    public partial class ChangePrivateChannelService : IEquatable<ChangePrivateChannelService>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChangePrivateChannelService" /> class.
        /// </summary>
        /// <param name="changePrivateChannelFields">Change PrivateChannel fields.</param>
        ...
        /// <summary>
        /// Change PrivateChannel fields
        /// </summary>
        /// <value>Change PrivateChannel fields</value>
        [DataMember(Name = "changePrivateChannelFields", EmitDefaultValue = true)]
        public List<ChangePrivateChannelFieldModel> ChangePrivateChannelFields { get; set; }
        ...
        /// </summary>
        /// <value>Base model of request.</value>
        [DataMember(Name = "requestTemplate", EmitDefaultValue = true)]
        public ApiRequest RequestTemplate { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChangePrivateChannelService {\n");
            sb.Append("  ChangePrivateChannelFields: ").Append(ChangePrivateChannelFields).Append("\n");
        ...
        {
            return this.Equals(input as ChangePrivateChannelService);
        }

        /// <summary>
        /// Returns true if ChangePrivateChannelService instances are equal
        /// </summary>
        /// <param name="input">Instance of ChangePrivateChannelService to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChangePrivateChannelService input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.ChangePrivateChannelFields == input.ChangePrivateChannelFields ||
                    this.ChangePrivateChannelFields != null &&
                    input.ChangePrivateChannelFields != null &&
                    this.ChangePrivateChannelFields.SequenceEqual(input.ChangePrivateChannelFields)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.ChangePrivateChannelFields != null)
                    hashCode = hashCode * 59 + this.ChangePrivateChannelFields.GetHashCode();
