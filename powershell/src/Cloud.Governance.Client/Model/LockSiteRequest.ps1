...
<#
LockSiteRequest<PSCustomObject>
#>

function New-LockSiteRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => LockSiteRequest' | Write-Debug
...
LockSiteRequest<PSCustomObject>
#>
function ConvertFrom-JsonToLockSiteRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => LockSiteRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LockSiteRequest
        $AllProperties = $("LockType", "LockTypeDescription", "Action", "ActionDescription", "SiteId", "SiteUrl", "Id", "ServiceId", "Department", "Summary", "NotesToApprovers", "QuestionnaireId", "Metadatas", "TicketNumber", "Type", "TypeDescription", "Requester", "RequesterLoginName", "Status", "ProgressStatus", "ProgressStatusDescription", "SubmittedTime", "LastUpdated", "CreatedTime", "AssignTo", "FullPath")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "LockTypeDescription"))) { #optional property not found
            $LockTypeDescription = $null
        } else {
            $LockTypeDescription = $JsonParameters.PSobject.Properties["LockTypeDescription"].value
        }
        ...
        $PSO = [PSCustomObject]@{
            "LockType" = ${LockType}
            "LockTypeDescription" = ${LockTypeDescription}
            "Action" = ${Action}
