...
namespace Cloud.Governance.Client.Model
{
    ...
    /// CreateListRequest
    /// </summary>
    [DataContract(Name = "CreateListRequest")]
    public partial class CreateListRequest : IEquatable<CreateListRequest>, IValidatableObject
    {
        ...
        public CreateListRequest(string listTitle = default(string), string listName = default(string), string listDescription = default(string), CreateListSPObject parentObject = default(CreateListSPObject), string listTemplate = default(string), bool enableNavigation = default(bool), ListType? listType = default(ListType?), ListVersionSettings versionSettings = default(ListVersionSettings), ListPermissionSettings permissionSettings = default(ListPermissionSettings), Guid? id = default(Guid?), Guid serviceId = default(Guid), string department = default(string), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<RequestMetadata> metadatas = default(List<RequestMetadata>), ServiceType? type = default(ServiceType?), string typeDescription = default(string), RequestStatus? status = default(RequestStatus?), int progressStatus = default(int), string progressStatusDescription = default(string))
        {
