namespace NetFramework
{
    ...
    using System;
    public class CreateGuestUser_EnableOneTimeRenewal_Specific : TestBase
    {
        public CreateGuestUser_EnableOneTimeRenewal_Specific(ApiConfig config) : base(config) { }
        ...
        public Guid Run(CreateGuestUserTestData data)
        {
            try
            {
                ...
                request.Summary = $"Api_Sample_CreateGuestUser_SetOneTimeRenewal_Specific_{DateTime.Now}";
                ...
                request.OneTimeSettings.Option = OneTimeRenewalOption.Specific;
                request.OneTimeSettings.StartTime = DateTime.UtcNow.AddDays(3);
