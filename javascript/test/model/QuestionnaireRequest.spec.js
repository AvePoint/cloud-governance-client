...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.QuestionnaireRequest();
  });
  ...
  describe('QuestionnaireRequest', function() {
    it('should create an instance of QuestionnaireRequest', function() {
      // uncomment below and update the code to test QuestionnaireRequest
      //var instane = new CloudGovernanceApi.QuestionnaireRequest();
      //expect(instance).to.be.a(CloudGovernanceApi.QuestionnaireRequest);
    });
