...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.ApiUser();
  });
  ...
  describe('ApiUser', function() {
    it('should create an instance of ApiUser', function() {
      // uncomment below and update the code to test ApiUser
      //var instane = new CloudGovernanceApi.ApiUser();
      //expect(instance).to.be.a(CloudGovernanceApi.ApiUser);
    });
