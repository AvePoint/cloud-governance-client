# CreateGroupRequestPrimaryContact
## Properties
...
```powershell
$CreateGroupRequestPrimaryContact = New-Cloud.Governance.ClientCreateGroupRequestPrimaryContact  -Id null `
 -LoginName null `
 -IsExternalUser null `
 -AzureUserType null `
 -DisplayName null `
...
```powershell
$CreateGroupRequestPrimaryContact | ConvertTo-JSON
```
