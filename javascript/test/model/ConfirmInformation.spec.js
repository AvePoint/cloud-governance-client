...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.ConfirmInformation();
  });
  ...
  describe('ConfirmInformation', function() {
    it('should create an instance of ConfirmInformation', function() {
      // uncomment below and update the code to test ConfirmInformation
      //var instane = new CloudGovernanceApi.ConfirmInformation();
      //expect(instance).to.be.a(CloudGovernanceApi.ConfirmInformation);
    });
