...
namespace Cloud.Governance.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreatePrivateChannelService")]
    public partial class CreatePrivateChannelService : IEquatable<CreatePrivateChannelService>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets OwnersAssignBy
        /// </summary>
        [DataMember(Name = "ownersAssignBy", EmitDefaultValue = false)]
        public AssignBy? OwnersAssignBy { get; set; }
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        {
            return this.Equals(input as CreatePrivateChannelService);
        }

        /// <summary>
        /// Returns true if CreatePrivateChannelService instances are equal
        /// </summary>
        /// <param name="input">Instance of CreatePrivateChannelService to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreatePrivateChannelService input)
        {
            if (input == null)
                return false;
