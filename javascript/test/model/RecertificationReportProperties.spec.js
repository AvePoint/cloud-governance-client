...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.RecertificationReportProperties();
  });
  ...
  describe('RecertificationReportProperties', function() {
    it('should create an instance of RecertificationReportProperties', function() {
      // uncomment below and update the code to test RecertificationReportProperties
      //var instane = new CloudGovernanceApi.RecertificationReportProperties();
      //expect(instance).to.be.a(CloudGovernanceApi.RecertificationReportProperties);
    });
