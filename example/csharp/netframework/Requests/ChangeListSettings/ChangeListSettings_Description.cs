...
namespace NetFramework
{
    ...
    public class ChangeListSettings_Description : TestBase
    {
        public ChangeListSettings_Description(ApiConfig config) : base(config) { }
        ...
        public Guid Run(ChangeListSettingsTestData data)
        {
            try
            {
                ...
                request.ListDescription.ChangeValue = $"{data.Description}_{DateTime.Now}";
