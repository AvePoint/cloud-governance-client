...
namespace Cloud.Governance.NewSdk.Model
{
    ...
    public partial class ApiRequest :  IEquatable<ApiRequest>, IValidatableObject
    {
        ...
        public ApiRequest(Guid? id = default(Guid?), Guid serviceId = default(Guid), string department = default(string), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<RequestMetadata> metadatas = default(List<RequestMetadata>), int? ticketNumber = default(int?), ServiceType type = default(ServiceType), string requester = default(string), RequestStatus status = default(RequestStatus), DateTime? submittedTime = default(DateTime?), DateTime? lastUpdated = default(DateTime?), DateTime? createdTime = default(DateTime?), string assignTo = default(string), string fullPath = default(string))
        {
            this.Id = id;
