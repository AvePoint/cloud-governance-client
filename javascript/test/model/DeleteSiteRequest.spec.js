...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.DeleteSiteRequest();
  });
  ...
  describe('DeleteSiteRequest', function() {
    it('should create an instance of DeleteSiteRequest', function() {
      // uncomment below and update the code to test DeleteSiteRequest
      //var instane = new CloudGovernanceApi.DeleteSiteRequest();
      //expect(instance).to.be.a(CloudGovernanceApi.DeleteSiteRequest);
    });
