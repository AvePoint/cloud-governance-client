...
<#
TaskHookMessage<PSCustomObject>
#>

function New-TaskHookMessage {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => TaskHookMessage' | Write-Debug
...
TaskHookMessage<PSCustomObject>
#>
function ConvertFrom-JsonToTaskHookMessage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => TaskHookMessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TaskHookMessage
        $AllProperties = $("TaskId", "TaskLink", "AssigneeDisplayName", "AssigneeIdentityName", "ApproverDisplayName", "ApproverIdentityName", "Message", "RequestId", "RequestGuid", "RequesterIdentityName", "Requester", "ServiceType", "ServiceTypeEnum", "TriggerType", "TriggerTime", "ObjectUrl", "ObjectId", "Summary")
