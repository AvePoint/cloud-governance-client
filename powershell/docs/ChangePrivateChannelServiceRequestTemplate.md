# ChangePrivateChannelServiceRequestTemplate
## Properties
...
```powershell
$ChangePrivateChannelServiceRequestTemplate = New-Cloud.Governance.ClientChangePrivateChannelServiceRequestTemplate  -Id null `
 -ServiceId null `
 -Summary null `
...
```powershell
$ChangePrivateChannelServiceRequestTemplate | ConvertTo-JSON
```
