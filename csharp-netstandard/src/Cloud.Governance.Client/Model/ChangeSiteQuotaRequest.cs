...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class ChangeSiteQuotaRequest : IEquatable<ChangeSiteQuotaRequest>, IValidatableObject
    {
        ...
        public ChangeSiteQuotaRequest(int quotaSize = 0, double? sharePointSiteSize = default(double?), double? currentQuota = default(double?), SiteLifecycleActionType? action = default(SiteLifecycleActionType?), Guid siteId = default(Guid), string siteUrl = default(string), string siteTitle = default(string), Guid? id = default(Guid?), Guid serviceId = default(Guid), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<QuestionAnswerResponse> questionnaireResponse = default(List<QuestionAnswerResponse>), List<RequestMetadata> metadatas = default(List<RequestMetadata>))
        {
