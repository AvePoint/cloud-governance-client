...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class ClonePermissionRequest : IEquatable<ClonePermissionRequest>, IValidatableObject
    {
        ...
        public ClonePermissionRequest(List<string> urls = default(List<string>), ApiUser sourceUser = default(ApiUser), ApiUser targetUser = default(ApiUser), ClonePermissionOption? cloneOption = default(ClonePermissionOption?), ClonePermissionAdditionalOption? additionalCloneOption = default(ClonePermissionAdditionalOption?), bool enabledRemoveExplicitPermission = false, bool enabledRemoveUserFromSPGroup = false, bool enabledDeleteUserPermission = false, Guid? id = default(Guid?), Guid serviceId = default(Guid), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<QuestionAnswerResponse> questionnaireResponse = default(List<QuestionAnswerResponse>), List<RequestMetadata> metadatas = default(List<RequestMetadata>))
        {
            this.Urls = urls;
