...
/**
 * The ArchiveSiteRequest model module.
 * @module model/ArchiveSiteRequest
 * @version 1.0
 */
class ArchiveSiteRequest {
    /**
     * Constructs a new <code>ArchiveSiteRequest</code>.
     * @alias module:model/ArchiveSiteRequest
     */
    constructor() { 
        
        ArchiveSiteRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ArchiveSiteRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ArchiveSiteRequest} obj Optional instance to populate.
     * @return {module:model/ArchiveSiteRequest} The populated <code>ArchiveSiteRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ArchiveSiteRequest();
 ...
 */
ArchiveSiteRequest.prototype['action'] = undefined;

/**
 * @member {String} actionDescription
 */
ArchiveSiteRequest.prototype['actionDescription'] = undefined;

/**
 * @member {String} siteId
 */
ArchiveSiteRequest.prototype['siteId'] = undefined;

/**
 * @member {String} siteUrl
 */
ArchiveSiteRequest.prototype['siteUrl'] = undefined;

/**
 * @member {String} id
 */
ArchiveSiteRequest.prototype['id'] = undefined;

/**
 * @member {String} serviceId
 */
ArchiveSiteRequest.prototype['serviceId'] = undefined;

/**
 * @member {String} department
 */
ArchiveSiteRequest.prototype['department'] = undefined;

/**
 * @member {String} summary
 */
ArchiveSiteRequest.prototype['summary'] = undefined;

/**
 * @member {String} notesToApprovers
 */
ArchiveSiteRequest.prototype['notesToApprovers'] = undefined;

/**
 * @member {String} questionnaireId
 */
ArchiveSiteRequest.prototype['questionnaireId'] = undefined;

/**
 * @member {Array.<module:model/RequestMetadata>} metadatas
 */
ArchiveSiteRequest.prototype['metadatas'] = undefined;

/**
 * @member {Number} ticketNumber
 */
ArchiveSiteRequest.prototype['ticketNumber'] = undefined;

/**
 * @member {module:model/ServiceType} type
 */
ArchiveSiteRequest.prototype['type'] = undefined;

/**
 * @member {String} typeDescription
 */
ArchiveSiteRequest.prototype['typeDescription'] = undefined;

/**
 * @member {String} requester
 */
ArchiveSiteRequest.prototype['requester'] = undefined;

/**
 * @member {module:model/RequestStatus} status
 */
ArchiveSiteRequest.prototype['status'] = undefined;

/**
 * @member {Number} progressStatus
 */
ArchiveSiteRequest.prototype['progressStatus'] = undefined;

/**
 * @member {String} progressStatusDescription
 */
ArchiveSiteRequest.prototype['progressStatusDescription'] = undefined;

/**
 * @member {Date} submittedTime
 */
ArchiveSiteRequest.prototype['submittedTime'] = undefined;

/**
 * @member {Date} lastUpdated
 */
ArchiveSiteRequest.prototype['lastUpdated'] = undefined;

/**
 * @member {Date} createdTime
 */
ArchiveSiteRequest.prototype['createdTime'] = undefined;

/**
 * @member {String} assignTo
 */
ArchiveSiteRequest.prototype['assignTo'] = undefined;

/**
 * @member {String} fullPath
 */
ArchiveSiteRequest.prototype['fullPath'] = undefined;
...
export default ArchiveSiteRequest;
