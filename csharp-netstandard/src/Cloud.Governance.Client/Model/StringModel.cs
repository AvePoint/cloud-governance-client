...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class StringModel : IEquatable<StringModel>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as StringModel);
        }

        /// <summary>
        /// Returns true if StringModel instances are equal
        /// </summary>
        /// <param name="input">Instance of StringModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StringModel input)
        {
            if (input == null)
                return false;
