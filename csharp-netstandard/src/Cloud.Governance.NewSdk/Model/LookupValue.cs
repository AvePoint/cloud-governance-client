...
namespace Cloud.Governance.NewSdk.Model
{
    ...
    public partial class LookupValue :  IEquatable<LookupValue>, IValidatableObject
    {
        ...
        public LookupValue(string tenant = default(string), string property = default(string), ApiUser targetUser = default(ApiUser), string userPropertyValue = default(string), string userPropertyDisplayValue = default(string))
        {
            this.Tenant = tenant;
