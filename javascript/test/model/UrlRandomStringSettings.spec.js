...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.UrlRandomStringSettings();
  });
  ...
  describe('UrlRandomStringSettings', function() {
    it('should create an instance of UrlRandomStringSettings', function() {
      // uncomment below and update the code to test UrlRandomStringSettings
      //var instane = new CloudGovernanceApi.UrlRandomStringSettings();
      //expect(instance).to.be.a(CloudGovernanceApi.UrlRandomStringSettings);
    });
