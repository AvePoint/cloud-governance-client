# ManagePermissionValidateResultObject
## Properties
...
```powershell
$ManagePermissionValidateResultObject = New-Cloud.Governance.ClientManagePermissionValidateResultObject  -ParentUrl null `
 -ParentNodeType null `
 -SiteUrl null `
 -WebUrl null `
...
```powershell
$ManagePermissionValidateResultObject | ConvertTo-JSON
```
