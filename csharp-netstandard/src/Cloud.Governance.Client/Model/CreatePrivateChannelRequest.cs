...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class CreatePrivateChannelRequest : IEquatable<CreatePrivateChannelRequest>, IValidatableObject
    {
        ...
        public CreatePrivateChannelRequest(string name = default(string), string channelDescription = default(string), List<ApiUser> owners = default(List<ApiUser>), List<ApiUser> members = default(List<ApiUser>), ApiUser team = default(ApiUser), string channelWebUrl = default(string), Guid? id = default(Guid?), Guid serviceId = default(Guid), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<RequestMetadata> metadatas = default(List<RequestMetadata>))
        {
            this.Name = name;
