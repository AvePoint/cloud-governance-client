...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.ChangeWebSPObject();
  });
  ...
  describe('ChangeWebSPObject', function() {
    it('should create an instance of ChangeWebSPObject', function() {
      // uncomment below and update the code to test ChangeWebSPObject
      //var instane = new CloudGovernanceApi.ChangeWebSPObject();
      //expect(instance).to.be.a(CloudGovernanceApi.ChangeWebSPObject);
    });
