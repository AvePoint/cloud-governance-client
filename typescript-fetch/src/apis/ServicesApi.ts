...
export interface AddCreateListServiceRequest {
    createSiteService?: CreateSiteService;
}

export interface AddCreateWebServiceRequest {
...
export interface GetMyServicesWithContextRequest {
...
export class ServicesApi extends runtime.BaseAPI {
     ...
     */
    async addCreateListServiceRaw(requestParameters: AddCreateListServiceRequest): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/services/createsite`,
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: CreateSiteServiceToJSON(requestParameters.createSiteService),
        });
     ...
     * Add create site service
     */
    async addCreateListService(requestParameters: AddCreateListServiceRequest): Promise<string> {
        const response = await this.addCreateListServiceRaw(requestParameters);
        return await response.value();
    }

    /**
     */
    async addCreateWebServiceRaw(requestParameters: AddCreateWebServiceRequest): Promise<runtime.ApiResponse<string>> {
        const queryParameters: runtime.HTTPQuery = {};
        ...
        const response = await this.request({
            path: `/services/createweb`,
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: CreateWebServiceToJSON(requestParameters.createWebService),
        });
    ...
    /**
     */
    async addCreateWebService(requestParameters: AddCreateWebServiceRequest): Promise<string> {
        const response = await this.addCreateWebServiceRaw(requestParameters);
        return await response.value();
    }
     ...
     */
    async getMyQuickServicesRaw(): Promise<runtime.ApiResponse<Array<ServiceList>>> {
        const queryParameters: runtime.HTTPQuery = {};
     ...
     * get configued quick services that can be used to start a request
     */
    async getMyQuickServices(): Promise<Array<ServiceList>> {
        const response = await this.getMyQuickServicesRaw();
        return await response.value();
    }
     ...
     */
    async getMyServicesWithContextRaw(requestParameters: GetMyServicesWithContextRequest): Promise<runtime.ApiResponse<Array<ServiceList>>> {
        if (requestParameters.objecttype === null || requestParameters.objecttype === undefined) {
            throw new runtime.RequiredError('objecttype','Required parameter requestParameters.objecttype was null or undefined when calling getMyServicesWithContext.');
        }

        if (requestParameters.objectid === null || requestParameters.objectid === undefined) {
            throw new runtime.RequiredError('objectid','Required parameter requestParameters.objectid was null or undefined when calling getMyServicesWithContext.');
        }
        ...
        const response = await this.request({
            path: `/services/my/workspace/{objecttype}/{objectid}`.replace(`{${"objecttype"}}`, encodeURIComponent(String(requestParameters.objecttype))).replace(`{${"objectid"}}`, encodeURIComponent(String(requestParameters.objectid))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        });
     ...
     * get services that can be used to start a request within context
     */
    async getMyServicesWithContext(requestParameters: GetMyServicesWithContextRequest): Promise<Array<ServiceList>> {
        const response = await this.getMyServicesWithContextRaw(requestParameters);
        return await response.value();
    }
