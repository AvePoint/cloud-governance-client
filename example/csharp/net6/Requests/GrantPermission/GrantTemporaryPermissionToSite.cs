namespace NetFramework
{
    ...
    using System.Net;
    public class GrantTemporaryPermissionToSite : TestBase
    {
        public GrantTemporaryPermissionToSite(ApiConfig authData) : base(authData) { }
        ...
        public Guid Run(GrantPermissionTestData data)
        {
            try
            {
                ...
                var permissionDurationSetting = new GrantPermissionRequestDurationSettings
                {
                    ...
                    DurationDateType = DurationDateType.Day,
                    DurationInterval = 3
                };
                #endregion

                request.Summary = $"Summary_GrantTemporaryPermission_Duration_{DateTime.Now}";
