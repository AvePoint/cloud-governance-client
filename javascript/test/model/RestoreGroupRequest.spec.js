...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.RestoreGroupRequest();
  });
  ...
  describe('RestoreGroupRequest', function() {
    it('should create an instance of RestoreGroupRequest', function() {
      // uncomment below and update the code to test RestoreGroupRequest
      //var instane = new CloudGovernanceApi.RestoreGroupRequest();
      //expect(instance).to.be.a(CloudGovernanceApi.RestoreGroupRequest);
    });
