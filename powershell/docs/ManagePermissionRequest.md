...
**ObjectType** | [**NodeType**](NodeType.md) |  | [optional] [default to null]
**ObjectTitle** | **String** |  | [optional] [default to null]
**SiteUrl** | **String** |  | [optional] [default to null]
**WebUrl** | **String** |  | [optional] [default to null]
**SpGroupManagement** | [**SPGroupManagementModel[]**](SPGroupManagementModel.md) |  | [optional] [default to null]
**PermissionManagement** | [**PermissionManagementModel**](PermissionManagementModel.md) |  | [optional] [default to null]
...
- Create a new object
```powershell
New-Cloud.Governance.ClientManagePermissionRequest  -ObjectUrl null `
 -ObjectType null `
 -ObjectTitle null `
 -SiteUrl null `
 -WebUrl null `
