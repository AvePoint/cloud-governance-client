...
<#
SiteLifecycleRequest<PSCustomObject>
#>

function New-SiteLifecycleRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => SiteLifecycleRequest' | Write-Debug
...
SiteLifecycleRequest<PSCustomObject>
#>
function ConvertFrom-JsonToSiteLifecycleRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
