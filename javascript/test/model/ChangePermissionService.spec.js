...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.ChangePermissionService();
  });
  ...
  describe('ChangePermissionService', function() {
    it('should create an instance of ChangePermissionService', function() {
      // uncomment below and update the code to test ChangePermissionService
      //var instane = new CloudGovernanceApi.ChangePermissionService();
      //expect(instance).to.be.a(CloudGovernanceApi.ChangePermissionService);
    });
    ...
    it('should have the property userRestrictionType (base name: "userRestrictionType")', function() {
      // uncomment below and update the code to test the property userRestrictionType
      //var instane = new CloudGovernanceApi.ChangePermissionService();
      //expect(instance).to.be();
    });
    ...
    it('should have the property permissionChangedTypeAssignBy (base name: "permissionChangedTypeAssignBy")', function() {
      // uncomment below and update the code to test the property permissionChangedTypeAssignBy
      //var instane = new CloudGovernanceApi.ChangePermissionService();
      //expect(instance).to.be();
    });

    it('should have the property enabledExcludePermissions (base name: "enabledExcludePermissions")', function() {
      // uncomment below and update the code to test the property enabledExcludePermissions
      //var instane = new CloudGovernanceApi.ChangePermissionService();
      //expect(instance).to.be();
    });

    it('should have the property excludedPermissions (base name: "excludedPermissions")', function() {
      // uncomment below and update the code to test the property excludedPermissions
      //var instane = new CloudGovernanceApi.ChangePermissionService();
      //expect(instance).to.be();
    });

    it('should have the property reviewTaskEmailTemplate (base name: "reviewTaskEmailTemplate")', function() {
      // uncomment below and update the code to test the property reviewTaskEmailTemplate
      //var instane = new CloudGovernanceApi.ChangePermissionService();
      //expect(instance).to.be();
    });
