...
function New-DeleteWebLifecycleRequest {
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => DeleteWebLifecycleRequest' | Write-Debug
...
DeleteWebLifecycleRequest<PSCustomObject>
#>
function ConvertFrom-JsonToDeleteWebLifecycleRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => DeleteWebLifecycleRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeleteWebLifecycleRequest
