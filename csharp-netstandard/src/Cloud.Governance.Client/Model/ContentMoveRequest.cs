...
namespace Cloud.Governance.Client.Model
{
    ...
    /// ContentMoveRequest
    /// </summary>
    [DataContract(Name = "ContentMoveRequest")]
    public partial class ContentMoveRequest : IEquatable<ContentMoveRequest>, IValidatableObject
    {
        ...
        public ContentMoveRequest(ContentMoveMethod? method = default(ContentMoveMethod?), CopyMoveSetting copySettings = default(CopyMoveSetting), CopyMoveSetting moveSettings = default(CopyMoveSetting), ContentMoveCommonSetting commonSettings = default(ContentMoveCommonSetting), List<ContentMoveSPObjectMapping> objectMappings = default(List<ContentMoveSPObjectMapping>), Guid? id = default(Guid?), Guid serviceId = default(Guid), string department = default(string), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<RequestMetadata> metadatas = default(List<RequestMetadata>), ServiceType? type = default(ServiceType?), string typeDescription = default(string), RequestStatus? status = default(RequestStatus?), int progressStatus = default(int), string progressStatusDescription = default(string))
        {
            this.Method = method;
