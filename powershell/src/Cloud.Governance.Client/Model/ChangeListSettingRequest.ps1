...
<#
ChangeListSettingRequest<PSCustomObject>
#>

function New-ChangeListSettingRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => ChangeListSettingRequest' | Write-Debug
...
ChangeListSettingRequest<PSCustomObject>
#>
function ConvertFrom-JsonToChangeListSettingRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => ChangeListSettingRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ChangeListSettingRequest
        $AllProperties = $("ObjectInfo", "ListTitle", "ListDescription", "NavigationSetting", "VersionSetting", "Id", "ServiceId", "Department", "Summary", "NotesToApprovers", "QuestionnaireId", "Metadatas", "TicketNumber", "Type", "TypeDescription", "Requester", "RequesterLoginName", "Status", "ProgressStatus", "ProgressStatusDescription", "SubmittedTime", "LastUpdated", "CreatedTime", "AssignTo", "FullPath")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "NavigationSetting"))) { #optional property not found
            $NavigationSetting = $null
        } else {
            $NavigationSetting = $JsonParameters.PSobject.Properties["NavigationSetting"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "VersionSetting"))) { #optional property not found
            $VersionSetting = $null
        } else {
            $VersionSetting = $JsonParameters.PSobject.Properties["VersionSetting"].value
        }
