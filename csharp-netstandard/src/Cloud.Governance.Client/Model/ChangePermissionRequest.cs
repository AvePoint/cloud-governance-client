...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class ChangePermissionRequest : IEquatable<ChangePermissionRequest>, IValidatableObject
    {
        ...
        public ChangePermissionRequest(PermissionObjectProperty objectProperty = default(PermissionObjectProperty), PermissionChangedType? permissionChangedType = default(PermissionChangedType?), bool isManagedAllUsers = false, List<ApiUser> selectedUsers = default(List<ApiUser>), Guid? id = default(Guid?), Guid serviceId = default(Guid), string department = default(string), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<RequestMetadata> metadatas = default(List<RequestMetadata>))
        {
