...
<#
RenewalTaskCompletedHookMessage<PSCustomObject>
#>

function New-RenewalTaskCompletedHookMessage {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => RenewalTaskCompletedHookMessage' | Write-Debug
...
RenewalTaskCompletedHookMessage<PSCustomObject>
#>
function ConvertFrom-JsonToRenewalTaskCompletedHookMessage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => RenewalTaskCompletedHookMessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RenewalTaskCompletedHookMessage
        $AllProperties = $("PhaseStartTime", "RenewalProfileName", "TaskLink", "ObjectTitle", "ObjectType", "ObjectTypeEnum", "GroupEmail", "TriggerType", "TriggerTime", "ObjectUrl", "ObjectId", "Summary")
