...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.ChangeWebContactRequest();
  });
  ...
  describe('ChangeWebContactRequest', function() {
    it('should create an instance of ChangeWebContactRequest', function() {
      // uncomment below and update the code to test ChangeWebContactRequest
      //var instane = new CloudGovernanceApi.ChangeWebContactRequest();
      //expect(instance).to.be.a(CloudGovernanceApi.ChangeWebContactRequest);
    });
    ...
    it('should have the property changedByUserSetting (base name: "changedByUserSetting")', function() {
      // uncomment below and update the code to test the property changedByUserSetting
      //var instane = new CloudGovernanceApi.ChangeWebContactRequest();
      //expect(instance).to.be();
    });

    it('should have the property changedByUrlItems (base name: "changedByUrlItems")', function() {
      // uncomment below and update the code to test the property changedByUrlItems
      //var instane = new CloudGovernanceApi.ChangeWebContactRequest();
      //expect(instance).to.be();
    });
