...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/RequestMetadata', 'model/RequestStatusNullable', 'model/ServiceTypeNullable', 'model/WebLifecycleActionType'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./RequestMetadata'), require('./RequestStatusNullable'), require('./ServiceTypeNullable'), require('./WebLifecycleActionType'));
  } else {
    // Browser globals (root is window)
    if (!root.CgClient) {
      root.CgClient = {};
    }
    root.CgClient.ArchiveWebLifecycleRequest = factory(root.CgClient.ApiClient, root.CgClient.RequestMetadata, root.CgClient.RequestStatusNullable, root.CgClient.ServiceTypeNullable, root.CgClient.WebLifecycleActionType);
  }
}(this, function(ApiClient, RequestMetadata, RequestStatusNullable, ServiceTypeNullable, WebLifecycleActionType) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('action')) {
        obj['action'] = ApiClient.convertToType(data['action'], WebLifecycleActionType);
      }
   ...
   */
  exports.prototype['webRelativeUrl'] = undefined;
  /**
