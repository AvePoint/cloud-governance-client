...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class ClonePermissionService : IEquatable<ClonePermissionService>, IValidatableObject
    {
        ...
        /// <param name="isHideTree">isHideTree (default to false).</param>
