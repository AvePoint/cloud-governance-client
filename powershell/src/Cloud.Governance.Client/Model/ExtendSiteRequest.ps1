...
<#
ExtendSiteRequest<PSCustomObject>
#>

function New-ExtendSiteRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => ExtendSiteRequest' | Write-Debug
...
ExtendSiteRequest<PSCustomObject>
#>
function ConvertFrom-JsonToExtendSiteRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => ExtendSiteRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
