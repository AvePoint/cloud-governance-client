...
function New-ChangeSiteQuotaRequest {
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => ChangeSiteQuotaRequest' | Write-Debug
...
ChangeSiteQuotaRequest<PSCustomObject>
#>
function ConvertFrom-JsonToChangeSiteQuotaRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
