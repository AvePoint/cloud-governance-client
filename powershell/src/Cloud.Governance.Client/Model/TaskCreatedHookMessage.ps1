...
<#
TaskCreatedHookMessage<PSCustomObject>
#>

function New-TaskCreatedHookMessage {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => TaskCreatedHookMessage' | Write-Debug
...
TaskCreatedHookMessage<PSCustomObject>
#>
function ConvertFrom-JsonToTaskCreatedHookMessage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => TaskCreatedHookMessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TaskCreatedHookMessage
        $AllProperties = $("AssigneeDisplayName", "AssigneeIdentityName", "TaskId", "TaskLink", "RequestId", "RequestGuid", "RequesterIdentityName", "Requester", "ServiceType", "ServiceTypeEnum", "TriggerType", "TriggerTime", "ObjectUrl", "ObjectId", "Summary")
