...
namespace Cloud.Governance.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ArchiveWebLifecycleRequest")]
    public partial class ArchiveWebLifecycleRequest : IEquatable<ArchiveWebLifecycleRequest>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Action
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchiveWebLifecycleRequest" /> class.
        /// </summary>
        ...
        public ArchiveWebLifecycleRequest(WebLifecycleActionType? action = default(WebLifecycleActionType?), Guid webId = default(Guid), string webUrl = default(string), string webRelativeUrl = default(string), Guid siteId = default(Guid), string siteUrl = default(string), string actionDescription = default(string), Guid? id = default(Guid?), Guid serviceId = default(Guid), string department = default(string), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<RequestMetadata> metadatas = default(List<RequestMetadata>), ServiceType? type = default(ServiceType?), string typeDescription = default(string), RequestStatus? status = default(RequestStatus?), int progressStatus = default(int), string progressStatusDescription = default(string))
        {
            this.Action = action;
            this.WebId = webId;
            this.WebUrl = webUrl;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ArchiveWebLifecycleRequest {\n");
        ...
        {
            return this.Equals(input as ArchiveWebLifecycleRequest);
        }

        /// <summary>
        /// Returns true if ArchiveWebLifecycleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ArchiveWebLifecycleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArchiveWebLifecycleRequest input)
        {
            if (input == null)
                return false;
