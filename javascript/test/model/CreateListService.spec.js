...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.CreateListService();
  });
  ...
  describe('CreateListService', function() {
    it('should create an instance of CreateListService', function() {
      // uncomment below and update the code to test CreateListService
      //var instane = new CloudGovernanceApi.CreateListService();
      //expect(instance).to.be.a(CloudGovernanceApi.CreateListService);
    });
    ...
    it('should have the property defaultListType (base name: "defaultListType")', function() {
      // uncomment below and update the code to test the property defaultListType
      //var instane = new CloudGovernanceApi.CreateListService();
      //expect(instance).to.be();
    });
    ...
    it('should have the property listTemplateSettings (base name: "listTemplateSettings")', function() {
      // uncomment below and update the code to test the property listTemplateSettings
      //var instane = new CloudGovernanceApi.CreateListService();
      //expect(instance).to.be();
    });

    it('should have the property urlSettings (base name: "urlSettings")', function() {
      // uncomment below and update the code to test the property urlSettings
      //var instane = new CloudGovernanceApi.CreateListService();
      //expect(instance).to.be();
    });

    it('should have the property allowBreakPermissionInheritance (base name: "allowBreakPermissionInheritance")', function() {
      // uncomment below and update the code to test the property allowBreakPermissionInheritance
      //var instane = new CloudGovernanceApi.CreateListService();
      //expect(instance).to.be();
    });
    ...
    it('should have the property listVersionAssignBy (base name: "listVersionAssignBy")', function() {
      // uncomment below and update the code to test the property listVersionAssignBy
      //var instane = new CloudGovernanceApi.CreateListService();
      //expect(instance).to.be();
    });

    it('should have the property listTemplateAssignBy (base name: "listTemplateAssignBy")', function() {
      // uncomment below and update the code to test the property listTemplateAssignBy
      //var instane = new CloudGovernanceApi.CreateListService();
      //expect(instance).to.be();
    });
    ...
    it('should have the property listTypeAssignBy (base name: "listTypeAssignBy")', function() {
      // uncomment below and update the code to test the property listTypeAssignBy
      //var instane = new CloudGovernanceApi.CreateListService();
      //expect(instance).to.be();
    });
