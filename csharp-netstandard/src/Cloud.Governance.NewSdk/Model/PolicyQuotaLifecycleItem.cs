...
namespace Cloud.Governance.NewSdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PolicyQuotaLifecycleItem :  IEquatable<PolicyQuotaLifecycleItem>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Option
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PolicyQuotaLifecycleItem {\n");
        ...
        {
            return this.Equals(input as PolicyQuotaLifecycleItem);
        }

        /// <summary>
        /// Returns true if PolicyQuotaLifecycleItem instances are equal
        /// </summary>
        /// <param name="input">Instance of PolicyQuotaLifecycleItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PolicyQuotaLifecycleItem input)
        {
            if (input == null)
                return false;
