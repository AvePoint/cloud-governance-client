...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class ChangeSiteSettingRequest : IEquatable<ChangeSiteSettingRequest>, IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name = "siteDescriptionSetting", EmitDefaultValue = true)]
        ...
        /// <summary>
        /// Returns false as EnableChangedMetadata should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeEnableChangedMetadata()
        {
            return false;
        }
        ...
        /// <summary>
        /// Returns false as OriginalSiteMetadatas should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeOriginalSiteMetadatas()
        {
            return false;
        }
