...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.ChangeGroupPolicyRequest();
  });
  ...
  describe('ChangeGroupPolicyRequest', function() {
    it('should create an instance of ChangeGroupPolicyRequest', function() {
      // uncomment below and update the code to test ChangeGroupPolicyRequest
      //var instane = new CloudGovernanceApi.ChangeGroupPolicyRequest();
      //expect(instance).to.be.a(CloudGovernanceApi.ChangeGroupPolicyRequest);
    });
    ...
    it('should have the property originalPolicy (base name: "originalPolicy")', function() {
      // uncomment below and update the code to test the property originalPolicy
      //var instane = new CloudGovernanceApi.ChangeGroupPolicyRequest();
      //expect(instance).to.be();
    });
