...
None
#>
function Add-WebUserCustomAction {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Add-WebUserCustomAction' | Write-Debug
        ...
        $LocalVarUri = '/admin/office365/web/usercustomactions'

        if (!$UserCustomAction) {
            throw "Error! The required parameter `UserCustomAction` missing when calling addWebUserCustomAction."
        }

        $LocalVarBodyParameter = $UserCustomAction | ConvertTo-Json -Depth 100
...
None
#>
function Invoke-DeleteWebUserCustomAction {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DeleteWebUserCustomAction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$WebFullUrl) {
            throw "Error! The required parameter `WebFullUrl` missing when calling deleteWebUserCustomAction."
        }
        $LocalVarQueryParameters['webFullUrl'] = $WebFullUrl

        if (!$Name) {
            throw "Error! The required parameter `Name` missing when calling deleteWebUserCustomAction."
        }
...
#>
function Get-AzureADExtensionPropertyNamesWithDataType {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Get-AzureADExtensionPropertyNamesWithDataType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/admin/office365/azuread/{tenantId}/property/custom'
        if (!$TenantId) {
            throw "Error! The required parameter `TenantId` missing when calling getAzureADExtensionPropertyNamesWithDataType."
        }
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "CustomExtensionPropertyModel[]" `
                                -IsBodyNullable $false
...
.PARAMETER IsSearchUserProperty
No description available.
...
function Get-AzureAdCustomPropertyNames {
    ...
    Process {
        ...
        if ($IsSearchUserProperty) {
            $LocalVarQueryParameters['isSearchUserProperty'] = $IsSearchUserProperty
        }
...
function Get-TenantIdByUrl {
    ...
    Process {
        'Calling method: Get-TenantIdByUrl' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/admin/office365/tenantid'

        if (!$Uri) {
            throw "Error! The required parameter `Uri` missing when calling getTenantIdByUrl."
        }
...
function Get-TenantIds {
    ...
    Process {
        'Calling method: Get-TenantIds' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/admin/office365/tenantids'
