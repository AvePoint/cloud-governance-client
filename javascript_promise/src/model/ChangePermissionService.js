...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiUser', 'model/AssignBy', 'model/CommonStatus', 'model/CustomActionSettings', 'model/CustomMetadata', 'model/GuidModel', 'model/PermissionChangedType', 'model/PermissionLevel', 'model/ServiceScopeSettings', 'model/ServiceType', 'model/TreeNode', 'model/UserLevelRestrictionType'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ApiUser'), require('./AssignBy'), require('./CommonStatus'), require('./CustomActionSettings'), require('./CustomMetadata'), require('./GuidModel'), require('./PermissionChangedType'), require('./PermissionLevel'), require('./ServiceScopeSettings'), require('./ServiceType'), require('./TreeNode'), require('./UserLevelRestrictionType'));
  } else {
    // Browser globals (root is window)
    if (!root.CgClient) {
      root.CgClient = {};
    }
    root.CgClient.ChangePermissionService = factory(root.CgClient.ApiClient, root.CgClient.ApiUser, root.CgClient.AssignBy, root.CgClient.CommonStatus, root.CgClient.CustomActionSettings, root.CgClient.CustomMetadata, root.CgClient.GuidModel, root.CgClient.PermissionChangedType, root.CgClient.PermissionLevel, root.CgClient.ServiceScopeSettings, root.CgClient.ServiceType, root.CgClient.TreeNode, root.CgClient.UserLevelRestrictionType);
  }
}(this, function(ApiClient, ApiUser, AssignBy, CommonStatus, CustomActionSettings, CustomMetadata, GuidModel, PermissionChangedType, PermissionLevel, ServiceScopeSettings, ServiceType, TreeNode, UserLevelRestrictionType) {
  'use strict';
   ...
   */
  exports.prototype['userRestrictionType'] = undefined;
  /**
   * @member {module:model/PermissionChangedType} permissionChangedType
   */
  exports.prototype['permissionChangedType'] = undefined;
  /**
   * @member {module:model/AssignBy} permissionChangedTypeAssignBy
   */
  exports.prototype['permissionChangedTypeAssignBy'] = undefined;
  /**
   * @member {Boolean} enabledExcludePermissions
   */
  exports.prototype['enabledExcludePermissions'] = undefined;
  /**
   * @member {Array.<module:model/PermissionLevel>} excludedPermissions
   */
  exports.prototype['excludedPermissions'] = undefined;
  /**
   * @member {module:model/GuidModel} reviewTaskEmailTemplate
   */
  exports.prototype['reviewTaskEmailTemplate'] = undefined;
  /**
