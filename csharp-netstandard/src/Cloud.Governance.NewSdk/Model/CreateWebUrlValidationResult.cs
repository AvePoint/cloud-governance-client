...
namespace Cloud.Governance.NewSdk.Model
{
    ...
    public partial class CreateWebUrlValidationResult :  IEquatable<CreateWebUrlValidationResult>, IValidatableObject
    {
        ...
        public CreateWebUrlValidationResult(string parentWebUrl = default(string), string parentSiteUrl = default(string), ApiUser sitePrimaryContact = default(ApiUser), ApiUser siteSecondaryContact = default(ApiUser), string errorMessage = default(string))
        {
