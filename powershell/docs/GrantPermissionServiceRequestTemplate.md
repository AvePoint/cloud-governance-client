# GrantPermissionServiceRequestTemplate
## Properties
...
```powershell
$GrantPermissionServiceRequestTemplate = New-Cloud.Governance.ClientGrantPermissionServiceRequestTemplate  -Url null `
...
```powershell
$GrantPermissionServiceRequestTemplate | ConvertTo-JSON
```
