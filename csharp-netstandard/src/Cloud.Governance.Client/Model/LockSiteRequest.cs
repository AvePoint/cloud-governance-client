...
namespace Cloud.Governance.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LockSiteRequest")]
    public partial class LockSiteRequest : IEquatable<LockSiteRequest>, IValidatableObject
    {
        /// <summary>
        /// Site collection locking status
        /// </summary>
        /// <value>Site collection locking status</value>
        ...
        /// </summary>
        /// <param name="lockType">Site collection locking status.</param>
        ...
        public LockSiteRequest(SiteLockType? lockType = default(SiteLockType?), SiteLifecycleActionType? action = default(SiteLifecycleActionType?), Guid siteId = default(Guid), string siteUrl = default(string), string siteTitle = default(string), Guid? id = default(Guid?), Guid serviceId = default(Guid), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<QuestionAnswerResponse> questionnaireResponse = default(List<QuestionAnswerResponse>), List<RequestMetadata> metadatas = default(List<RequestMetadata>))
        {
        ...
        /// </summary>
        /// <value>Description of site collection locking status. You can get all available description of site collection locking statuses by invoking the GetSiteLifecycleService api.</value>
        [DataMember(Name = "lockTypeDescription", EmitDefaultValue = true)]
        public string LockTypeDescription { get; private set; }

        /// <summary>
        /// Returns false as LockTypeDescription should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeLockTypeDescription()
        {
            return false;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LockSiteRequest {\n");
            sb.Append("  LockType: ").Append(LockType).Append("\n");
            sb.Append("  LockTypeDescription: ").Append(LockTypeDescription).Append("\n");
        ...
        {
            return this.Equals(input as LockSiteRequest);
        }

        /// <summary>
        /// Returns true if LockSiteRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of LockSiteRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LockSiteRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.LockTypeDescription == input.LockTypeDescription ||
                    (this.LockTypeDescription != null &&
                    this.LockTypeDescription.Equals(input.LockTypeDescription))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.LockTypeDescription != null)
                    hashCode = hashCode * 59 + this.LockTypeDescription.GetHashCode();
