...
namespace Cloud.Governance.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ElectionProcessViewModel :  IEquatable<ElectionProcessViewModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ElectionProcessViewModel" /> class.
        /// </summary>
        ...
        public ElectionProcessViewModel(List<GuidModel> permissionLevels = default(List<GuidModel>), bool enablePrimarySiteContact = default(bool), bool enableSecondarySiteContact = default(bool), bool enablePrimarySiteAdministrator = default(bool), bool enableAdministratorGroupUser = default(bool), int? administratorGroupUserCount = default(int?), bool enableMainPermissionUsers = default(bool), Guid? mainPermissionLevel = default(Guid?), int? mainPermissionUserCount = default(int?), bool enableAlternativePermissionUsers = default(bool), Guid? alternativePermissionLevel = default(Guid?), int? alternativPermissionUserCount = default(int?))
        {
        ...
        public List<GuidModel> PermissionLevels { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ElectionProcessViewModel {\n");
        ...
        {
            return this.Equals(input as ElectionProcessViewModel);
        }

        /// <summary>
        /// Returns true if ElectionProcessViewModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ElectionProcessViewModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ElectionProcessViewModel input)
        {
            if (input == null)
                return false;
