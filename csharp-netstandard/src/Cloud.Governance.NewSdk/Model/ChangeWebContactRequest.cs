...
namespace Cloud.Governance.NewSdk.Model
{
    ...
    public partial class ChangeWebContactRequest :  IEquatable<ChangeWebContactRequest>, IValidatableObject
    {
        ...
        public ChangeWebContactRequest(ChangeContactMethod changedMethod = default(ChangeContactMethod), ChangeContactByUserSetting changedByUserSetting = default(ChangeContactByUserSetting), List<ChangeWebContactByUrlSetting> changedByUrlItems = default(List<ChangeWebContactByUrlSetting>), List<ChangeWebContactSubRequest> subRequests = default(List<ChangeWebContactSubRequest>), Guid? id = default(Guid?), Guid serviceId = default(Guid), string department = default(string), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<RequestMetadata> metadatas = default(List<RequestMetadata>), int? ticketNumber = default(int?), ServiceType type = default(ServiceType), string requester = default(string), RequestStatus status = default(RequestStatus), DateTime? submittedTime = default(DateTime?), DateTime? lastUpdated = default(DateTime?), DateTime? createdTime = default(DateTime?), string assignTo = default(string), string fullPath = default(string))
        {
        ...
        public List<ChangeWebContactSubRequest> SubRequests { get; set; }
