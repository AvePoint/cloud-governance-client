...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class ChangeGroupQuotaResult : IEquatable<ChangeGroupQuotaResult>, IValidatableObject
    {
        ...
        /// <param name="sharePointSiteSize">current uesd quota.</param>
        public ChangeGroupQuotaResult(bool allowedAnySize = false, long minQuotaSize = 0, long maxQuotaSize = 0, long currentQuotaSize = 0, double? sharePointSiteSize = default(double?))
        {
        ...
        /// current uesd quota
        /// </summary>
        /// <value>current uesd quota</value>
