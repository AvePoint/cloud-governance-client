...
<#
RenewalTaskExceptionHookMessage<PSCustomObject>
#>

function New-RenewalTaskExceptionHookMessage {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => RenewalTaskExceptionHookMessage' | Write-Debug
...
RenewalTaskExceptionHookMessage<PSCustomObject>
#>
function ConvertFrom-JsonToRenewalTaskExceptionHookMessage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => RenewalTaskExceptionHookMessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
