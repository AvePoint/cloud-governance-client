...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.UserGroupPermissions();
  });
  ...
  describe('UserGroupPermissions', function() {
    it('should create an instance of UserGroupPermissions', function() {
      // uncomment below and update the code to test UserGroupPermissions
      //var instane = new CloudGovernanceApi.UserGroupPermissions();
      //expect(instance).to.be.a(CloudGovernanceApi.UserGroupPermissions);
    });
