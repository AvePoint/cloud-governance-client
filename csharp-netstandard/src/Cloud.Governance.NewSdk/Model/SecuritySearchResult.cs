...
namespace Cloud.Governance.NewSdk.Model
{
    ...
    public partial class SecuritySearchResult :  IEquatable<SecuritySearchResult>, IValidatableObject
    {
        ...
        public SecuritySearchResult(Guid id = default(Guid), string displayName = default(string), string identityName = default(string), string objectUrl = default(string), string objectTitle = default(string), string objectType = default(string), string accountType = default(string), string sharePointGroup = default(string), string permissionLevels = default(string), ApprovalAction action = default(ApprovalAction))
        {
