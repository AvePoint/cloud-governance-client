...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.SiteLifecycleService();
  });
  ...
  describe('SiteLifecycleService', function() {
    it('should create an instance of SiteLifecycleService', function() {
      // uncomment below and update the code to test SiteLifecycleService
      //var instane = new CloudGovernanceApi.SiteLifecycleService();
      //expect(instance).to.be.a(CloudGovernanceApi.SiteLifecycleService);
    });
    ...
    it('should have the property displayMetadataInAutoLifecycleTask (base name: "displayMetadataInAutoLifecycleTask")', function() {
      // uncomment below and update the code to test the property displayMetadataInAutoLifecycleTask
      //var instane = new CloudGovernanceApi.SiteLifecycleService();
      //expect(instance).to.be();
    });
