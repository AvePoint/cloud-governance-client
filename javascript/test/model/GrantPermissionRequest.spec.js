...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.GrantPermissionRequest();
  });
  ...
  describe('GrantPermissionRequest', function() {
    it('should create an instance of GrantPermissionRequest', function() {
      // uncomment below and update the code to test GrantPermissionRequest
      //var instane = new CloudGovernanceApi.GrantPermissionRequest();
      //expect(instance).to.be.a(CloudGovernanceApi.GrantPermissionRequest);
    });
    ...
    it('should have the property externalUserSharingSettings (base name: "externalUserSharingSettings")', function() {
      // uncomment below and update the code to test the property externalUserSharingSettings
      //var instane = new CloudGovernanceApi.GrantPermissionRequest();
      //expect(instance).to.be();
    });

    it('should have the property welcomeEmailSettings (base name: "welcomeEmailSettings")', function() {
      // uncomment below and update the code to test the property welcomeEmailSettings
      //var instane = new CloudGovernanceApi.GrantPermissionRequest();
      //expect(instance).to.be();
    });
