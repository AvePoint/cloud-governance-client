...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class UpdatableApiUser :  IEquatable<UpdatableApiUser>, IValidatableObject
    {
        ...
        public UpdatableApiUser(string email = default(string), string jobTitle = default(string), string id = default(string), string loginName = default(string), string displayName = default(string), bool isGroup = default(bool))
        {
            this.Email = email;
