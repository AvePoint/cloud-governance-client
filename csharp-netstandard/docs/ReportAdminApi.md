...
# **GeTaskReport**
> AllTaskListPageResult GeTaskReport (int? top = null, string skip = null, string nexttoken = null)
...
namespace Example
{
    public class GeTaskReportExample
    {
        public static void Main()
        {
            ...
            {
                // get all tasks report
                AllTaskListPageResult result = apiInstance.GeTaskReport(top, skip, nexttoken);
