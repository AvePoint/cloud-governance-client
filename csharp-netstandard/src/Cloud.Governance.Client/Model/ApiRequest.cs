...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class ApiRequest : IEquatable<ApiRequest>, IValidatableObject
    {
        ...
        public ApiRequest(Guid? id = default(Guid?), Guid serviceId = default(Guid), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<RequestMetadata> metadatas = default(List<RequestMetadata>))
        {
            this.Id = id;
