...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class DeleteWebLifecycleRequest : IEquatable<DeleteWebLifecycleRequest>, IValidatableObject
    {
        ...
        public DeleteWebLifecycleRequest(Guid webId = default(Guid), string webUrl = default(string), string webRelativeUrl = default(string), string webTitle = default(string), Guid siteId = default(Guid), string siteUrl = default(string), Guid? id = default(Guid?), Guid serviceId = default(Guid), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<QuestionAnswerResponse> questionnaireResponse = default(List<QuestionAnswerResponse>), List<RequestMetadata> metadatas = default(List<RequestMetadata>))
        {
            this.WebId = webId;
            this.WebUrl = webUrl;
