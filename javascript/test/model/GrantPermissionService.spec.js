...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.GrantPermissionService();
  });
  ...
  describe('GrantPermissionService', function() {
    it('should create an instance of GrantPermissionService', function() {
      // uncomment below and update the code to test GrantPermissionService
      //var instane = new CloudGovernanceApi.GrantPermissionService();
      //expect(instance).to.be.a(CloudGovernanceApi.GrantPermissionService);
    });
    ...
    it('should have the property userLevelControlSettings (base name: "userLevelControlSettings")', function() {
      // uncomment below and update the code to test the property userLevelControlSettings
      //var instane = new CloudGovernanceApi.GrantPermissionService();
      //expect(instance).to.be();
    });

    it('should have the property permissionDurationSettings (base name: "permissionDurationSettings")', function() {
      // uncomment below and update the code to test the property permissionDurationSettings
      //var instane = new CloudGovernanceApi.GrantPermissionService();
      //expect(instance).to.be();
    });
    ...
    it('should have the property defaultWelcomeEmailSettings (base name: "defaultWelcomeEmailSettings")', function() {
      // uncomment below and update the code to test the property defaultWelcomeEmailSettings
      //var instane = new CloudGovernanceApi.GrantPermissionService();
      //expect(instance).to.be();
    });
