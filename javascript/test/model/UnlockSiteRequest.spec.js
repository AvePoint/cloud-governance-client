...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.UnlockSiteRequest();
  });
  ...
  describe('UnlockSiteRequest', function() {
    it('should create an instance of UnlockSiteRequest', function() {
      // uncomment below and update the code to test UnlockSiteRequest
      //var instane = new CloudGovernanceApi.UnlockSiteRequest();
      //expect(instance).to.be.a(CloudGovernanceApi.UnlockSiteRequest);
    });
