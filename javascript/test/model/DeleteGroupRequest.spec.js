...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.DeleteGroupRequest();
  });
  ...
  describe('DeleteGroupRequest', function() {
    it('should create an instance of DeleteGroupRequest', function() {
      ...
      //var instane = new CloudGovernanceApi.DeleteGroupRequest();
      //expect(instance).to.be.a(CloudGovernanceApi.DeleteGroupRequest);
    });
