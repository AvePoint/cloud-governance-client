...
<#
OldMetadataGridModel<PSCustomObject>
#>

function New-OldMetadataGridModel {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => OldMetadataGridModel' | Write-Debug
...
OldMetadataGridModel<PSCustomObject>
#>
function ConvertFrom-JsonToOldMetadataGridModel {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => OldMetadataGridModel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OldMetadataGridModel
        $AllProperties = $("CreatedBy", "CreatedByDisplayName", "Id", "Name", "Description", "FieldType", "FieldTypeDescription", "MetadataValue", "ShowInReportType", "ShowInReportTypeDescription", "LastModifiedTime")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "FieldTypeDescription"))) { #optional property not found
            $FieldTypeDescription = $null
        } else {
            $FieldTypeDescription = $JsonParameters.PSobject.Properties["FieldTypeDescription"].value
        }
