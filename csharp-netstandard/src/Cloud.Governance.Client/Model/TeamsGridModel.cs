...
namespace Cloud.Governance.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TeamsGridModel :  IEquatable<TeamsGridModel>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets TeamsSharing
        /// </summary>
        [DataMember(Name="teamsSharing", EmitDefaultValue=false)]
        public GroupEnableSharingStatus? TeamsSharing { get; set; }
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets TeamsId
        /// </summary>
        [DataMember(Name="teamsId", EmitDefaultValue=true)]
        public string TeamsId { get; set; }

        /// <summary>
        /// Gets or Sets TeamsName
        /// </summary>
        [DataMember(Name="teamsName", EmitDefaultValue=true)]
        ...
        /// <summary>
        /// Gets or Sets EnableTeamsArchive
        /// </summary>
        [DataMember(Name="enableTeamsArchive", EmitDefaultValue=false)]
        public bool EnableTeamsArchive { get; set; }

        /// <summary>
        /// Gets or Sets EnableTeamsRestore
        /// </summary>
        [DataMember(Name="enableTeamsRestore", EmitDefaultValue=false)]
        public bool EnableTeamsRestore { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TeamsGridModel {\n");
            sb.Append("  TeamsId: ").Append(TeamsId).Append("\n");
            sb.Append("  TeamsName: ").Append(TeamsName).Append("\n");
            sb.Append("  TeamsSharing: ").Append(TeamsSharing).Append("\n");
            sb.Append("  GroupSharingDescription: ").Append(GroupSharingDescription).Append("\n");
            sb.Append("  EnableTeamsArchive: ").Append(EnableTeamsArchive).Append("\n");
            sb.Append("  EnableTeamsRestore: ").Append(EnableTeamsRestore).Append("\n");
        ...
        {
            return this.Equals(input as TeamsGridModel);
        }

        /// <summary>
        /// Returns true if TeamsGridModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TeamsGridModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TeamsGridModel input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.TeamsId == input.TeamsId ||
                    (this.TeamsId != null &&
                    this.TeamsId.Equals(input.TeamsId))
                ) && 
                (
                    this.TeamsName == input.TeamsName ||
                    (this.TeamsName != null &&
                    this.TeamsName.Equals(input.TeamsName))
                ) && 
                (
                    this.TeamsSharing == input.TeamsSharing ||
                    this.TeamsSharing.Equals(input.TeamsSharing)
                ) && 
                (
                ...
                (
                    this.EnableTeamsArchive == input.EnableTeamsArchive ||
                    this.EnableTeamsArchive.Equals(input.EnableTeamsArchive)
                ) && 
                (
                    this.EnableTeamsRestore == input.EnableTeamsRestore ||
                    this.EnableTeamsRestore.Equals(input.EnableTeamsRestore)
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.TeamsId != null)
                    hashCode = hashCode * 59 + this.TeamsId.GetHashCode();
                if (this.TeamsName != null)
                    hashCode = hashCode * 59 + this.TeamsName.GetHashCode();
                hashCode = hashCode * 59 + this.TeamsSharing.GetHashCode();
                if (this.GroupSharingDescription != null)
                    hashCode = hashCode * 59 + this.GroupSharingDescription.GetHashCode();
                hashCode = hashCode * 59 + this.EnableTeamsArchive.GetHashCode();
                hashCode = hashCode * 59 + this.EnableTeamsRestore.GetHashCode();
                if (this.Id != null)
