...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiUser', 'model/PermissionChangedType', 'model/PermissionObjectProperty', 'model/RequestMetadata', 'model/RequestStatusNullable', 'model/ServiceTypeNullable'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ApiUser'), require('./PermissionChangedType'), require('./PermissionObjectProperty'), require('./RequestMetadata'), require('./RequestStatusNullable'), require('./ServiceTypeNullable'));
  } else {
    // Browser globals (root is window)
    if (!root.CgClient) {
      root.CgClient = {};
    }
    root.CgClient.ChangePermissionRequest = factory(root.CgClient.ApiClient, root.CgClient.ApiUser, root.CgClient.PermissionChangedType, root.CgClient.PermissionObjectProperty, root.CgClient.RequestMetadata, root.CgClient.RequestStatusNullable, root.CgClient.ServiceTypeNullable);
  }
}(this, function(ApiClient, ApiUser, PermissionChangedType, PermissionObjectProperty, RequestMetadata, RequestStatusNullable, ServiceTypeNullable) {
  'use strict';
   ...
   */
  exports.prototype['objectProperty'] = undefined;
  /**
   ...
   */
  exports.prototype['isManagedAllUsers'] = undefined;
  /**
