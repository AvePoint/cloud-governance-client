...
namespace Cloud.Governance.NewSdk.Model
{
    ...
    public partial class PermissionLevel :  IEquatable<PermissionLevel>, IValidatableObject
    {
        ...
        public PermissionLevel(Guid id = default(Guid), int idInSharePoint = default(int), string name = default(string), string description = default(string), bool isExcluded = default(bool))
        {
            this.Name = name;
