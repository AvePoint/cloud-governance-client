...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.CreateSiteRequest();
  });
  ...
  describe('CreateSiteRequest', function() {
    it('should create an instance of CreateSiteRequest', function() {
      // uncomment below and update the code to test CreateSiteRequest
      //var instane = new CloudGovernanceApi.CreateSiteRequest();
      //expect(instance).to.be.a(CloudGovernanceApi.CreateSiteRequest);
    });
    ...
    it('should have the property additionalAdmins (base name: "additionalAdmins")', function() {
      // uncomment below and update the code to test the property additionalAdmins
      //var instane = new CloudGovernanceApi.CreateSiteRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property isShownClassificationAndDesing (base name: "isShownClassificationAndDesing")', function() {
      // uncomment below and update the code to test the property isShownClassificationAndDesing
      //var instane = new CloudGovernanceApi.CreateSiteRequest();
      //expect(instance).to.be();
    });

    it('should have the property designType (base name: "designType")', function() {
      // uncomment below and update the code to test the property designType
      //var instane = new CloudGovernanceApi.CreateSiteRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property isShownHubsiteSettings (base name: "isShownHubsiteSettings")', function() {
      // uncomment below and update the code to test the property isShownHubsiteSettings
      //var instane = new CloudGovernanceApi.CreateSiteRequest();
      //expect(instance).to.be();
    });
