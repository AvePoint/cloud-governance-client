...
ElectionProcessViewModel<PSCustomObject>
#>

function New-ElectionProcessViewModel {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating object: Cloud.Governance.Client => ElectionProcessViewModel' | Write-Debug
