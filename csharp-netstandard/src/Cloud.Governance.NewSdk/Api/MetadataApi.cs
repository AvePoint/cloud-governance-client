...
namespace Cloud.Governance.NewSdk.Api
{
    ...
    public interface IMetadataApiSync : IApiAccessor
    {
        ...
        ApiResponse<List<CustomMetadata>> GetMetadataWithHttpInfo (string filter = null, string orderby = null, string search = null, int? top = null, int? skip = null);
        /// <summary>
        /// get metadata by id
        /// </summary>
        /// <remarks>
    ...
    public interface IMetadataApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<CustomMetadata>> GetMetadataAsync (string filter = null, string orderby = null, string search = null, int? top = null, int? skip = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<List<CustomMetadata>>> GetMetadataAsyncWithHttpInfo (string filter = null, string orderby = null, string search = null, int? top = null, int? skip = null);
        /// <summary>
        /// get metadata by id
        /// </summary>
        /// <remarks>
    ...
    public partial class MetadataApi : IMetadataApi
    {
        ...
        /// <returns></returns>
        public MetadataApi(Cloud.Governance.NewSdk.Client.Configuration configuration)
        {
        ...
        public MetadataApi(Cloud.Governance.NewSdk.Client.ISynchronousClient client,Cloud.Governance.NewSdk.Client.IAsynchronousClient asyncClient, Cloud.Governance.NewSdk.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="skip"> Define the number of records you want to skip, default value is 0 (optional)</param>
        /// <returns>List&lt;CustomMetadata&gt;</returns>
        public List<CustomMetadata> GetMetadata (string filter = null, string orderby = null, string search = null, int? top = null, int? skip = null)
        {
             Cloud.Governance.NewSdk.Client.ApiResponse<List<CustomMetadata>> localVarResponse = GetMetadataWithHttpInfo(filter, orderby, search, top, skip);
        ...
        /// <param name="skip"> Define the number of records you want to skip, default value is 0 (optional)</param>
        /// <returns>ApiResponse of List&lt;CustomMetadata&gt;</returns>
        public Cloud.Governance.NewSdk.Client.ApiResponse< List<CustomMetadata> > GetMetadataWithHttpInfo (string filter = null, string orderby = null, string search = null, int? top = null, int? skip = null)
        {
            ...
            var response = this.Client.Get< List<CustomMetadata> >("/metadata", requestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception exception = this.ExceptionFactory("GetMetadata", response);
        ...
        /// <param name="skip"> Define the number of records you want to skip, default value is 0 (optional)</param>
        /// <returns>Task of List&lt;CustomMetadata&gt;</returns>
        public async System.Threading.Tasks.Task<List<CustomMetadata>> GetMetadataAsync (string filter = null, string orderby = null, string search = null, int? top = null, int? skip = null)
        {
             Cloud.Governance.NewSdk.Client.ApiResponse<List<CustomMetadata>> localVarResponse = await GetMetadataAsyncWithHttpInfo(filter, orderby, search, top, skip);
             return localVarResponse.Data;
        ...
        /// <param name="skip"> Define the number of records you want to skip, default value is 0 (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;CustomMetadata&gt;)</returns>
        public async System.Threading.Tasks.Task<Cloud.Governance.NewSdk.Client.ApiResponse<List<CustomMetadata>>> GetMetadataAsyncWithHttpInfo (string filter = null, string orderby = null, string search = null, int? top = null, int? skip = null)
        {
            ...
            var response = await this.AsynchronousClient.GetAsync<List<CustomMetadata>>("/metadata", requestOptions, this.Configuration);
        ...
        {
             Cloud.Governance.NewSdk.Client.ApiResponse<CustomMetadata> localVarResponse = GetMetadataByIdWithHttpInfo(id);
             return localVarResponse.Data;
        }
        ...
        /// <param name="id"></param>
        /// <returns>ApiResponse of CustomMetadata</returns>
        public Cloud.Governance.NewSdk.Client.ApiResponse< CustomMetadata > GetMetadataByIdWithHttpInfo (Guid id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Cloud.Governance.NewSdk.Client.ApiException(400, "Missing required parameter 'id' when calling MetadataApi->GetMetadataById");
            ...
            var response = this.Client.Get< CustomMetadata >("/metadata/{id}", requestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception exception = this.ExceptionFactory("GetMetadataById", response);
                if (exception != null) throw exception;
            }
        ...
        {
             Cloud.Governance.NewSdk.Client.ApiResponse<CustomMetadata> localVarResponse = await GetMetadataByIdAsyncWithHttpInfo(id);
             return localVarResponse.Data;
        ...
        /// <param name="id"></param>
        /// <returns>Task of ApiResponse (CustomMetadata)</returns>
        public async System.Threading.Tasks.Task<Cloud.Governance.NewSdk.Client.ApiResponse<CustomMetadata>> GetMetadataByIdAsyncWithHttpInfo (Guid id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Cloud.Governance.NewSdk.Client.ApiException(400, "Missing required parameter 'id' when calling MetadataApi->GetMetadataById");
            ...
            var response = await this.AsynchronousClient.GetAsync<CustomMetadata>("/metadata/{id}", requestOptions, this.Configuration);
