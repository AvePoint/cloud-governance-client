...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.SPNode();
  });
  ...
  describe('SPNode', function() {
    it('should create an instance of SPNode', function() {
      // uncomment below and update the code to test SPNode
      //var instane = new CloudGovernanceApi.SPNode();
      //expect(instance).to.be.a(CloudGovernanceApi.SPNode);
    });
