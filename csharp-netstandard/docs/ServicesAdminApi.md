...
namespace Example
{
    public class GetServicesExample
    {
        public static void Main()
        {
            ...
            var filter = filter_example;  // string | Use **eq**(equal) or **ne**(not equal) to filter the results (e.g. field1 eq 'value1' and field2 ne 'value2'), supported fields :<br/> id, description, name, serviceType, status, language, modifiedTime, createdByDisplayName, createdBy (optional) 
            var orderby = orderby_example;  // string | Order by one field, supported fields:<br/> id, description, name, serviceType, status, language, modifiedTime, createdByDisplayName, createdBy (optional) 
...
------------- | ------------- | ------------- | -------------
 **filter** | **string**| Use **eq**(equal) or **ne**(not equal) to filter the results (e.g. field1 eq &#39;value1&#39; and field2 ne &#39;value2&#39;), supported fields :&lt;br/&gt; id, description, name, serviceType, status, language, modifiedTime, createdByDisplayName, createdBy | [optional] 
