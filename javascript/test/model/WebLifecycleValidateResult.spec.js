...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.WebLifecycleValidateResult();
  });
  ...
  describe('WebLifecycleValidateResult', function() {
    it('should create an instance of WebLifecycleValidateResult', function() {
      // uncomment below and update the code to test WebLifecycleValidateResult
      //var instane = new CloudGovernanceApi.WebLifecycleValidateResult();
      //expect(instance).to.be.a(CloudGovernanceApi.WebLifecycleValidateResult);
    });
