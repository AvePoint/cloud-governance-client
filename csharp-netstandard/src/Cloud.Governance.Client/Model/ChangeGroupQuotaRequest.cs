...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class ChangeGroupQuotaRequest : IEquatable<ChangeGroupQuotaRequest>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="groupQuotaSize">groupQuotaSize.</param>
        ...
        public ChangeGroupQuotaRequest(long groupQuotaSize = default(long), Guid groupId = default(Guid), Guid? id = default(Guid?), Guid serviceId = default(Guid), string department = default(string), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<RequestMetadata> metadatas = default(List<RequestMetadata>), ServiceType? type = default(ServiceType?), string typeDescription = default(string), RequestStatus? status = default(RequestStatus?), int progressStatus = default(int), string progressStatusDescription = default(string))
        {
