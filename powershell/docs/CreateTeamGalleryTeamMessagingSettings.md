# CreateTeamGalleryTeamMessagingSettings
## Properties
...
```powershell
$CreateTeamGalleryTeamMessagingSettings = New-Cloud.Governance.ClientCreateTeamGalleryTeamMessagingSettings  -AllowUserEditMessages null `
...
```powershell
$CreateTeamGalleryTeamMessagingSettings | ConvertTo-JSON
```
