...
------------ | ------------- | ------------- | -------------
**EnableChangeTitle** | **Boolean** |  | [optional] [default to null]
**EnableChangeDescription** | **Boolean** |  | [optional] [default to null]
**ChangeMetadataSettings** | [**ChangeMetadataActionSetting**](ChangeMetadataActionSetting.md) |  | [optional] [default to null]
**DeploymentManagerPlanSettings** | [**DpmServiceSetting**](DpmServiceSetting.md) |  | [optional] [default to null]
...
- Create a new object
```powershell
New-Cloud.Governance.ClientChangeSiteSettingService  -EnableChangeTitle null `
