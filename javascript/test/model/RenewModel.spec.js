...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.RenewModel();
  });
  ...
  describe('RenewModel', function() {
    it('should create an instance of RenewModel', function() {
      // uncomment below and update the code to test RenewModel
      //var instane = new CloudGovernanceApi.RenewModel();
      //expect(instance).to.be.a(CloudGovernanceApi.RenewModel);
    });
