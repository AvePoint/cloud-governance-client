...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.ChangeListSettingService();
  });
  ...
  describe('ChangeListSettingService', function() {
    it('should create an instance of ChangeListSettingService', function() {
      // uncomment below and update the code to test ChangeListSettingService
      //var instane = new CloudGovernanceApi.ChangeListSettingService();
      //expect(instance).to.be.a(CloudGovernanceApi.ChangeListSettingService);
    });

    it('should have the property isEnableChangeTitle (base name: "isEnableChangeTitle")', function() {
      // uncomment below and update the code to test the property isEnableChangeTitle
      //var instane = new CloudGovernanceApi.ChangeListSettingService();
      //expect(instance).to.be();
    });

    it('should have the property isEnableChangeDescription (base name: "isEnableChangeDescription")', function() {
      // uncomment below and update the code to test the property isEnableChangeDescription
      //var instane = new CloudGovernanceApi.ChangeListSettingService();
      //expect(instance).to.be();
    });

    it('should have the property isEnableChangeQuickLaunch (base name: "isEnableChangeQuickLaunch")', function() {
      // uncomment below and update the code to test the property isEnableChangeQuickLaunch
      //var instane = new CloudGovernanceApi.ChangeListSettingService();
      //expect(instance).to.be();
    });

    it('should have the property isEnableChangeVersion (base name: "isEnableChangeVersion")', function() {
      // uncomment below and update the code to test the property isEnableChangeVersion
      //var instane = new CloudGovernanceApi.ChangeListSettingService();
      //expect(instance).to.be();
    });
