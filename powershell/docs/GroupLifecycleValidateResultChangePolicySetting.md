# GroupLifecycleValidateResultChangePolicySetting
## Properties
...
```powershell
$GroupLifecycleValidateResultChangePolicySetting = New-Cloud.Governance.ClientGroupLifecycleValidateResultChangePolicySetting  -CurrentPolicy null `
 -AllPolicies null `
...
```powershell
$GroupLifecycleValidateResultChangePolicySetting | ConvertTo-JSON
```
