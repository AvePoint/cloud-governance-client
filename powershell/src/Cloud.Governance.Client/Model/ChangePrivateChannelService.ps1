...
<#
ChangePrivateChannelService<PSCustomObject>
#>

function New-ChangePrivateChannelService {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => ChangePrivateChannelService' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        
        $PSO = [PSCustomObject]@{
            "ChangePrivateChannelFields" = ${ChangePrivateChannelFields}
            "TenantId" = ${TenantId}
            "Metadatas" = ${Metadatas}
...
ChangePrivateChannelService<PSCustomObject>
#>
function ConvertFrom-JsonToChangePrivateChannelService {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => ChangePrivateChannelService' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ChangePrivateChannelService
        $AllProperties = $("ChangePrivateChannelFields", "TenantId", "Metadatas", "HideRequestSummary", "Id", "Name", "Description", "Type", "ServiceContact", "ServiceAdminContact", "ApproversContainManagerRole", "Status", "ShowServiceInCatalog", "CustomActions", "ApprovalProcessId", "LanguageId", "CategoryId", "RequestTemplate")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "ChangePrivateChannelFields"))) { #optional property not found
            $ChangePrivateChannelFields = $null
        } else {
            $ChangePrivateChannelFields = $JsonParameters.PSobject.Properties["ChangePrivateChannelFields"].value
        }
