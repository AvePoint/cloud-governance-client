...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.ExtendGroupRequest();
  });
  ...
  describe('ExtendGroupRequest', function() {
    it('should create an instance of ExtendGroupRequest', function() {
      // uncomment below and update the code to test ExtendGroupRequest
      //var instane = new CloudGovernanceApi.ExtendGroupRequest();
      //expect(instance).to.be.a(CloudGovernanceApi.ExtendGroupRequest);
    });
