...
export function ApiTaskFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiTask {
    ...
    return {
        ...
        'allComments': !exists(json, 'allComments') ? undefined : (json['allComments'] as Array<any>).map(TaskCommentFromJSON),
        ...
        'dynamicActions': !exists(json, 'dynamicActions') ? undefined : (json['dynamicActions'] as Array<any>).map(TaskDynamicActionsFromJSON),
    };
}
...
export function ApiTaskToJSON(value?: ApiTask | null): any {
    ...
    return {
        ...
        'allComments': value.allComments == null ? undefined : (value.allComments as Array<any>).map(TaskCommentToJSON),
        'errorMessage': value.errorMessage,
        'lastModifiedTime': value.lastModifiedTime == null ? undefined : value.lastModifiedTime.toISOString(),
        'taskType': TaskTypeToJSON(value.taskType),
        'allowReassign': value.allowReassign,
        'allowEdit': value.allowEdit,
        'dynamicActions': value.dynamicActions == null ? undefined : (value.dynamicActions as Array<any>).map(TaskDynamicActionsToJSON),
    };
}
