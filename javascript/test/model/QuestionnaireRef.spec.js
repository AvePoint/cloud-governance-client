...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.QuestionnaireRef();
  });
  ...
  describe('QuestionnaireRef', function() {
    it('should create an instance of QuestionnaireRef', function() {
      // uncomment below and update the code to test QuestionnaireRef
      //var instane = new CloudGovernanceApi.QuestionnaireRef();
      //expect(instance).to.be.a(CloudGovernanceApi.QuestionnaireRef);
    });
