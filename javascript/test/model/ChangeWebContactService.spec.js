...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.ChangeWebContactService();
  });
  ...
  describe('ChangeWebContactService', function() {
    it('should create an instance of ChangeWebContactService', function() {
      // uncomment below and update the code to test ChangeWebContactService
      //var instane = new CloudGovernanceApi.ChangeWebContactService();
      //expect(instance).to.be.a(CloudGovernanceApi.ChangeWebContactService);
    });
    ...
    it('should have the property unCheckedNodesInfo (base name: "unCheckedNodesInfo")', function() {
      // uncomment below and update the code to test the property unCheckedNodesInfo
      //var instane = new CloudGovernanceApi.ChangeWebContactService();
      //expect(instance).to.be();
    });

    it('should have the property changeMethod (base name: "changeMethod")', function() {
      // uncomment below and update the code to test the property changeMethod
      //var instane = new CloudGovernanceApi.ChangeWebContactService();
      //expect(instance).to.be();
    });

    it('should have the property changeMethodAssignBy (base name: "changeMethodAssignBy")', function() {
      // uncomment below and update the code to test the property changeMethodAssignBy
      //var instane = new CloudGovernanceApi.ChangeWebContactService();
      //expect(instance).to.be();
    });

    it('should have the property enableNotifyNewContact (base name: "enableNotifyNewContact")', function() {
      // uncomment below and update the code to test the property enableNotifyNewContact
      //var instane = new CloudGovernanceApi.ChangeWebContactService();
      //expect(instance).to.be();
    });

    it('should have the property newContactNotifiedEmail (base name: "newContactNotifiedEmail")', function() {
      // uncomment below and update the code to test the property newContactNotifiedEmail
      //var instane = new CloudGovernanceApi.ChangeWebContactService();
      //expect(instance).to.be();
    });
