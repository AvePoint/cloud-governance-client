...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.ChangeSiteContactService();
  });
  ...
  describe('ChangeSiteContactService', function() {
    it('should create an instance of ChangeSiteContactService', function() {
      // uncomment below and update the code to test ChangeSiteContactService
      //var instane = new CloudGovernanceApi.ChangeSiteContactService();
      //expect(instance).to.be.a(CloudGovernanceApi.ChangeSiteContactService);
    });

    it('should have the property enableChangeContact (base name: "enableChangeContact")', function() {
      // uncomment below and update the code to test the property enableChangeContact
      //var instane = new CloudGovernanceApi.ChangeSiteContactService();
      //expect(instance).to.be();
    });

    it('should have the property enableChangeAdmin (base name: "enableChangeAdmin")', function() {
      // uncomment below and update the code to test the property enableChangeAdmin
      //var instane = new CloudGovernanceApi.ChangeSiteContactService();
      //expect(instance).to.be();
    });

    it('should have the property changedMethod (base name: "changedMethod")', function() {
      // uncomment below and update the code to test the property changedMethod
      //var instane = new CloudGovernanceApi.ChangeSiteContactService();
      //expect(instance).to.be();
    });

    it('should have the property changeModeAssignBy (base name: "changeModeAssignBy")', function() {
      // uncomment below and update the code to test the property changeModeAssignBy
      //var instane = new CloudGovernanceApi.ChangeSiteContactService();
      //expect(instance).to.be();
    });
