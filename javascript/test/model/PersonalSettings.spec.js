...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.PersonalSettings();
  });
  ...
  describe('PersonalSettings', function() {
    it('should create an instance of PersonalSettings', function() {
      // uncomment below and update the code to test PersonalSettings
      //var instane = new CloudGovernanceApi.PersonalSettings();
      //expect(instance).to.be.a(CloudGovernanceApi.PersonalSettings);
    });
