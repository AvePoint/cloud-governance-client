...
namespace Cloud.Governance.Client.Model
{
    ...
    /// AllTaskList
    /// </summary>
    [DataContract(Name = "AllTaskList")]
    public partial class AllTaskList : IEquatable<AllTaskList>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AllTaskList" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AllTaskList);
        }

        /// <summary>
        /// Returns true if AllTaskList instances are equal
        /// </summary>
        /// <param name="input">Instance of AllTaskList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllTaskList input)
        {
            if (input == null)
                return false;
