...
{
    /// <summary>
    /// Create private channel request model
    /// </summary>
    [DataContract(Name = "CreatePrivateChannelRequest")]
    public partial class CreatePrivateChannelRequest : IEquatable<CreatePrivateChannelRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreatePrivateChannelRequest" /> class.
        /// </summary>
        /// <param name="name">Channnel name.</param>
        /// <param name="channelDescription">Channnel description.</param>
        /// <param name="owners">Channnel owners.</param>
        /// <param name="members">Channnel members.</param>
        /// <param name="team">Channel parent team.</param>
        /// <param name="channelWebUrl">Channnel web url.</param>
        ...
        public CreatePrivateChannelRequest(string name = default(string), string channelDescription = default(string), List<ApiUser> owners = default(List<ApiUser>), List<ApiUser> members = default(List<ApiUser>), ApiUser team = default(ApiUser), string channelWebUrl = default(string), Guid? id = default(Guid?), Guid serviceId = default(Guid), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<QuestionAnswerResponse> questionnaireResponse = default(List<QuestionAnswerResponse>), List<RequestMetadata> metadatas = default(List<RequestMetadata>))
        {
            this.Name = name;
            ...
            this.Team = team;
            this.ChannelWebUrl = channelWebUrl;
            this.Id = id;
        ...
        /// </summary>
        /// <value>Channnel description</value>
        [DataMember(Name = "channelDescription", EmitDefaultValue = true)]
        public string ChannelDescription { get; set; }

        /// <summary>
        /// Channnel owners
        /// </summary>
        /// <value>Channnel owners</value>
        ...
        /// Channel parent team
        /// </summary>
        /// <value>Channel parent team</value>
        ...
        /// Channnel web url
        /// </summary>
        /// <value>Channnel web url</value>
        [DataMember(Name = "channelWebUrl", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreatePrivateChannelRequest {\n");
            sb.Append("  Name: ").Append(Name).Append("\n");
            sb.Append("  ChannelDescription: ").Append(ChannelDescription).Append("\n");
            sb.Append("  Owners: ").Append(Owners).Append("\n");
            sb.Append("  Members: ").Append(Members).Append("\n");
            sb.Append("  Team: ").Append(Team).Append("\n");
            sb.Append("  ChannelWebUrl: ").Append(ChannelWebUrl).Append("\n");
        ...
        {
            return this.Equals(input as CreatePrivateChannelRequest);
        }

        /// <summary>
        /// Returns true if CreatePrivateChannelRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreatePrivateChannelRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreatePrivateChannelRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ChannelDescription == input.ChannelDescription ||
                    (this.ChannelDescription != null &&
                    this.ChannelDescription.Equals(input.ChannelDescription))
                ) && 
                (
                ...
                (
                    this.ChannelWebUrl == input.ChannelWebUrl ||
                    (this.ChannelWebUrl != null &&
                    this.ChannelWebUrl.Equals(input.ChannelWebUrl))
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ChannelDescription != null)
                    hashCode = hashCode * 59 + this.ChannelDescription.GetHashCode();
                if (this.Owners != null)
                ...
                if (this.ChannelWebUrl != null)
                    hashCode = hashCode * 59 + this.ChannelWebUrl.GetHashCode();
                if (this.Id != null)
