...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiDurationTypeNullable', 'model/ExpirationType'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ApiDurationTypeNullable'), require('./ExpirationType'));
  } else {
    // Browser globals (root is window)
    if (!root.CgClient) {
      root.CgClient = {};
    }
    root.CgClient.TemporaryPermissionRequestSetting = factory(root.CgClient.ApiClient, root.CgClient.ApiDurationTypeNullable, root.CgClient.ExpirationType);
  }
}(this, function(ApiClient, ApiDurationTypeNullable, ExpirationType) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('durationDateType')) {
        obj['durationDateType'] = ApiDurationTypeNullable.constructFromObject(data['durationDateType']);
      }
  ...
  /**
   * @member {module:model/ApiDurationTypeNullable} durationDateType
   */
