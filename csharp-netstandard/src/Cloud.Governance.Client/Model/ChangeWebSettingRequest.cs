...
namespace Cloud.Governance.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChangeWebSettingRequest")]
    public partial class ChangeWebSettingRequest : IEquatable<ChangeWebSettingRequest>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChangeWebSettingRequest" /> class.
        /// </summary>
        /// <param name="url">url.</param>
        /// <param name="changedTitle">changedTitle.</param>
        /// <param name="changedDescription">changedDescription.</param>
        /// <param name="changedMetadata">changedMetadata.</param>
        ...
        public ChangeWebSettingRequest(ChangeWebSPObject url = default(ChangeWebSPObject), StringChangedProperty changedTitle = default(StringChangedProperty), StringChangedProperty changedDescription = default(StringChangedProperty), RequestMetadataListChangedProperty changedMetadata = default(RequestMetadataListChangedProperty), string deploymentPlanName = default(string), Guid? id = default(Guid?), Guid serviceId = default(Guid), string department = default(string), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<RequestMetadata> metadatas = default(List<RequestMetadata>), ServiceType? type = default(ServiceType?), string typeDescription = default(string), RequestStatus? status = default(RequestStatus?), int progressStatus = default(int), string progressStatusDescription = default(string))
        {
            this.Url = url;
        ...
        /// <summary>
        /// Gets or Sets ChangedTitle
        /// </summary>
        [DataMember(Name = "changedTitle", EmitDefaultValue = false)]
        public StringChangedProperty ChangedTitle { get; set; }

        /// <summary>
        /// Gets or Sets ChangedDescription
        /// </summary>
        [DataMember(Name = "changedDescription", EmitDefaultValue = false)]
        public StringChangedProperty ChangedDescription { get; set; }

        /// <summary>
        /// Gets or Sets ChangedMetadata
        /// </summary>
        [DataMember(Name = "changedMetadata", EmitDefaultValue = false)]
        public RequestMetadataListChangedProperty ChangedMetadata { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChangeWebSettingRequest {\n");
            sb.Append("  Url: ").Append(Url).Append("\n");
            sb.Append("  ChangedTitle: ").Append(ChangedTitle).Append("\n");
            sb.Append("  ChangedDescription: ").Append(ChangedDescription).Append("\n");
            sb.Append("  ChangedMetadata: ").Append(ChangedMetadata).Append("\n");
        ...
        {
            return this.Equals(input as ChangeWebSettingRequest);
        }

        /// <summary>
        /// Returns true if ChangeWebSettingRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ChangeWebSettingRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChangeWebSettingRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ChangedTitle == input.ChangedTitle ||
                    (this.ChangedTitle != null &&
                    this.ChangedTitle.Equals(input.ChangedTitle))
                ) && 
                (
                    this.ChangedDescription == input.ChangedDescription ||
                    (this.ChangedDescription != null &&
                    this.ChangedDescription.Equals(input.ChangedDescription))
                ) && 
                (
                    this.ChangedMetadata == input.ChangedMetadata ||
                    (this.ChangedMetadata != null &&
                    this.ChangedMetadata.Equals(input.ChangedMetadata))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ChangedTitle != null)
                    hashCode = hashCode * 59 + this.ChangedTitle.GetHashCode();
                if (this.ChangedDescription != null)
                    hashCode = hashCode * 59 + this.ChangedDescription.GetHashCode();
                if (this.ChangedMetadata != null)
                    hashCode = hashCode * 59 + this.ChangedMetadata.GetHashCode();
