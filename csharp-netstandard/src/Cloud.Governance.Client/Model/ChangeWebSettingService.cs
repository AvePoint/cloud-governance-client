...
namespace Cloud.Governance.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChangeWebSettingService")]
    public partial class ChangeWebSettingService : IEquatable<ChangeWebSettingService>, IValidatableObject
    {
        /// <summary>
        ...
        public ChangeWebSettingRequest RequestTemplate { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChangeWebSettingService {\n");
        ...
        {
            return this.Equals(input as ChangeWebSettingService);
        }

        /// <summary>
        /// Returns true if ChangeWebSettingService instances are equal
        /// </summary>
        /// <param name="input">Instance of ChangeWebSettingService to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChangeWebSettingService input)
        {
            if (input == null)
                return false;
