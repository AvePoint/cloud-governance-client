...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.HubSiteSettings();
  });
  ...
  describe('HubSiteSettings', function() {
    it('should create an instance of HubSiteSettings', function() {
      // uncomment below and update the code to test HubSiteSettings
      //var instane = new CloudGovernanceApi.HubSiteSettings();
      //expect(instance).to.be.a(CloudGovernanceApi.HubSiteSettings);
    });
