...
namespace Cloud.Governance.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChangeSiteContactRequest")]
    public partial class ChangeSiteContactRequest : IEquatable<ChangeSiteContactRequest>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets ChangeContactMethod
        /// </summary>
        [DataMember(Name = "changeContactMethod", EmitDefaultValue = false)]
        public ChangeContactMethod? ChangeContactMethod { get; set; }
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChangeSiteContactRequest" /> class.
        /// </summary>
        /// <param name="changeContactMethod">changeContactMethod.</param>
        /// <param name="changeByUrlSetting">changeByUrlSetting.</param>
        /// <param name="changeByUserSetting">changeByUserSetting.</param>
        ...
        public ChangeSiteContactRequest(ChangeContactMethod? changeContactMethod = default(ChangeContactMethod?), List<ChangeContactByUrlSetting> changeByUrlSetting = default(List<ChangeContactByUrlSetting>), ChangeContactByUserSetting changeByUserSetting = default(ChangeContactByUserSetting), Guid? id = default(Guid?), Guid serviceId = default(Guid), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<QuestionAnswerResponse> questionnaireResponse = default(List<QuestionAnswerResponse>), List<RequestMetadata> metadatas = default(List<RequestMetadata>))
        {
            this.ChangeContactMethod = changeContactMethod;
            this.ChangeByUrlSetting = changeByUrlSetting;
            this.ChangeByUserSetting = changeByUserSetting;
            this.Id = id;
        ...
        /// <summary>
        /// Gets or Sets ChangeByUrlSetting
        /// </summary>
        [DataMember(Name = "changeByUrlSetting", EmitDefaultValue = true)]
        public List<ChangeContactByUrlSetting> ChangeByUrlSetting { get; set; }

        /// <summary>
        /// Gets or Sets ChangeByUserSetting
        /// </summary>
        [DataMember(Name = "changeByUserSetting", EmitDefaultValue = true)]
        public ChangeContactByUserSetting ChangeByUserSetting { get; set; }

        /// <summary>
        /// Gets or Sets SubRequests
        /// </summary>
        [DataMember(Name = "subRequests", EmitDefaultValue = true)]
        public List<ChangeSiteContactSubRequest> SubRequests { get; private set; }

        /// <summary>
        /// Returns false as SubRequests should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeSubRequests()
        {
            return false;
        }

        /// <summary>
        /// Gets or Sets IsServiceEnableChangeContact
        /// </summary>
        [DataMember(Name = "isServiceEnableChangeContact", EmitDefaultValue = false)]
        public bool IsServiceEnableChangeContact { get; private set; }

        /// <summary>
        /// Returns false as IsServiceEnableChangeContact should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeIsServiceEnableChangeContact()
        {
            return false;
        }

        /// <summary>
        /// Gets or Sets IsServiceEnableChangeAdmin
        /// </summary>
        [DataMember(Name = "isServiceEnableChangeAdmin", EmitDefaultValue = false)]
        public bool IsServiceEnableChangeAdmin { get; private set; }

        /// <summary>
        /// Returns false as IsServiceEnableChangeAdmin should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeIsServiceEnableChangeAdmin()
        {
            return false;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChangeSiteContactRequest {\n");
            sb.Append("  ChangeContactMethod: ").Append(ChangeContactMethod).Append("\n");
            sb.Append("  ChangeByUrlSetting: ").Append(ChangeByUrlSetting).Append("\n");
            sb.Append("  ChangeByUserSetting: ").Append(ChangeByUserSetting).Append("\n");
            sb.Append("  SubRequests: ").Append(SubRequests).Append("\n");
            sb.Append("  IsServiceEnableChangeContact: ").Append(IsServiceEnableChangeContact).Append("\n");
            sb.Append("  IsServiceEnableChangeAdmin: ").Append(IsServiceEnableChangeAdmin).Append("\n");
        ...
        {
            return this.Equals(input as ChangeSiteContactRequest);
        }

        /// <summary>
        /// Returns true if ChangeSiteContactRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ChangeSiteContactRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChangeSiteContactRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.ChangeContactMethod == input.ChangeContactMethod ||
                    this.ChangeContactMethod.Equals(input.ChangeContactMethod)
                ) && 
                (
                    this.ChangeByUrlSetting == input.ChangeByUrlSetting ||
                    this.ChangeByUrlSetting != null &&
                    input.ChangeByUrlSetting != null &&
                    this.ChangeByUrlSetting.SequenceEqual(input.ChangeByUrlSetting)
                ) && 
                (
                    this.ChangeByUserSetting == input.ChangeByUserSetting ||
                    (this.ChangeByUserSetting != null &&
                    this.ChangeByUserSetting.Equals(input.ChangeByUserSetting))
                ) && 
                (
                    this.SubRequests == input.SubRequests ||
                    this.SubRequests != null &&
                    input.SubRequests != null &&
                    this.SubRequests.SequenceEqual(input.SubRequests)
                ) && 
                (
                    this.IsServiceEnableChangeContact == input.IsServiceEnableChangeContact ||
                    this.IsServiceEnableChangeContact.Equals(input.IsServiceEnableChangeContact)
                ) && 
                (
                    this.IsServiceEnableChangeAdmin == input.IsServiceEnableChangeAdmin ||
                    this.IsServiceEnableChangeAdmin.Equals(input.IsServiceEnableChangeAdmin)
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = hashCode * 59 + this.ChangeContactMethod.GetHashCode();
                if (this.ChangeByUrlSetting != null)
                    hashCode = hashCode * 59 + this.ChangeByUrlSetting.GetHashCode();
                if (this.ChangeByUserSetting != null)
                    hashCode = hashCode * 59 + this.ChangeByUserSetting.GetHashCode();
                if (this.SubRequests != null)
                    hashCode = hashCode * 59 + this.SubRequests.GetHashCode();
                hashCode = hashCode * 59 + this.IsServiceEnableChangeContact.GetHashCode();
                hashCode = hashCode * 59 + this.IsServiceEnableChangeAdmin.GetHashCode();
                if (this.Id != null)
