# HookMessageListRenewalTaskCompleted
## Properties
...
```powershell
$HookMessageListRenewalTaskCompleted = New-Cloud.Governance.ClientHookMessageListRenewalTaskCompleted  -PhaseStartTime null `
...
```powershell
$HookMessageListRenewalTaskCompleted | ConvertTo-JSON
```
