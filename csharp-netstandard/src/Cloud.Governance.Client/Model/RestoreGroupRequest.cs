...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class RestoreGroupRequest :  IEquatable<RestoreGroupRequest>, IValidatableObject
    {
        ...
        public RestoreGroupRequest(Guid groupId = default(Guid), Guid? id = default(Guid?), Guid serviceId = default(Guid), string department = default(string), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<RequestMetadata> metadatas = default(List<RequestMetadata>))
        {
