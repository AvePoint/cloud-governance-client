...
<#
ServiceForRequest<PSCustomObject>
#>

function New-ServiceForRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => ServiceForRequest' | Write-Debug
...
ServiceForRequest<PSCustomObject>
#>
function ConvertFrom-JsonToServiceForRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => ServiceForRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
