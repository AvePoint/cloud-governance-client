# ChangePermissionServiceRequestTemplate
## Properties
...
```powershell
$ChangePermissionServiceRequestTemplate = New-Cloud.Governance.ClientChangePermissionServiceRequestTemplate  -ObjectProperty null `
...
```powershell
$ChangePermissionServiceRequestTemplate | ConvertTo-JSON
```
