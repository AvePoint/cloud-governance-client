...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.ChangeGroupQuotaRequest();
  });
  ...
  describe('ChangeGroupQuotaRequest', function() {
    it('should create an instance of ChangeGroupQuotaRequest', function() {
      // uncomment below and update the code to test ChangeGroupQuotaRequest
      //var instane = new CloudGovernanceApi.ChangeGroupQuotaRequest();
      //expect(instance).to.be.a(CloudGovernanceApi.ChangeGroupQuotaRequest);
    });

    it('should have the property groupQuotaSize (base name: "groupQuotaSize")', function() {
      // uncomment below and update the code to test the property groupQuotaSize
      //var instane = new CloudGovernanceApi.ChangeGroupQuotaRequest();
      //expect(instance).to.be();
    });

    it('should have the property originalQuotaSize (base name: "originalQuotaSize")', function() {
      // uncomment below and update the code to test the property originalQuotaSize
      //var instane = new CloudGovernanceApi.ChangeGroupQuotaRequest();
      //expect(instance).to.be();
    });
