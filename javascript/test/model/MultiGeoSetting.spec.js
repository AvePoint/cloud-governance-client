...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.MultiGeoSetting();
  });
  ...
  describe('MultiGeoSetting', function() {
    it('should create an instance of MultiGeoSetting', function() {
      // uncomment below and update the code to test MultiGeoSetting
      //var instane = new CloudGovernanceApi.MultiGeoSetting();
      //expect(instance).to.be.a(CloudGovernanceApi.MultiGeoSetting);
    });
