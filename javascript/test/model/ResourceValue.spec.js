...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.ResourceValue();
  });
  ...
  describe('ResourceValue', function() {
    it('should create an instance of ResourceValue', function() {
      // uncomment below and update the code to test ResourceValue
      //var instane = new CloudGovernanceApi.ResourceValue();
      //expect(instance).to.be.a(CloudGovernanceApi.ResourceValue);
    });
