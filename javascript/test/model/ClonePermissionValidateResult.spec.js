...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.ClonePermissionValidateResult();
  });
  ...
  describe('ClonePermissionValidateResult', function() {
    it('should create an instance of ClonePermissionValidateResult', function() {
      // uncomment below and update the code to test ClonePermissionValidateResult
      //var instane = new CloudGovernanceApi.ClonePermissionValidateResult();
      //expect(instance).to.be.a(CloudGovernanceApi.ClonePermissionValidateResult);
    });
