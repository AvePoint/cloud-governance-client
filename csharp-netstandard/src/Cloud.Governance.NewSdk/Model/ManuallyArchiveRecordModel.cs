...
namespace Cloud.Governance.NewSdk.Model
{
    ...
    public partial class ManuallyArchiveRecordModel :  IEquatable<ManuallyArchiveRecordModel>, IValidatableObject
    {
        ...
        public ManuallyArchiveRecordModel(string rowKey = default(string), string partitionKey = default(string), Guid siteId = default(Guid), string url = default(string), bool isSelected = default(bool), ManualArchiveNodeLevel nodeType = default(ManualArchiveNodeLevel))
        {
            this.RowKey = rowKey;
        ...
        /// Gets or Sets RowKey
        /// </summary>
        [DataMember(Name="rowKey", EmitDefaultValue=true)]
