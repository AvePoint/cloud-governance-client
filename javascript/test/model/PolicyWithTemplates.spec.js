...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.PolicyWithTemplates();
  });
  ...
  describe('PolicyWithTemplates', function() {
    it('should create an instance of PolicyWithTemplates', function() {
      // uncomment below and update the code to test PolicyWithTemplates
      //var instane = new CloudGovernanceApi.PolicyWithTemplates();
      //expect(instance).to.be.a(CloudGovernanceApi.PolicyWithTemplates);
    });
