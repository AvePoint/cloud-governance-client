# ChangeSiteContactServiceRequestTemplate
## Properties
...
**ParentRequestId** | **String** |  | [optional] [readonly] 
...
```powershell
$ChangeSiteContactServiceRequestTemplate = New-Cloud.Governance.ClientChangeSiteContactServiceRequestTemplate  -ChangeContactMethod null `
...
```powershell
$ChangeSiteContactServiceRequestTemplate | ConvertTo-JSON
```
