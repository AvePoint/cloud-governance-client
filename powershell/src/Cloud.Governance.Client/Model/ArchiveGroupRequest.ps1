...
<#
ArchiveGroupRequest<PSCustomObject>
#>

function New-ArchiveGroupRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => ArchiveGroupRequest' | Write-Debug
...
ArchiveGroupRequest<PSCustomObject>
#>
function ConvertFrom-JsonToArchiveGroupRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => ArchiveGroupRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArchiveGroupRequest
