...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class ManagePermissionRequest : IEquatable<ManagePermissionRequest>, IValidatableObject
    {
        ...
        public ManagePermissionRequest(string objectUrl = default(string), NodeType? objectType = default(NodeType?), string objectTitle = default(string), string siteUrl = default(string), string webUrl = default(string), List<SPGroupManagementModel> spGroupManagement = default(List<SPGroupManagementModel>), PermissionManagementModel permissionManagement = default(PermissionManagementModel), Guid? id = default(Guid?), Guid serviceId = default(Guid), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<QuestionAnswerResponse> questionnaireResponse = default(List<QuestionAnswerResponse>), List<RequestMetadata> metadatas = default(List<RequestMetadata>))
        {
