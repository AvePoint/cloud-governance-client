...
<#
CreatePrivateChannelService<PSCustomObject>
#>

function New-CreatePrivateChannelService {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => CreatePrivateChannelService' | Write-Debug
...
CreatePrivateChannelService<PSCustomObject>
#>
function ConvertFrom-JsonToCreatePrivateChannelService {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => CreatePrivateChannelService' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "OwnersAssignBy"))) { #optional property not found
            $OwnersAssignBy = $null
        } else {
