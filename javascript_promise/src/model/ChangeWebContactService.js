...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiUser', 'model/AssignBy', 'model/ChangeContactMethod', 'model/CommonStatus', 'model/CustomActionSettings', 'model/CustomMetadata', 'model/ServiceScopeSettings', 'model/ServiceType'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ApiUser'), require('./AssignBy'), require('./ChangeContactMethod'), require('./CommonStatus'), require('./CustomActionSettings'), require('./CustomMetadata'), require('./ServiceScopeSettings'), require('./ServiceType'));
  } else {
    // Browser globals (root is window)
    if (!root.CgClient) {
      root.CgClient = {};
    }
    root.CgClient.ChangeWebContactService = factory(root.CgClient.ApiClient, root.CgClient.ApiUser, root.CgClient.AssignBy, root.CgClient.ChangeContactMethod, root.CgClient.CommonStatus, root.CgClient.CustomActionSettings, root.CgClient.CustomMetadata, root.CgClient.ServiceScopeSettings, root.CgClient.ServiceType);
  }
}(this, function(ApiClient, ApiUser, AssignBy, ChangeContactMethod, CommonStatus, CustomActionSettings, CustomMetadata, ServiceScopeSettings, ServiceType) {
  'use strict';
   ...
   */
  exports.prototype['unCheckedNodesInfo'] = undefined;
  /**
   * @member {module:model/ChangeContactMethod} changeMethod
   */
  exports.prototype['changeMethod'] = undefined;
  /**
   * @member {module:model/AssignBy} changeMethodAssignBy
   */
  exports.prototype['changeMethodAssignBy'] = undefined;
  /**
   * @member {Boolean} enableNotifyNewContact
   */
  exports.prototype['enableNotifyNewContact'] = undefined;
  /**
   * @member {String} newContactNotifiedEmail
   */
  exports.prototype['newContactNotifiedEmail'] = undefined;
  /**
