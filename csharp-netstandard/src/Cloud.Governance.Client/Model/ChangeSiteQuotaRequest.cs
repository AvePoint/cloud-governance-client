...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class ChangeSiteQuotaRequest : IEquatable<ChangeSiteQuotaRequest>, IValidatableObject
    {
        ...
        public ChangeSiteQuotaRequest(int quotaSize = default(int), SiteLifecycleActionType? action = default(SiteLifecycleActionType?), string actionDescription = default(string), Guid siteId = default(Guid), string siteUrl = default(string), Guid? id = default(Guid?), Guid serviceId = default(Guid), string department = default(string), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<RequestMetadata> metadatas = default(List<RequestMetadata>), ServiceType? type = default(ServiceType?), string typeDescription = default(string), RequestStatus? status = default(RequestStatus?), int progressStatus = default(int), string progressStatusDescription = default(string))
        {
        ...
        {
            return this.Equals(input as ChangeSiteQuotaRequest);
        }

        /// <summary>
        /// Returns true if ChangeSiteQuotaRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ChangeSiteQuotaRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChangeSiteQuotaRequest input)
        {
            if (input == null)
                return false;
