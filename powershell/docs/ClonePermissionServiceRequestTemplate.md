# ClonePermissionServiceRequestTemplate
## Properties
...
```powershell
$ClonePermissionServiceRequestTemplate = New-Cloud.Governance.ClientClonePermissionServiceRequestTemplate  -Urls null `
 -SourceUser null `
 -TargetUser null `
 -CloneOption null `
...
```powershell
$ClonePermissionServiceRequestTemplate | ConvertTo-JSON
```
