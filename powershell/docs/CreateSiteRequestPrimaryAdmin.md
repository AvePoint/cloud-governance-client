...
```powershell
$CreateSiteRequestPrimaryAdmin = New-Cloud.Governance.ClientCreateSiteRequestPrimaryAdmin  -Id null `
 -LoginName null `
 -IsExternalUser null `
 -AzureUserType null `
 -DisplayName null `
...
```powershell
$CreateSiteRequestPrimaryAdmin | ConvertTo-JSON
```
