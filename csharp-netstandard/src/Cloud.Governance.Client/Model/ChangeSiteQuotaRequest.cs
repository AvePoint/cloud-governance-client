...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class ChangeSiteQuotaRequest : IEquatable<ChangeSiteQuotaRequest>, IValidatableObject
    {
        ...
        public ChangeSiteQuotaRequest(int quotaSize = default(int), SiteLifecycleActionType? action = default(SiteLifecycleActionType?), Guid siteId = default(Guid), string siteUrl = default(string), Guid? id = default(Guid?), Guid serviceId = default(Guid), string department = default(string), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<RequestMetadata> metadatas = default(List<RequestMetadata>))
        {
