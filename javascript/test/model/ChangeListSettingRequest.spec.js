...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.ChangeListSettingRequest();
  });
  ...
  describe('ChangeListSettingRequest', function() {
    it('should create an instance of ChangeListSettingRequest', function() {
      // uncomment below and update the code to test ChangeListSettingRequest
      //var instane = new CloudGovernanceApi.ChangeListSettingRequest();
      //expect(instance).to.be.a(CloudGovernanceApi.ChangeListSettingRequest);
    });
    ...
    it('should have the property navigationSetting (base name: "navigationSetting")', function() {
      // uncomment below and update the code to test the property navigationSetting
      //var instane = new CloudGovernanceApi.ChangeListSettingRequest();
      //expect(instance).to.be();
    });

    it('should have the property versionSetting (base name: "versionSetting")', function() {
      // uncomment below and update the code to test the property versionSetting
      //var instane = new CloudGovernanceApi.ChangeListSettingRequest();
      //expect(instance).to.be();
    });
