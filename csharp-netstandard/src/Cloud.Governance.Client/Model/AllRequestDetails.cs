...
namespace Cloud.Governance.Client.Model
{
    ...
    /// AllRequestDetails
    /// </summary>
    [DataContract(Name = "AllRequestDetails")]
    public partial class AllRequestDetails : IEquatable<AllRequestDetails>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AllRequestDetails" /> class.
        /// </summary>
        /// <param name="lastApprovedTime">lastApprovedTime.</param>
        ...
        /// <summary>
        /// Gets or Sets LastApprovedTime
        /// </summary>
        [DataMember(Name = "lastApprovedTime", EmitDefaultValue = true)]
        public DateTime? LastApprovedTime { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllRequestDetails {\n");
            sb.Append("  LastApprovedTime: ").Append(LastApprovedTime).Append("\n");
        ...
        {
            return this.Equals(input as AllRequestDetails);
        }

        /// <summary>
        /// Returns true if AllRequestDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of AllRequestDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllRequestDetails input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.LastApprovedTime == input.LastApprovedTime ||
                    (this.LastApprovedTime != null &&
                    this.LastApprovedTime.Equals(input.LastApprovedTime))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.LastApprovedTime != null)
                    hashCode = hashCode * 59 + this.LastApprovedTime.GetHashCode();
