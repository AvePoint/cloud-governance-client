...
function New-ClonePermissionValidateResult {
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => ClonePermissionValidateResult' | Write-Debug
...
ClonePermissionValidateResult<PSCustomObject>
#>
function ConvertFrom-JsonToClonePermissionValidateResult {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => ClonePermissionValidateResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClonePermissionValidateResult
        $AllProperties = $("SiteId", "SiteUrl", "IsValid", "ErrorMessage", "MessageCode")
