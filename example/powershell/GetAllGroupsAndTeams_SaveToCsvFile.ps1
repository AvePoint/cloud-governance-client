...
if( $null -eq  (Get-InstalledModule -Name $ModuleName -MinimumVersion "6.1.1.0")){
    Install-Module -Name $ModuleName -Force -MinimumVersion "6.1.1.0"
}
...
try {
    ...
    do {
        ...
        $PageResult = Get-Workspaces -NextToken $NextToken -Filter $Filter
