...
<#
CreatePrivateChannelRequest<PSCustomObject>
#>

function New-CreatePrivateChannelRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => CreatePrivateChannelRequest' | Write-Debug
...
CreatePrivateChannelRequest<PSCustomObject>
#>
function ConvertFrom-JsonToCreatePrivateChannelRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => CreatePrivateChannelRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CreatePrivateChannelRequest
        $AllProperties = $("Name", "ChannelDescription", "Owners", "Members", "Team", "ChannelWebUrl", "Id", "ServiceId", "Summary", "NotesToApprovers", "QuestionnaireId", "QuestionnaireResponse", "Metadatas", "TicketNumber", "Type", "TypeDescription", "Requester", "RequesterLoginName", "Status", "ProgressStatus", "ProgressStatusDescription", "SubmittedTime", "LastUpdated", "CreatedTime", "AssignTo", "FullPath", "ApprovalStageName", "Participants", "ObjectID")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "ChannelWebUrl"))) { #optional property not found
            $ChannelWebUrl = $null
        } else {
            $ChannelWebUrl = $JsonParameters.PSobject.Properties["ChannelWebUrl"].value
        }
