...
namespace Cloud.Governance.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SiteLifecycleService")]
    public partial class SiteLifecycleService : IEquatable<SiteLifecycleService>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Action
        /// </summary>
        ...
        /// <param name="displayMetadataInAutoLifecycleTask">displayMetadataInAutoLifecycleTask (default to false).</param>
        /// <param name="scopeSettings">scopeSettings.</param>
        /// <param name="requestTemplate">Site collection lifecycle request model.</param>
        ...
        /// <summary>
        /// Gets or Sets DisplayMetadataInAutoLifecycleTask
        /// </summary>
        [DataMember(Name = "displayMetadataInAutoLifecycleTask", EmitDefaultValue = false)]
        public bool DisplayMetadataInAutoLifecycleTask { get; set; }
        ...
        /// </summary>
        /// <value>Site collection lifecycle request model</value>
        [DataMember(Name = "requestTemplate", EmitDefaultValue = true)]
        public SiteLifecycleRequest RequestTemplate { get; set; }

        /// <summary>
        /// Gets or Sets ChangePolicySetting
        /// </summary>
        [DataMember(Name = "changePolicySetting", EmitDefaultValue = true)]
        public ChangePolicyActionSetting ChangePolicySetting { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SiteLifecycleService {\n");
            sb.Append("  Action: ").Append(Action).Append("\n");
            sb.Append("  DisplayMetadataInAutoLifecycleTask: ").Append(DisplayMetadataInAutoLifecycleTask).Append("\n");
        ...
        {
            return this.Equals(input as SiteLifecycleService);
        }

        /// <summary>
        /// Returns true if SiteLifecycleService instances are equal
        /// </summary>
        /// <param name="input">Instance of SiteLifecycleService to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SiteLifecycleService input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.DisplayMetadataInAutoLifecycleTask == input.DisplayMetadataInAutoLifecycleTask ||
                    this.DisplayMetadataInAutoLifecycleTask.Equals(input.DisplayMetadataInAutoLifecycleTask)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.DisplayMetadataInAutoLifecycleTask.GetHashCode();
