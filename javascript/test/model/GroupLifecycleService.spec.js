...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.GroupLifecycleService();
  });
  ...
  describe('GroupLifecycleService', function() {
    it('should create an instance of GroupLifecycleService', function() {
      // uncomment below and update the code to test GroupLifecycleService
      //var instane = new CloudGovernanceApi.GroupLifecycleService();
      //expect(instance).to.be.a(CloudGovernanceApi.GroupLifecycleService);
    });
