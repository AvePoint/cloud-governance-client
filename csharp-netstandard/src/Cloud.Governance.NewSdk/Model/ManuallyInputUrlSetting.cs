...
namespace Cloud.Governance.NewSdk.Model
{
    ...
    public partial class ManuallyInputUrlSetting :  IEquatable<ManuallyInputUrlSetting>, IValidatableObject
    {
        ...
        public ManuallyInputUrlSetting(bool enableConstructUrl = default(bool), bool enableUrlValidation = default(bool), AssignBy constructUrlAssignBy = default(AssignBy), TextValidationRuleRef validationRule = default(TextValidationRuleRef), List<string> rules = default(List<string>), string suffix = default(string), string connection = default(string))
        {
            this.Rules = rules;
            this.Suffix = suffix;
