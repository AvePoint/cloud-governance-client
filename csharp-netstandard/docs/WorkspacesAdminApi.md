...
------------- | ------------- | -------------
[**ApplyCommunitiesProfiles**](WorkspacesAdminApi.md#applycommunitiesprofiles) | **POST** /admin/directory/workspace/communities/profiles | apply groups policy
...
[**UpdateMetadatas**](WorkspacesAdminApi.md#updatemetadatas) | **POST** /admin/directory/workspace/metadata | update metadatas for workspaces


<a name="applycommunitiesprofiles"></a>
# **ApplyCommunitiesProfiles**
> void ApplyCommunitiesProfiles (ApplyCommunityProfilesModel applyCommunityProfilesModel = null)
...
namespace Example
{
    public class ApplyCommunitiesProfilesExample
    {
        public static void Main()
        {
            ...
            var applyCommunityProfilesModel = new ApplyCommunityProfilesModel(); // ApplyCommunityProfilesModel | apply policy setting (optional) 

            try
            {
                // apply groups policy
                apiInstance.ApplyCommunitiesProfiles(applyCommunityProfilesModel);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling WorkspacesAdminApi.ApplyCommunitiesProfiles: " + e.Message );
...
<a name="getworkspacespost"></a>
# **GetWorkspacesPost**
> WorkspaceGridModelPageResult GetWorkspacesPost (string filter = null, string orderby = null, string search = null, int? top = null, string skip = null, string nexttoken = null)
...
namespace Example
{
    public class GetWorkspacesPostExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // get managed workspaces
                WorkspaceGridModelPageResult result = apiInstance.GetWorkspacesPost(filter, orderby, search, top, skip, nexttoken);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling WorkspacesAdminApi.GetWorkspacesPost: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
<a name="updatemetadatas"></a>
# **UpdateMetadatas**
> void UpdateMetadatas (UpdateMetadataParameter updateMetadataParameter = null)
...
namespace Example
{
    public class UpdateMetadatasExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
