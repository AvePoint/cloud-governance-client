...
namespace Cloud.Governance.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GrantPermissionRequest")]
    public partial class GrantPermissionRequest : IEquatable<GrantPermissionRequest>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        public GrantPermissionSPObject Url { get; set; }

        /// <summary>
        /// Gets or Sets PermissionSettings
        /// </summary>
        [DataMember(Name = "permissionSettings", EmitDefaultValue = false)]
        public GrantPermissionRequestPermissionSettings PermissionSettings { get; set; }

        /// <summary>
        /// Gets or Sets PermissionDurationSettings
        /// </summary>
        [DataMember(Name = "permissionDurationSettings", EmitDefaultValue = false)]
        public GrantPermissionRequestDurationSettings PermissionDurationSettings { get; set; }

        /// <summary>
        /// Gets or Sets SelectedUsers
        /// </summary>
        [DataMember(Name = "selectedUsers", EmitDefaultValue = true)]
        public List<SharingEnabledUser> SelectedUsers { get; set; }

        /// <summary>
        /// Gets or Sets ExternalUserSharingSettings
        /// </summary>
        [DataMember(Name = "externalUserSharingSettings", EmitDefaultValue = false)]
        public ExternalUserSharingSettings ExternalUserSharingSettings { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ExternalUserSharingSettings: ").Append(ExternalUserSharingSettings).Append("\n");
        ...
        {
            return this.Equals(input as GrantPermissionRequest);
        }

        /// <summary>
        /// Returns true if GrantPermissionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GrantPermissionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GrantPermissionRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ExternalUserSharingSettings == input.ExternalUserSharingSettings ||
                    (this.ExternalUserSharingSettings != null &&
                    this.ExternalUserSharingSettings.Equals(input.ExternalUserSharingSettings))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ExternalUserSharingSettings != null)
                    hashCode = hashCode * 59 + this.ExternalUserSharingSettings.GetHashCode();
