...
<#
GrantPermissionRequest<PSCustomObject>
#>

function New-GrantPermissionRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => GrantPermissionRequest' | Write-Debug
...
GrantPermissionRequest<PSCustomObject>
#>
function ConvertFrom-JsonToGrantPermissionRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => GrantPermissionRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GrantPermissionRequest
        $AllProperties = $("Url", "PermissionSettings", "PermissionDurationSettings", "SelectedUsers", "ExternalUserSharingSettings", "WelcomeEmailSettings", "Id", "ServiceId", "Department", "Summary", "NotesToApprovers", "QuestionnaireId", "Metadatas", "TicketNumber", "Type", "TypeDescription", "Requester", "RequesterLoginName", "Status", "ProgressStatus", "ProgressStatusDescription", "SubmittedTime", "LastUpdated", "CreatedTime", "AssignTo", "FullPath")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "ExternalUserSharingSettings"))) { #optional property not found
            $ExternalUserSharingSettings = $null
        } else {
            $ExternalUserSharingSettings = $JsonParameters.PSobject.Properties["ExternalUserSharingSettings"].value
        }
