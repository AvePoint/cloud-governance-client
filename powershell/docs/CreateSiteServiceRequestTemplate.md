# CreateSiteServiceRequestTemplate
## Properties
...
```powershell
$CreateSiteServiceRequestTemplate = New-Cloud.Governance.ClientCreateSiteServiceRequestTemplate  -SiteTitle null `
...
```powershell
$CreateSiteServiceRequestTemplate | ConvertTo-JSON
```
