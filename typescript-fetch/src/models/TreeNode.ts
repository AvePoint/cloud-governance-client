...
export function TreeNodeFromJSONTyped(json: any, ignoreDiscriminator: boolean): TreeNode {
    ...
    return {
        ...
        'children': !exists(json, 'children') ? undefined : (json['children'] as Array<any>).map(TreeNodeFromJSON),
        'selectedChildren': !exists(json, 'selectedChildren') ? undefined : (json['selectedChildren'] as Array<any>).map(TreeNodeFromJSON),
...
export function TreeNodeToJSON(value?: TreeNode | null): any {
    ...
    return {
        ...
        'selectedChildren': value.selectedChildren == null ? undefined : (value.selectedChildren as Array<any>).map(TreeNodeToJSON),
