...
<#
DeleteSiteRequest<PSCustomObject>
#>

function New-DeleteSiteRequest {
    [CmdletBinding()]
    Param (
...
DeleteSiteRequest<PSCustomObject>
#>
function ConvertFrom-JsonToDeleteSiteRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: Cloud.Governance.Client => DeleteSiteRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeleteSiteRequest
