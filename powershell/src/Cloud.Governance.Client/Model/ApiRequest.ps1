...
function New-ApiRequest {
    ...
    Process {
        'Creating PSCustomObject: Cloud.Governance.Client => ApiRequest' | Write-Debug
...
ApiRequest<PSCustomObject>
#>
function ConvertFrom-JsonToApiRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
