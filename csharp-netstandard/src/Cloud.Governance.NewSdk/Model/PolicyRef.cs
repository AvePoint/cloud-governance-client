...
namespace Cloud.Governance.NewSdk.Model
{
    ...
    public partial class PolicyRef :  IEquatable<PolicyRef>, IValidatableObject
    {
        ...
        public PolicyRef(Guid id = default(Guid), string name = default(string), string description = default(string), string category = default(string), Guid tenantId = default(Guid))
        {
            this.Name = name;
