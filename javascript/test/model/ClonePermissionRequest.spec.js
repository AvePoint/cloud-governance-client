...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.ClonePermissionRequest();
  });
  ...
  describe('ClonePermissionRequest', function() {
    it('should create an instance of ClonePermissionRequest', function() {
      // uncomment below and update the code to test ClonePermissionRequest
      //var instane = new CloudGovernanceApi.ClonePermissionRequest();
      //expect(instance).to.be.a(CloudGovernanceApi.ClonePermissionRequest);
    });
    ...
    it('should have the property sourceUser (base name: "sourceUser")', function() {
