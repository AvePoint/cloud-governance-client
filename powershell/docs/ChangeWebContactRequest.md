...
------------ | ------------- | ------------- | -------------
**ChangedMethod** | [**ChangeContactMethod**](ChangeContactMethod.md) |  | [optional] [default to null]
**ChangedByUserSetting** | [**ChangeContactByUserSetting**](ChangeContactByUserSetting.md) |  | [optional] [default to null]
**ChangedByUrlItems** | [**ChangeWebContactByUrlSetting[]**](ChangeWebContactByUrlSetting.md) |  | [optional] [default to null]
**SubRequests** | [**ChangeWebContactSubRequest[]**](ChangeWebContactSubRequest.md) |  | [optional] [readonly] [default to null]
...
- Create a new object
```powershell
New-Cloud.Governance.ClientChangeWebContactRequest  -ChangedMethod null `
