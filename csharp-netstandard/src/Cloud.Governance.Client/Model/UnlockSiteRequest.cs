...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class UnlockSiteRequest : IEquatable<UnlockSiteRequest>, IValidatableObject
    {
        ...
        public UnlockSiteRequest(int extendDuration = default(int), ApiDurationType? extendDurationType = default(ApiDurationType?), SiteLifecycleActionType? action = default(SiteLifecycleActionType?), string actionDescription = default(string), Guid siteId = default(Guid), string siteUrl = default(string), Guid? id = default(Guid?), Guid serviceId = default(Guid), string department = default(string), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<RequestMetadata> metadatas = default(List<RequestMetadata>), ServiceType? type = default(ServiceType?), string typeDescription = default(string), RequestStatus? status = default(RequestStatus?), int progressStatus = default(int), string progressStatusDescription = default(string))
        {
