...
namespace Cloud.Governance.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MetadataRecertificationReportProperties :  IEquatable<MetadataRecertificationReportProperties>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataRecertificationReportProperties" /> class.
        /// </summary>
        /// <param name="enableAddOrDeletedMetadata">enableAddOrDeletedMetadata.</param>
        ...
        /// <summary>
        /// Gets or Sets EnableAddOrDeletedMetadata
        /// </summary>
        [DataMember(Name="enableAddOrDeletedMetadata", EmitDefaultValue=false)]
        public bool EnableAddOrDeletedMetadata { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MetadataRecertificationReportProperties {\n");
            sb.Append("  EnableAddOrDeletedMetadata: ").Append(EnableAddOrDeletedMetadata).Append("\n");
        ...
        {
            return this.Equals(input as MetadataRecertificationReportProperties);
        }

        /// <summary>
        /// Returns true if MetadataRecertificationReportProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of MetadataRecertificationReportProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetadataRecertificationReportProperties input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.EnableAddOrDeletedMetadata == input.EnableAddOrDeletedMetadata ||
                    this.EnableAddOrDeletedMetadata.Equals(input.EnableAddOrDeletedMetadata)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = hashCode * 59 + this.EnableAddOrDeletedMetadata.GetHashCode();
