...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudGovernanceApi.ArchiveGroupRequest();
  });
  ...
  describe('ArchiveGroupRequest', function() {
    it('should create an instance of ArchiveGroupRequest', function() {
      // uncomment below and update the code to test ArchiveGroupRequest
      //var instane = new CloudGovernanceApi.ArchiveGroupRequest();
      //expect(instance).to.be.a(CloudGovernanceApi.ArchiveGroupRequest);
    });
