...
namespace Cloud.Governance.NewSdk.Model
{
    ...
    public partial class CreateWebScopeSettings :  IEquatable<CreateWebScopeSettings>, IValidatableObject
    {
        ...
        public AutoPopulateUrlAssignBy? AutoPopulateUrlWithSPContextAssignBy { get; set; }
        /// <summary>
        ...
        public CreateWebScopeSettings(List<SPNode> selectedNodes = default(List<SPNode>), string restrictParentUrl = default(string), ScopeType scopeType = default(ScopeType), bool useTitleInUrl = default(bool), bool enableUrlValidation = default(bool), TextValidationRuleRef textValidationRule = default(TextValidationRuleRef), bool autoPopulateUrlWithSPContext = default(bool), AutoPopulateUrlAssignBy autoPopulateUrlWithSPContextAssignBy = default(AutoPopulateUrlAssignBy))
        {
