...
# **GetTenantIds**
> void GetTenantIds (string filter = null, string orderby = null, string search = null, int? top = null, string skip = null, string nexttoken = null)
...
namespace Example
{
    public class GetTenantIdsExample
    {
        public static void Main()
        {
            ...
            {
                // get tenant ids by filter expression
                apiInstance.GetTenantIds(filter, orderby, search, top, skip, nexttoken);
            }
            catch (ApiException  e)
            {
