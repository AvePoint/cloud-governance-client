...
namespace Cloud.Governance.Client.Model
{
    ...
    public partial class ChangePermissionRequest : IEquatable<ChangePermissionRequest>, IValidatableObject
    {
        ...
        /// <param name="isManagedAllUsers">isManagedAllUsers (default to false).</param>
        ...
        public ChangePermissionRequest(PermissionObjectProperty objectProperty = default(PermissionObjectProperty), PermissionChangedType? permissionChangedType = default(PermissionChangedType?), bool isManagedAllUsers = false, List<ApiUser> selectedUsers = default(List<ApiUser>), Guid? id = default(Guid?), Guid serviceId = default(Guid), string summary = default(string), string notesToApprovers = default(string), Guid? questionnaireId = default(Guid?), List<QuestionAnswerResponse> questionnaireResponse = default(List<QuestionAnswerResponse>), List<RequestMetadata> metadatas = default(List<RequestMetadata>))
        {
        ...
        /// </summary>
        [DataMember(Name = "objectProperty", EmitDefaultValue = true)]
