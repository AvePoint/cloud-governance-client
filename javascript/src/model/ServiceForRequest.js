...
/**
 * The ServiceForRequest model module.
 * @module model/ServiceForRequest
 * @version 1.0
 */
class ServiceForRequest {
    /**
     * Constructs a new <code>ServiceForRequest</code>.
     * @alias module:model/ServiceForRequest
     */
    constructor() { 
        
        ServiceForRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ServiceForRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServiceForRequest} obj Optional instance to populate.
     * @return {module:model/ServiceForRequest} The populated <code>ServiceForRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServiceForRequest();
 ...
 */
ServiceForRequest.prototype['departmentAssignBy'] = undefined;

/**
 * @member {Array.<module:model/CustomMetadata>} metadatas
 */
ServiceForRequest.prototype['metadatas'] = undefined;

/**
 * @member {Boolean} hideRequestSummary
 */
ServiceForRequest.prototype['hideRequestSummary'] = undefined;

/**
 * @member {String} id
 */
ServiceForRequest.prototype['id'] = undefined;

/**
 * @member {String} name
 */
ServiceForRequest.prototype['name'] = undefined;

/**
 * @member {String} description
 */
ServiceForRequest.prototype['description'] = undefined;

/**
 * @member {module:model/ServiceType} type
 */
ServiceForRequest.prototype['type'] = undefined;

/**
 * @member {String} department
 */
ServiceForRequest.prototype['department'] = undefined;

/**
 * @member {Boolean} loadDepartmentFromUps
 */
ServiceForRequest.prototype['loadDepartmentFromUps'] = undefined;

/**
 * @member {Array.<String>} departments
 */
ServiceForRequest.prototype['departments'] = undefined;

/**
 * @member {module:model/ApiUser} serviceContact
 */
ServiceForRequest.prototype['serviceContact'] = undefined;

/**
 * @member {module:model/ApiUser} serviceAdminContact
 */
ServiceForRequest.prototype['serviceAdminContact'] = undefined;

/**
 * @member {Boolean} approversContainManagerRole
 */
ServiceForRequest.prototype['approversContainManagerRole'] = undefined;

/**
 * @member {module:model/CommonStatus} status
 */
ServiceForRequest.prototype['status'] = undefined;

/**
 * @member {Boolean} showServiceInCatalog
 */
ServiceForRequest.prototype['showServiceInCatalog'] = undefined;

/**
 * @member {module:model/CustomActivityInfo} customActivity
 */
ServiceForRequest.prototype['customActivity'] = undefined;

/**
 * @member {String} approvalProcessId
 */
ServiceForRequest.prototype['approvalProcessId'] = undefined;

/**
 * @member {Number} languageId
 */
ServiceForRequest.prototype['languageId'] = undefined;

/**
 * @member {String} categoryId
 */
ServiceForRequest.prototype['categoryId'] = undefined;
